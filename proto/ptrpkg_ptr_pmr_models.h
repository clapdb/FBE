...
public:
    ...
    void get(::ptrpkg_pmr::Line** fbe_value, std::pmr::memory_resource* resource) noexcept;
    // Get the struct fields values
    void get_fields(::ptrpkg_pmr::Line& fbe_value, size_t fbe_struct_size, std::pmr::memory_resource* resource) noexcept;
    ...
    void set(const ::ptrpkg_pmr::Line* fbe_value, std::pmr::memory_resource* resource) noexcept;
    // Set the struct fields values
    void set_fields(const ::ptrpkg_pmr::Line* fbe_value, std::pmr::memory_resource* resource) noexcept;
...
public:
    ...
    size_t serialize(const ::ptrpkg_pmr::Line& value, std::pmr::memory_resource* resource);
    // Deserialize the struct value
    size_t deserialize(::ptrpkg_pmr::Line& value, std::pmr::memory_resource* resource) noexcept;
