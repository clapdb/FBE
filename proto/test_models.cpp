...
FieldModel<::test::Struct128>::FieldModel(FBEBuffer& buffer, size_t offset) noexcept : _buffer(buffer), _offset(offset)
    , f1(buffer, 4 + 4)
    , f2(buffer, f1.fbe_offset() + f1.fbe_size())
    , f3(buffer, f2.fbe_offset() + f2.fbe_size())
    , f4(buffer, f3.fbe_offset() + f3.fbe_size())
...
size_t FieldModel<::test::Struct128>::fbe_body() const noexcept
{
    size_t fbe_result = 4 + 4
        + f1.fbe_size()
        + f2.fbe_size()
...
size_t FieldModel<::test::Struct128>::fbe_extra() const noexcept
{
    if ((_buffer.offset() + fbe_offset() + fbe_size()) > _buffer.size())
        return 0;
...
bool FieldModel<::test::Struct128>::verify(bool fbe_verify_type) const noexcept
{
    if ((_buffer.offset() + fbe_offset() + fbe_size()) > _buffer.size())
        return true;
...
bool FieldModel<::test::Struct128>::verify_fields([[maybe_unused]] size_t fbe_struct_size) const noexcept
{
    size_t fbe_current_size = 4 + 4;
...
size_t FieldModel<::test::Struct128>::get_begin() const noexcept
{
    if ((_buffer.offset() + fbe_offset() + fbe_size()) > _buffer.size())
        return 0;
...
void FieldModel<::test::Struct128>::get_end(size_t fbe_begin) const noexcept
{
    _buffer.unshift(fbe_begin);
}

void FieldModel<::test::Struct128>::get(::test::Struct128& fbe_value) const noexcept
{
    size_t fbe_begin = get_begin();
    if (fbe_begin == 0)
        return;
...
void FieldModel<::test::Struct128>::get_fields([[maybe_unused]] ::test::Struct128& fbe_value, [[maybe_unused]] size_t fbe_struct_size) const noexcept
{
    size_t fbe_current_size = 4 + 4;
...
size_t FieldModel<::test::Struct128>::set_begin()
{
    assert(((_buffer.offset() + fbe_offset() + fbe_size()) <= _buffer.size()) && "Model is broken!");
    if ((_buffer.offset() + fbe_offset() + fbe_size()) > _buffer.size())
        return 0;
...
void FieldModel<::test::Struct128>::set_end(size_t fbe_begin)
{
    _buffer.unshift(fbe_begin);
}

void FieldModel<::test::Struct128>::set(const ::test::Struct128& fbe_value) noexcept
{
    size_t fbe_begin = set_begin();
    if (fbe_begin == 0)
        return;
...
void FieldModel<::test::Struct128>::set_fields([[maybe_unused]] const ::test::Struct128& fbe_value) noexcept
{
    f1.set(fbe_value.f1);
    f2.set(fbe_value.f2);
    f3.set(fbe_value.f3);
...
size_t Struct128Model::serialize(const ::test::Struct128& value)
{
    size_t fbe_begin = create_begin();
    model.set(value);
    size_t fbe_full_size = create_end(fbe_begin);
...
size_t Struct128Model::deserialize(::test::Struct128& value) const noexcept
{
    if ((this->buffer().offset() + model.fbe_offset() - 4) > this->buffer().size())
        return 0;
