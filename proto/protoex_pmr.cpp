...
Order::Order(int32_t arg_id, const stdb::memory::arena_string& arg_symbol, const ::protoex_pmr::OrderSide& arg_side, const ::protoex_pmr::OrderType& arg_type, double arg_price, double arg_volume, double arg_tp, double arg_sl)
    : id(arg_id)
    , symbol(arg_symbol)
    , side(arg_side)
    , type(arg_type)
...
Balance::Balance(const ::proto_pmr::Balance& base, double arg_locked)
    : ::proto_pmr::Balance(base)
    , locked(arg_locked)
{}
...
{
    return (
        ::proto_pmr::Balance::operator==(other)
        && (locked == other.locked)
        );
}
...
bool Balance::operator<([[maybe_unused]] const Balance& other) const noexcept
{
    if (::proto_pmr::Balance::operator<(other))
        return true;
    if (other.::proto_pmr::Balance::operator<(*this))
        return false;
    return false;
}
...
{
    stream << "Balance(";
    stream << (const ::proto_pmr::Balance&)value;
...
Account::Account(int32_t arg_id, const stdb::memory::arena_string& arg_name, const ::protoex_pmr::StateEx& arg_state, const ::protoex_pmr::Balance& arg_wallet, const std::optional<::protoex_pmr::Balance>& arg_asset, const pmr::vector<::protoex_pmr::Order>& arg_orders)
    : id(arg_id)
    , name(arg_name)
    , state(arg_state)
    , wallet(arg_wallet)
...
OrderMessage::OrderMessage(const ::protoex_pmr::Order& arg_body)
    : body(arg_body)
{}
...
BalanceMessage::BalanceMessage(const ::protoex_pmr::Balance& arg_body)
    : body(arg_body)
{}
...
AccountMessage::AccountMessage(const ::protoex_pmr::Account& arg_body)
    : body(arg_body)
{}
