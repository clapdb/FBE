...
public:
    ...
    void get(::protoex::Order& fbe_value, std::pmr::memory_resource* resource) const noexcept;
    // Get the struct fields values
    void get_fields(::protoex::Order& fbe_value, size_t fbe_struct_size, std::pmr::memory_resource* resource) const noexcept;
    ...
    void set(const ::protoex::Order& fbe_value, std::pmr::memory_resource* resource) noexcept;
    // Set the struct fields values
    void set_fields(const ::protoex::Order& fbe_value, std::pmr::memory_resource* resource) noexcept;
...
public:
    ...
    size_t serialize(const ::protoex::Order& value, std::pmr::memory_resource* resource);
    // Deserialize the struct value
    size_t deserialize(::protoex::Order& value, std::pmr::memory_resource* resource) const noexcept;
...
template<>
struct model_of<::protoex::Order> {
using type = protoex::OrderModel;
};
...
public:
    ...
    // Get the struct value
    void get(::protoex::Balance& fbe_value, std::pmr::memory_resource* resource) const noexcept;
    // Get the struct fields values
    void get_fields(::protoex::Balance& fbe_value, size_t fbe_struct_size, std::pmr::memory_resource* resource) const noexcept;
    ...
    // Set the struct value
    void set(const ::protoex::Balance& fbe_value, std::pmr::memory_resource* resource) noexcept;
    // Set the struct fields values
    void set_fields(const ::protoex::Balance& fbe_value, std::pmr::memory_resource* resource) noexcept;
...
public:
    ...
    // Serialize the struct value
    size_t serialize(const ::protoex::Balance& value, std::pmr::memory_resource* resource);
    // Deserialize the struct value
    size_t deserialize(::protoex::Balance& value, std::pmr::memory_resource* resource) const noexcept;
...
template<>
struct model_of<::protoex::Balance> {
using type = protoex::BalanceModel;
};
...
public:
    ...
    // Get the struct value
    void get(::protoex::Account& fbe_value, std::pmr::memory_resource* resource) const noexcept;
    // Get the struct fields values
    void get_fields(::protoex::Account& fbe_value, size_t fbe_struct_size, std::pmr::memory_resource* resource) const noexcept;
    ...
    // Set the struct value
    void set(const ::protoex::Account& fbe_value, std::pmr::memory_resource* resource) noexcept;
    // Set the struct fields values
    void set_fields(const ::protoex::Account& fbe_value, std::pmr::memory_resource* resource) noexcept;
...
public:
    ...
    // Serialize the struct value
    size_t serialize(const ::protoex::Account& value, std::pmr::memory_resource* resource);
    // Deserialize the struct value
    size_t deserialize(::protoex::Account& value, std::pmr::memory_resource* resource) const noexcept;
...
template<>
struct model_of<::protoex::Account> {
using type = protoex::AccountModel;
};
...
public:
    ...
    // Get the struct value
    void get(::protoex::OrderMessage& fbe_value, std::pmr::memory_resource* resource) const noexcept;
    // Get the struct fields values
    void get_fields(::protoex::OrderMessage& fbe_value, size_t fbe_struct_size, std::pmr::memory_resource* resource) const noexcept;
    ...
    // Set the struct value
    void set(const ::protoex::OrderMessage& fbe_value, std::pmr::memory_resource* resource) noexcept;
    // Set the struct fields values
    void set_fields(const ::protoex::OrderMessage& fbe_value, std::pmr::memory_resource* resource) noexcept;
...
public:
    ...
    // Serialize the struct value
    size_t serialize(const ::protoex::OrderMessage& value, std::pmr::memory_resource* resource);
    // Deserialize the struct value
    size_t deserialize(::protoex::OrderMessage& value, std::pmr::memory_resource* resource) const noexcept;
...
template<>
struct model_of<::protoex::OrderMessage> {
using type = protoex::OrderMessageModel;
};
...
public:
    ...
    // Get the struct value
    void get(::protoex::BalanceMessage& fbe_value, std::pmr::memory_resource* resource) const noexcept;
    // Get the struct fields values
    void get_fields(::protoex::BalanceMessage& fbe_value, size_t fbe_struct_size, std::pmr::memory_resource* resource) const noexcept;
    ...
    // Set the struct value
    void set(const ::protoex::BalanceMessage& fbe_value, std::pmr::memory_resource* resource) noexcept;
    // Set the struct fields values
    void set_fields(const ::protoex::BalanceMessage& fbe_value, std::pmr::memory_resource* resource) noexcept;
...
public:
    ...
    // Serialize the struct value
    size_t serialize(const ::protoex::BalanceMessage& value, std::pmr::memory_resource* resource);
    // Deserialize the struct value
    size_t deserialize(::protoex::BalanceMessage& value, std::pmr::memory_resource* resource) const noexcept;
...
template<>
struct model_of<::protoex::BalanceMessage> {
using type = protoex::BalanceMessageModel;
};
...
public:
    ...
    // Get the struct value
    void get(::protoex::AccountMessage& fbe_value, std::pmr::memory_resource* resource) const noexcept;
    // Get the struct fields values
    void get_fields(::protoex::AccountMessage& fbe_value, size_t fbe_struct_size, std::pmr::memory_resource* resource) const noexcept;
    ...
    // Set the struct value
    void set(const ::protoex::AccountMessage& fbe_value, std::pmr::memory_resource* resource) noexcept;
    // Set the struct fields values
    void set_fields(const ::protoex::AccountMessage& fbe_value, std::pmr::memory_resource* resource) noexcept;
...
public:
    ...
    // Serialize the struct value
    size_t serialize(const ::protoex::AccountMessage& value, std::pmr::memory_resource* resource);
    // Deserialize the struct value
    size_t deserialize(::protoex::AccountMessage& value, std::pmr::memory_resource* resource) const noexcept;
...
template<>
struct model_of<::protoex::AccountMessage> {
using type = protoex::AccountMessageModel;
};
