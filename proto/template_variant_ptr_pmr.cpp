...
Line::Line(::variants_pmr::V arg_v, std::pmr::vector<::variants_pmr::V> arg_vv, FBE::pmr::HashMap<ArenaString, ::variants_pmr::V> arg_vm, std::optional<::variants_pmr::V> arg_vo)
    : v(std::move(arg_v))
    , vv(std::move(arg_vv))
    , vm(std::move(arg_vm))
    , vo()
...
Line2::Line2(FBE::pmr::HashMap<::enums_pmr::EnumInt8, ::variants_pmr::V> arg_vm)
    : vm(std::move(arg_vm))
{}
