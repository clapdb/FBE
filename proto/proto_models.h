...
public:
    ...
    // Get the struct value
    void get(::proto::CharMap& fbe_value) const noexcept;
    // Get the struct fields values
    void get_fields(::proto::CharMap& fbe_value, size_t fbe_struct_size) const noexcept;
    ...
    // Set the struct value
    void set(const ::proto::CharMap& fbe_value) noexcept;
    // Set the struct fields values
    void set_fields(const ::proto::CharMap& fbe_value) noexcept;
