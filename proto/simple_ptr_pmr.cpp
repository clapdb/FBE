...
Simple::Simple(const ArenaString& arg_info, std::unique_ptr<::simple_pmr::Simple> arg_simple, int32_t arg_depth, std::pmr::vector<std::unique_ptr<::simple_pmr::Simple>> arg_spv, std::pmr::vector<::simple_pmr::Simple> arg_sv, FBE::pmr::map<int32_t, std::unique_ptr<::simple_pmr::Simple>> arg_spm, FBE::pmr::map<int32_t, ::simple_pmr::Simple> arg_sm)
    : info(arg_info)
