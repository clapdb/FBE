...
FieldModel<::enums_pmr::Enums>::FieldModel(FBEBuffer& buffer, size_t offset) noexcept : _buffer(buffer), _offset(offset)
    , byte0(buffer, 4 + 4)
...
size_t FieldModel<::enums_pmr::Enums>::fbe_body() const noexcept
{
...
size_t FieldModel<::enums_pmr::Enums>::fbe_extra() const noexcept
{
...
bool FieldModel<::enums_pmr::Enums>::verify(bool fbe_verify_type) const noexcept
{
    if ((_buffer.offset() + fbe_offset() + fbe_size()) > _buffer.size())
        return true;
...
bool FieldModel<::enums_pmr::Enums>::verify_fields([[maybe_unused]] size_t fbe_struct_size) const noexcept
{
...
size_t FieldModel<::enums_pmr::Enums>::get_begin() const noexcept
{
    if ((_buffer.offset() + fbe_offset() + fbe_size()) > _buffer.size())
        return 0;
...
void FieldModel<::enums_pmr::Enums>::get_end(size_t fbe_begin) const noexcept
{
    _buffer.unshift(fbe_begin);
}

void FieldModel<::enums_pmr::Enums>::get(::enums_pmr::Enums& fbe_value) const noexcept
{
...
void FieldModel<::enums_pmr::Enums>::get_fields([[maybe_unused]] ::enums_pmr::Enums& fbe_value, [[maybe_unused]] size_t fbe_struct_size) const noexcept
{
    size_t fbe_current_size = 4 + 4;
...
size_t FieldModel<::enums_pmr::Enums>::set_begin()
{
...
void FieldModel<::enums_pmr::Enums>::set_end(size_t fbe_begin)
{
    _buffer.unshift(fbe_begin);
}

void FieldModel<::enums_pmr::Enums>::set(const ::enums_pmr::Enums& fbe_value) noexcept
{
...
void FieldModel<::enums_pmr::Enums>::set_fields([[maybe_unused]] const ::enums_pmr::Enums& fbe_value) noexcept
{
...
size_t EnumsModel::serialize(const ::enums_pmr::Enums& value)
{
...
size_t EnumsModel::deserialize(::enums_pmr::Enums& value) const noexcept
{
    if ((this->buffer().offset() + model.fbe_offset() - 4) > this->buffer().size())
        return 0;
