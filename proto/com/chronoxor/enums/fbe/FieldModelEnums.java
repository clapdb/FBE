...
public final class FieldModelEnums extends com.chronoxor.fbe.FieldModel
{
    ...
    public void getFields(com.chronoxor.enums.Enums fbeValue, long fbeStructSize)
    {
        ...
        if ((fbeCurrentSize + byte0.fbeSize()) <= fbeStructSize)
            fbeValue.byte0 = byte0.get(com.chronoxor.EnumByte.ENUM_VALUE_0);
        else
            fbeValue.byte0 = com.chronoxor.EnumByte.ENUM_VALUE_0;
        fbeCurrentSize += byte0.fbeSize();

        if ((fbeCurrentSize + byte1.fbeSize()) <= fbeStructSize)
            fbeValue.byte1 = byte1.get(com.chronoxor.EnumByte.ENUM_VALUE_1);
        else
            fbeValue.byte1 = com.chronoxor.EnumByte.ENUM_VALUE_1;
        fbeCurrentSize += byte1.fbeSize();

        if ((fbeCurrentSize + byte2.fbeSize()) <= fbeStructSize)
            fbeValue.byte2 = byte2.get(com.chronoxor.EnumByte.ENUM_VALUE_2);
        else
            fbeValue.byte2 = com.chronoxor.EnumByte.ENUM_VALUE_2;
        fbeCurrentSize += byte2.fbeSize();

        if ((fbeCurrentSize + byte3.fbeSize()) <= fbeStructSize)
            fbeValue.byte3 = byte3.get(com.chronoxor.EnumByte.ENUM_VALUE_3);
        else
            fbeValue.byte3 = com.chronoxor.EnumByte.ENUM_VALUE_3;
        fbeCurrentSize += byte3.fbeSize();

        if ((fbeCurrentSize + byte4.fbeSize()) <= fbeStructSize)
            fbeValue.byte4 = byte4.get(com.chronoxor.EnumByte.ENUM_VALUE_4);
        else
            fbeValue.byte4 = com.chronoxor.EnumByte.ENUM_VALUE_4;
        fbeCurrentSize += byte4.fbeSize();

        if ((fbeCurrentSize + byte5.fbeSize()) <= fbeStructSize)
            fbeValue.byte5 = byte5.get(com.chronoxor.EnumByte.ENUM_VALUE_5);
        else
            fbeValue.byte5 = com.chronoxor.EnumByte.ENUM_VALUE_5;
        fbeCurrentSize += byte5.fbeSize();

        if ((fbeCurrentSize + char0.fbeSize()) <= fbeStructSize)
            fbeValue.char0 = char0.get(com.chronoxor.EnumChar.ENUM_VALUE_0);
        else
            fbeValue.char0 = com.chronoxor.EnumChar.ENUM_VALUE_0;
        fbeCurrentSize += char0.fbeSize();

        if ((fbeCurrentSize + char1.fbeSize()) <= fbeStructSize)
            fbeValue.char1 = char1.get(com.chronoxor.EnumChar.ENUM_VALUE_1);
        else
            fbeValue.char1 = com.chronoxor.EnumChar.ENUM_VALUE_1;
        fbeCurrentSize += char1.fbeSize();

        if ((fbeCurrentSize + char2.fbeSize()) <= fbeStructSize)
            fbeValue.char2 = char2.get(com.chronoxor.EnumChar.ENUM_VALUE_2);
        else
            fbeValue.char2 = com.chronoxor.EnumChar.ENUM_VALUE_2;
        fbeCurrentSize += char2.fbeSize();

        if ((fbeCurrentSize + char3.fbeSize()) <= fbeStructSize)
            fbeValue.char3 = char3.get(com.chronoxor.EnumChar.ENUM_VALUE_3);
        else
            fbeValue.char3 = com.chronoxor.EnumChar.ENUM_VALUE_3;
        fbeCurrentSize += char3.fbeSize();

        if ((fbeCurrentSize + char4.fbeSize()) <= fbeStructSize)
            fbeValue.char4 = char4.get(com.chronoxor.EnumChar.ENUM_VALUE_4);
        else
            fbeValue.char4 = com.chronoxor.EnumChar.ENUM_VALUE_4;
        fbeCurrentSize += char4.fbeSize();

        if ((fbeCurrentSize + char5.fbeSize()) <= fbeStructSize)
            fbeValue.char5 = char5.get(com.chronoxor.EnumChar.ENUM_VALUE_5);
        else
            fbeValue.char5 = com.chronoxor.EnumChar.ENUM_VALUE_5;
        fbeCurrentSize += char5.fbeSize();

        if ((fbeCurrentSize + wchar0.fbeSize()) <= fbeStructSize)
            fbeValue.wchar0 = wchar0.get(com.chronoxor.EnumWChar.ENUM_VALUE_0);
        else
            fbeValue.wchar0 = com.chronoxor.EnumWChar.ENUM_VALUE_0;
        fbeCurrentSize += wchar0.fbeSize();

        if ((fbeCurrentSize + wchar1.fbeSize()) <= fbeStructSize)
            fbeValue.wchar1 = wchar1.get(com.chronoxor.EnumWChar.ENUM_VALUE_1);
        else
            fbeValue.wchar1 = com.chronoxor.EnumWChar.ENUM_VALUE_1;
        fbeCurrentSize += wchar1.fbeSize();

        if ((fbeCurrentSize + wchar2.fbeSize()) <= fbeStructSize)
            fbeValue.wchar2 = wchar2.get(com.chronoxor.EnumWChar.ENUM_VALUE_2);
        else
            fbeValue.wchar2 = com.chronoxor.EnumWChar.ENUM_VALUE_2;
        fbeCurrentSize += wchar2.fbeSize();

        if ((fbeCurrentSize + wchar3.fbeSize()) <= fbeStructSize)
            fbeValue.wchar3 = wchar3.get(com.chronoxor.EnumWChar.ENUM_VALUE_3);
        else
            fbeValue.wchar3 = com.chronoxor.EnumWChar.ENUM_VALUE_3;
        fbeCurrentSize += wchar3.fbeSize();

        if ((fbeCurrentSize + wchar4.fbeSize()) <= fbeStructSize)
            fbeValue.wchar4 = wchar4.get(com.chronoxor.EnumWChar.ENUM_VALUE_4);
        else
            fbeValue.wchar4 = com.chronoxor.EnumWChar.ENUM_VALUE_4;
        fbeCurrentSize += wchar4.fbeSize();

        if ((fbeCurrentSize + wchar5.fbeSize()) <= fbeStructSize)
            fbeValue.wchar5 = wchar5.get(com.chronoxor.EnumWChar.ENUM_VALUE_5);
        else
            fbeValue.wchar5 = com.chronoxor.EnumWChar.ENUM_VALUE_5;
        fbeCurrentSize += wchar5.fbeSize();

        if ((fbeCurrentSize + int8b0.fbeSize()) <= fbeStructSize)
            fbeValue.int8b0 = int8b0.get(com.chronoxor.EnumInt8.ENUM_VALUE_0);
        else
            fbeValue.int8b0 = com.chronoxor.EnumInt8.ENUM_VALUE_0;
        fbeCurrentSize += int8b0.fbeSize();

        if ((fbeCurrentSize + int8b1.fbeSize()) <= fbeStructSize)
            fbeValue.int8b1 = int8b1.get(com.chronoxor.EnumInt8.ENUM_VALUE_1);
        else
            fbeValue.int8b1 = com.chronoxor.EnumInt8.ENUM_VALUE_1;
        fbeCurrentSize += int8b1.fbeSize();

        if ((fbeCurrentSize + int8b2.fbeSize()) <= fbeStructSize)
            fbeValue.int8b2 = int8b2.get(com.chronoxor.EnumInt8.ENUM_VALUE_2);
        else
            fbeValue.int8b2 = com.chronoxor.EnumInt8.ENUM_VALUE_2;
        fbeCurrentSize += int8b2.fbeSize();

        if ((fbeCurrentSize + int8b3.fbeSize()) <= fbeStructSize)
            fbeValue.int8b3 = int8b3.get(com.chronoxor.EnumInt8.ENUM_VALUE_3);
        else
            fbeValue.int8b3 = com.chronoxor.EnumInt8.ENUM_VALUE_3;
        fbeCurrentSize += int8b3.fbeSize();

        if ((fbeCurrentSize + int8b4.fbeSize()) <= fbeStructSize)
            fbeValue.int8b4 = int8b4.get(com.chronoxor.EnumInt8.ENUM_VALUE_4);
        else
            fbeValue.int8b4 = com.chronoxor.EnumInt8.ENUM_VALUE_4;
        fbeCurrentSize += int8b4.fbeSize();

        if ((fbeCurrentSize + int8b5.fbeSize()) <= fbeStructSize)
            fbeValue.int8b5 = int8b5.get(com.chronoxor.EnumInt8.ENUM_VALUE_5);
        else
            fbeValue.int8b5 = com.chronoxor.EnumInt8.ENUM_VALUE_5;
        fbeCurrentSize += int8b5.fbeSize();

        if ((fbeCurrentSize + uint8b0.fbeSize()) <= fbeStructSize)
            fbeValue.uint8b0 = uint8b0.get(com.chronoxor.EnumUInt8.ENUM_VALUE_0);
        else
            fbeValue.uint8b0 = com.chronoxor.EnumUInt8.ENUM_VALUE_0;
        fbeCurrentSize += uint8b0.fbeSize();

        if ((fbeCurrentSize + uint8b1.fbeSize()) <= fbeStructSize)
            fbeValue.uint8b1 = uint8b1.get(com.chronoxor.EnumUInt8.ENUM_VALUE_1);
        else
            fbeValue.uint8b1 = com.chronoxor.EnumUInt8.ENUM_VALUE_1;
        fbeCurrentSize += uint8b1.fbeSize();

        if ((fbeCurrentSize + uint8b2.fbeSize()) <= fbeStructSize)
            fbeValue.uint8b2 = uint8b2.get(com.chronoxor.EnumUInt8.ENUM_VALUE_2);
        else
            fbeValue.uint8b2 = com.chronoxor.EnumUInt8.ENUM_VALUE_2;
        fbeCurrentSize += uint8b2.fbeSize();

        if ((fbeCurrentSize + uint8b3.fbeSize()) <= fbeStructSize)
            fbeValue.uint8b3 = uint8b3.get(com.chronoxor.EnumUInt8.ENUM_VALUE_3);
        else
            fbeValue.uint8b3 = com.chronoxor.EnumUInt8.ENUM_VALUE_3;
        fbeCurrentSize += uint8b3.fbeSize();

        if ((fbeCurrentSize + uint8b4.fbeSize()) <= fbeStructSize)
            fbeValue.uint8b4 = uint8b4.get(com.chronoxor.EnumUInt8.ENUM_VALUE_4);
        else
            fbeValue.uint8b4 = com.chronoxor.EnumUInt8.ENUM_VALUE_4;
        fbeCurrentSize += uint8b4.fbeSize();

        if ((fbeCurrentSize + uint8b5.fbeSize()) <= fbeStructSize)
            fbeValue.uint8b5 = uint8b5.get(com.chronoxor.EnumUInt8.ENUM_VALUE_5);
        else
            fbeValue.uint8b5 = com.chronoxor.EnumUInt8.ENUM_VALUE_5;
        fbeCurrentSize += uint8b5.fbeSize();

        if ((fbeCurrentSize + int16b0.fbeSize()) <= fbeStructSize)
            fbeValue.int16b0 = int16b0.get(com.chronoxor.EnumInt16.ENUM_VALUE_0);
        else
            fbeValue.int16b0 = com.chronoxor.EnumInt16.ENUM_VALUE_0;
        fbeCurrentSize += int16b0.fbeSize();

        if ((fbeCurrentSize + int16b1.fbeSize()) <= fbeStructSize)
            fbeValue.int16b1 = int16b1.get(com.chronoxor.EnumInt16.ENUM_VALUE_1);
        else
            fbeValue.int16b1 = com.chronoxor.EnumInt16.ENUM_VALUE_1;
        fbeCurrentSize += int16b1.fbeSize();

        if ((fbeCurrentSize + int16b2.fbeSize()) <= fbeStructSize)
            fbeValue.int16b2 = int16b2.get(com.chronoxor.EnumInt16.ENUM_VALUE_2);
        else
            fbeValue.int16b2 = com.chronoxor.EnumInt16.ENUM_VALUE_2;
        fbeCurrentSize += int16b2.fbeSize();

        if ((fbeCurrentSize + int16b3.fbeSize()) <= fbeStructSize)
            fbeValue.int16b3 = int16b3.get(com.chronoxor.EnumInt16.ENUM_VALUE_3);
        else
            fbeValue.int16b3 = com.chronoxor.EnumInt16.ENUM_VALUE_3;
        fbeCurrentSize += int16b3.fbeSize();

        if ((fbeCurrentSize + int16b4.fbeSize()) <= fbeStructSize)
            fbeValue.int16b4 = int16b4.get(com.chronoxor.EnumInt16.ENUM_VALUE_4);
        else
            fbeValue.int16b4 = com.chronoxor.EnumInt16.ENUM_VALUE_4;
        fbeCurrentSize += int16b4.fbeSize();

        if ((fbeCurrentSize + int16b5.fbeSize()) <= fbeStructSize)
            fbeValue.int16b5 = int16b5.get(com.chronoxor.EnumInt16.ENUM_VALUE_5);
        else
            fbeValue.int16b5 = com.chronoxor.EnumInt16.ENUM_VALUE_5;
        fbeCurrentSize += int16b5.fbeSize();

        if ((fbeCurrentSize + uint16b0.fbeSize()) <= fbeStructSize)
            fbeValue.uint16b0 = uint16b0.get(com.chronoxor.EnumUInt16.ENUM_VALUE_0);
        else
            fbeValue.uint16b0 = com.chronoxor.EnumUInt16.ENUM_VALUE_0;
        fbeCurrentSize += uint16b0.fbeSize();

        if ((fbeCurrentSize + uint16b1.fbeSize()) <= fbeStructSize)
            fbeValue.uint16b1 = uint16b1.get(com.chronoxor.EnumUInt16.ENUM_VALUE_1);
        else
            fbeValue.uint16b1 = com.chronoxor.EnumUInt16.ENUM_VALUE_1;
        fbeCurrentSize += uint16b1.fbeSize();

        if ((fbeCurrentSize + uint16b2.fbeSize()) <= fbeStructSize)
            fbeValue.uint16b2 = uint16b2.get(com.chronoxor.EnumUInt16.ENUM_VALUE_2);
        else
            fbeValue.uint16b2 = com.chronoxor.EnumUInt16.ENUM_VALUE_2;
        fbeCurrentSize += uint16b2.fbeSize();

        if ((fbeCurrentSize + uint16b3.fbeSize()) <= fbeStructSize)
            fbeValue.uint16b3 = uint16b3.get(com.chronoxor.EnumUInt16.ENUM_VALUE_3);
        else
            fbeValue.uint16b3 = com.chronoxor.EnumUInt16.ENUM_VALUE_3;
        fbeCurrentSize += uint16b3.fbeSize();

        if ((fbeCurrentSize + uint16b4.fbeSize()) <= fbeStructSize)
            fbeValue.uint16b4 = uint16b4.get(com.chronoxor.EnumUInt16.ENUM_VALUE_4);
        else
            fbeValue.uint16b4 = com.chronoxor.EnumUInt16.ENUM_VALUE_4;
        fbeCurrentSize += uint16b4.fbeSize();

        if ((fbeCurrentSize + uint16b5.fbeSize()) <= fbeStructSize)
            fbeValue.uint16b5 = uint16b5.get(com.chronoxor.EnumUInt16.ENUM_VALUE_5);
        else
            fbeValue.uint16b5 = com.chronoxor.EnumUInt16.ENUM_VALUE_5;
        fbeCurrentSize += uint16b5.fbeSize();

        if ((fbeCurrentSize + int32b0.fbeSize()) <= fbeStructSize)
            fbeValue.int32b0 = int32b0.get(com.chronoxor.EnumInt32.ENUM_VALUE_0);
        else
            fbeValue.int32b0 = com.chronoxor.EnumInt32.ENUM_VALUE_0;
        fbeCurrentSize += int32b0.fbeSize();

        if ((fbeCurrentSize + int32b1.fbeSize()) <= fbeStructSize)
            fbeValue.int32b1 = int32b1.get(com.chronoxor.EnumInt32.ENUM_VALUE_1);
        else
            fbeValue.int32b1 = com.chronoxor.EnumInt32.ENUM_VALUE_1;
        fbeCurrentSize += int32b1.fbeSize();

        if ((fbeCurrentSize + int32b2.fbeSize()) <= fbeStructSize)
            fbeValue.int32b2 = int32b2.get(com.chronoxor.EnumInt32.ENUM_VALUE_2);
        else
            fbeValue.int32b2 = com.chronoxor.EnumInt32.ENUM_VALUE_2;
        fbeCurrentSize += int32b2.fbeSize();

        if ((fbeCurrentSize + int32b3.fbeSize()) <= fbeStructSize)
            fbeValue.int32b3 = int32b3.get(com.chronoxor.EnumInt32.ENUM_VALUE_3);
        else
            fbeValue.int32b3 = com.chronoxor.EnumInt32.ENUM_VALUE_3;
        fbeCurrentSize += int32b3.fbeSize();

        if ((fbeCurrentSize + int32b4.fbeSize()) <= fbeStructSize)
            fbeValue.int32b4 = int32b4.get(com.chronoxor.EnumInt32.ENUM_VALUE_4);
        else
            fbeValue.int32b4 = com.chronoxor.EnumInt32.ENUM_VALUE_4;
        fbeCurrentSize += int32b4.fbeSize();

        if ((fbeCurrentSize + int32b5.fbeSize()) <= fbeStructSize)
            fbeValue.int32b5 = int32b5.get(com.chronoxor.EnumInt32.ENUM_VALUE_5);
        else
            fbeValue.int32b5 = com.chronoxor.EnumInt32.ENUM_VALUE_5;
        fbeCurrentSize += int32b5.fbeSize();

        if ((fbeCurrentSize + uint32b0.fbeSize()) <= fbeStructSize)
            fbeValue.uint32b0 = uint32b0.get(com.chronoxor.EnumUInt32.ENUM_VALUE_0);
        else
            fbeValue.uint32b0 = com.chronoxor.EnumUInt32.ENUM_VALUE_0;
        fbeCurrentSize += uint32b0.fbeSize();

        if ((fbeCurrentSize + uint32b1.fbeSize()) <= fbeStructSize)
            fbeValue.uint32b1 = uint32b1.get(com.chronoxor.EnumUInt32.ENUM_VALUE_1);
        else
            fbeValue.uint32b1 = com.chronoxor.EnumUInt32.ENUM_VALUE_1;
        fbeCurrentSize += uint32b1.fbeSize();

        if ((fbeCurrentSize + uint32b2.fbeSize()) <= fbeStructSize)
            fbeValue.uint32b2 = uint32b2.get(com.chronoxor.EnumUInt32.ENUM_VALUE_2);
        else
            fbeValue.uint32b2 = com.chronoxor.EnumUInt32.ENUM_VALUE_2;
        fbeCurrentSize += uint32b2.fbeSize();

        if ((fbeCurrentSize + uint32b3.fbeSize()) <= fbeStructSize)
            fbeValue.uint32b3 = uint32b3.get(com.chronoxor.EnumUInt32.ENUM_VALUE_3);
        else
            fbeValue.uint32b3 = com.chronoxor.EnumUInt32.ENUM_VALUE_3;
        fbeCurrentSize += uint32b3.fbeSize();

        if ((fbeCurrentSize + uint32b4.fbeSize()) <= fbeStructSize)
            fbeValue.uint32b4 = uint32b4.get(com.chronoxor.EnumUInt32.ENUM_VALUE_4);
        else
            fbeValue.uint32b4 = com.chronoxor.EnumUInt32.ENUM_VALUE_4;
        fbeCurrentSize += uint32b4.fbeSize();

        if ((fbeCurrentSize + uint32b5.fbeSize()) <= fbeStructSize)
            fbeValue.uint32b5 = uint32b5.get(com.chronoxor.EnumUInt32.ENUM_VALUE_5);
        else
            fbeValue.uint32b5 = com.chronoxor.EnumUInt32.ENUM_VALUE_5;
        fbeCurrentSize += uint32b5.fbeSize();

        if ((fbeCurrentSize + int64b0.fbeSize()) <= fbeStructSize)
            fbeValue.int64b0 = int64b0.get(com.chronoxor.EnumInt64.ENUM_VALUE_0);
        else
            fbeValue.int64b0 = com.chronoxor.EnumInt64.ENUM_VALUE_0;
        fbeCurrentSize += int64b0.fbeSize();

        if ((fbeCurrentSize + int64b1.fbeSize()) <= fbeStructSize)
            fbeValue.int64b1 = int64b1.get(com.chronoxor.EnumInt64.ENUM_VALUE_1);
        else
            fbeValue.int64b1 = com.chronoxor.EnumInt64.ENUM_VALUE_1;
        fbeCurrentSize += int64b1.fbeSize();

        if ((fbeCurrentSize + int64b2.fbeSize()) <= fbeStructSize)
            fbeValue.int64b2 = int64b2.get(com.chronoxor.EnumInt64.ENUM_VALUE_2);
        else
            fbeValue.int64b2 = com.chronoxor.EnumInt64.ENUM_VALUE_2;
        fbeCurrentSize += int64b2.fbeSize();

        if ((fbeCurrentSize + int64b3.fbeSize()) <= fbeStructSize)
            fbeValue.int64b3 = int64b3.get(com.chronoxor.EnumInt64.ENUM_VALUE_3);
        else
            fbeValue.int64b3 = com.chronoxor.EnumInt64.ENUM_VALUE_3;
        fbeCurrentSize += int64b3.fbeSize();

        if ((fbeCurrentSize + int64b4.fbeSize()) <= fbeStructSize)
            fbeValue.int64b4 = int64b4.get(com.chronoxor.EnumInt64.ENUM_VALUE_4);
        else
            fbeValue.int64b4 = com.chronoxor.EnumInt64.ENUM_VALUE_4;
        fbeCurrentSize += int64b4.fbeSize();

        if ((fbeCurrentSize + int64b5.fbeSize()) <= fbeStructSize)
            fbeValue.int64b5 = int64b5.get(com.chronoxor.EnumInt64.ENUM_VALUE_5);
        else
            fbeValue.int64b5 = com.chronoxor.EnumInt64.ENUM_VALUE_5;
        fbeCurrentSize += int64b5.fbeSize();

        if ((fbeCurrentSize + uint64b0.fbeSize()) <= fbeStructSize)
            fbeValue.uint64b0 = uint64b0.get(com.chronoxor.EnumUInt64.ENUM_VALUE_0);
        else
            fbeValue.uint64b0 = com.chronoxor.EnumUInt64.ENUM_VALUE_0;
        fbeCurrentSize += uint64b0.fbeSize();

        if ((fbeCurrentSize + uint64b1.fbeSize()) <= fbeStructSize)
            fbeValue.uint64b1 = uint64b1.get(com.chronoxor.EnumUInt64.ENUM_VALUE_1);
        else
            fbeValue.uint64b1 = com.chronoxor.EnumUInt64.ENUM_VALUE_1;
        fbeCurrentSize += uint64b1.fbeSize();

        if ((fbeCurrentSize + uint64b2.fbeSize()) <= fbeStructSize)
            fbeValue.uint64b2 = uint64b2.get(com.chronoxor.EnumUInt64.ENUM_VALUE_2);
        else
            fbeValue.uint64b2 = com.chronoxor.EnumUInt64.ENUM_VALUE_2;
        fbeCurrentSize += uint64b2.fbeSize();

        if ((fbeCurrentSize + uint64b3.fbeSize()) <= fbeStructSize)
            fbeValue.uint64b3 = uint64b3.get(com.chronoxor.EnumUInt64.ENUM_VALUE_3);
        else
            fbeValue.uint64b3 = com.chronoxor.EnumUInt64.ENUM_VALUE_3;
        fbeCurrentSize += uint64b3.fbeSize();

        if ((fbeCurrentSize + uint64b4.fbeSize()) <= fbeStructSize)
            fbeValue.uint64b4 = uint64b4.get(com.chronoxor.EnumUInt64.ENUM_VALUE_4);
        else
            fbeValue.uint64b4 = com.chronoxor.EnumUInt64.ENUM_VALUE_4;
        fbeCurrentSize += uint64b4.fbeSize();

        if ((fbeCurrentSize + uint64b5.fbeSize()) <= fbeStructSize)
            fbeValue.uint64b5 = uint64b5.get(com.chronoxor.EnumUInt64.ENUM_VALUE_5);
        else
            fbeValue.uint64b5 = com.chronoxor.EnumUInt64.ENUM_VALUE_5;
        fbeCurrentSize += uint64b5.fbeSize();
    }
