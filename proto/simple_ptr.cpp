...
Simple::Simple(const FBEString& arg_info, std::unique_ptr<::simple::Simple> arg_simple, int32_t arg_depth, FastVec<std::unique_ptr<::simple::Simple>> arg_spv, FastVec<::simple::Simple> arg_sv, FBE::map<int32_t, std::unique_ptr<::simple::Simple>> arg_spm, FBE::map<int32_t, ::simple::Simple> arg_sm)
    : info(arg_info)
