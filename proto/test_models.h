...
// Fast Binary Encoding ::test::Struct128 field model
template <>
class FieldModel<::test::Struct128>
{
public:
    FieldModel(FBEBuffer& buffer, size_t offset) noexcept;
    ...
    // Get the struct value
    void get(::test::Struct128& fbe_value) const noexcept;
    // Get the struct fields values
    void get_fields(::test::Struct128& fbe_value, size_t fbe_struct_size) const noexcept;
    ...
    // Set the struct value
    void set(const ::test::Struct128& fbe_value) noexcept;
    // Set the struct fields values
    void set_fields(const ::test::Struct128& fbe_value) noexcept;
...
public:
    ...
    size_t fbe_size() const noexcept { return model.fbe_size() + model.fbe_extra(); }
    // Get the model type
    static constexpr size_t fbe_type() noexcept { return FieldModel<::test::Struct128>::fbe_type(); }
    ...
    // Serialize the struct value
    size_t serialize(const ::test::Struct128& value);
    // Deserialize the struct value
    size_t deserialize(::test::Struct128& value) const noexcept;

    // Move to the next struct value
    void next(size_t prev) noexcept { model.fbe_shift(prev); }

public:
    FieldModel<::test::Struct128> model;
};
