...
void FieldModel<::variants_ptr::Expr>::get(::variants_ptr::Expr& fbe_value) const noexcept
{
    ...
    switch(variant_type_index) {
        ...
        case 4: {
            FieldModelVector<uint8_t> fbe_model(_buffer, 4);
            fbe_value.emplace<FastVec<uint8_t>>();
...
[this, fbe_variant_index = fbe_value.index()](std::monostate v) {
            ...
            , [this, fbe_variant_index = fbe_value.index()](const FastVec<uint8_t>& v) {
                FieldModelVector<uint8_t> fbe_model(_buffer, 4);
                size_t fbe_begin = set_begin(fbe_model.fbe_size(), fbe_variant_index);
                if (fbe_begin == 0)
                    return;
...
void FieldModelPtr_variants_ptr_ExprContainer::get(::variants_ptr::ExprContainer** fbe_value) noexcept
{
    size_t fbe_begin = get_begin();
    if (fbe_begin == 0)
        return;
...
void FieldModelPtr_variants_ptr_ExprContainer::set(const ::variants_ptr::ExprContainer* fbe_value) noexcept
{
    size_t fbe_begin = set_begin(fbe_value != nullptr);
    if (fbe_begin == 0)
        return;
...
void FieldModel_variants_ptr_ExprContainer::get(::FBE::Base& fbe_value) noexcept
{
    size_t fbe_begin = get_begin();
    if (fbe_begin == 0)
        return;
...
void FieldModel_variants_ptr_ExprContainer::get_fields([[maybe_unused]] ::FBE::Base& base_fbe_value, [[maybe_unused]] size_t fbe_struct_size) noexcept
{
...
void FieldModel_variants_ptr_ExprContainer::set(const ::FBE::Base& fbe_value) noexcept
{
    size_t fbe_begin = set_begin();
    if (fbe_begin == 0)
        return;
...
void FieldModel_variants_ptr_ExprContainer::set_fields([[maybe_unused]] const ::FBE::Base& base_fbe_value) noexcept
{
...
size_t ExprContainerModel::serialize(const ::variants_ptr::ExprContainer& value)
{
    size_t fbe_begin = create_begin();
    model.set(value);
    size_t fbe_full_size = create_end(fbe_begin);
...
size_t ExprContainerModel::deserialize(::variants_ptr::ExprContainer& value) noexcept
{
    if ((this->buffer().offset() + model.fbe_offset() - 4) > this->buffer().size())
        return 0;
