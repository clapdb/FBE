...
FinalModel<::arena_pmr::Item>::FinalModel(FBEBuffer& buffer, size_t offset) noexcept : _buffer(buffer), _offset(offset)
    , optr(buffer, 0)
    , alias(buffer, 0)
...
size_t FinalModel<::arena_pmr::Item>::fbe_allocation_size(const ::arena_pmr::Item& fbe_value) const noexcept
{
    size_t fbe_result = 0
...
size_t FinalModel<::arena_pmr::Item>::verify() const noexcept
{
...
size_t FinalModel<::arena_pmr::Item>::verify_fields() const noexcept
{
...
size_t FinalModel<::arena_pmr::Item>::get(::arena_pmr::Item& fbe_value) const noexcept
{
    _buffer.shift(fbe_offset());
...
size_t FinalModel<::arena_pmr::Item>::get_fields([[maybe_unused]] ::arena_pmr::Item& fbe_value) const noexcept
{
    size_t fbe_current_offset = 0;
...
size_t FinalModel<::arena_pmr::Item>::get(::arena_pmr::Item& fbe_value, [[maybe_unused]] std::pmr::memory_resource* resource) const noexcept
{
    _buffer.shift(fbe_offset());
...
size_t FinalModel<::arena_pmr::Item>::get_fields([[maybe_unused]] ::arena_pmr::Item& fbe_value, [[maybe_unused]] std::pmr::memory_resource* resource) const noexcept
{
    size_t fbe_current_offset = 0;
    size_t fbe_current_size = 0;
    [[maybe_unused]] size_t fbe_field_size;
    ...
    optr.fbe_offset(fbe_current_offset);
    fbe_field_size = optr.get(fbe_value.optr, resource);
    fbe_current_offset += fbe_field_size;
    fbe_current_size += fbe_field_size;

    alias.fbe_offset(fbe_current_offset);
    fbe_field_size = alias.get(fbe_value.alias, resource);
    fbe_current_offset += fbe_field_size;
    fbe_current_size += fbe_field_size;

    expressions.fbe_offset(fbe_current_offset);
    fbe_field_size = expressions.get(fbe_value.expressions, resource);
    fbe_current_offset += fbe_field_size;
    fbe_current_size += fbe_field_size;

    aliases_int.fbe_offset(fbe_current_offset);
    fbe_field_size = aliases_int.get(fbe_value.aliases_int, resource);
    fbe_current_offset += fbe_field_size;
    fbe_current_size += fbe_field_size;
...
size_t FinalModel<::arena_pmr::Item>::set(const ::arena_pmr::Item& fbe_value) noexcept
{
    _buffer.shift(fbe_offset());
...
size_t FinalModel<::arena_pmr::Item>::set_fields([[maybe_unused]] const ::arena_pmr::Item& fbe_value) noexcept
{
    size_t fbe_current_offset = 0;
    size_t fbe_current_size = 0;
    [[maybe_unused]] size_t fbe_field_size;
...
size_t ItemFinalModel::serialize(const ::arena_pmr::Item& value)
{
...
size_t ItemFinalModel::deserialize(::arena_pmr::Item& value) const noexcept
{
...
size_t ItemFinalModel::deserialize(::arena_pmr::Item& value, std::pmr::memory_resource* resource) const noexcept
{
    assert(((this->buffer().offset() + _model.fbe_offset()) <= this->buffer().size()) && "Model is broken!");
    if ((this->buffer().offset() + _model.fbe_offset()) > this->buffer().size())
        return 0;
...
FinalModel<::arena_pmr::Item2>::FinalModel(FBEBuffer& buffer, size_t offset) noexcept : _buffer(buffer), _offset(offset)
    , bytes_v(buffer, 0)
{}

size_t FinalModel<::arena_pmr::Item2>::fbe_allocation_size(const ::arena_pmr::Item2& fbe_value) const noexcept
{
    size_t fbe_result = 0
...
size_t FinalModel<::arena_pmr::Item2>::verify() const noexcept
{
    _buffer.shift(fbe_offset());
    size_t fbe_result = verify_fields();
    _buffer.unshift(fbe_offset());
...
size_t FinalModel<::arena_pmr::Item2>::verify_fields() const noexcept
{
    size_t fbe_current_offset = 0;
    [[maybe_unused]] size_t fbe_field_size;
...
size_t FinalModel<::arena_pmr::Item2>::get(::arena_pmr::Item2& fbe_value) const noexcept
{
    _buffer.shift(fbe_offset());
    size_t fbe_result = get_fields(fbe_value);
    _buffer.unshift(fbe_offset());
...
size_t FinalModel<::arena_pmr::Item2>::get_fields([[maybe_unused]] ::arena_pmr::Item2& fbe_value) const noexcept
{
    size_t fbe_current_offset = 0;
    size_t fbe_current_size = 0;
    [[maybe_unused]] size_t fbe_field_size;
...
size_t FinalModel<::arena_pmr::Item2>::get(::arena_pmr::Item2& fbe_value, [[maybe_unused]] std::pmr::memory_resource* resource) const noexcept
{
    _buffer.shift(fbe_offset());
    size_t fbe_result = get_fields(fbe_value, resource);
    _buffer.unshift(fbe_offset());
...
size_t FinalModel<::arena_pmr::Item2>::get_fields([[maybe_unused]] ::arena_pmr::Item2& fbe_value, [[maybe_unused]] std::pmr::memory_resource* resource) const noexcept
{
    size_t fbe_current_offset = 0;
    size_t fbe_current_size = 0;
    [[maybe_unused]] size_t fbe_field_size;
    ...
    bytes_v.fbe_offset(fbe_current_offset);
    fbe_field_size = bytes_v.get(fbe_value.bytes_v, resource);
    fbe_current_offset += fbe_field_size;
    fbe_current_size += fbe_field_size;
...
size_t FinalModel<::arena_pmr::Item2>::set(const ::arena_pmr::Item2& fbe_value) noexcept
{
    _buffer.shift(fbe_offset());
    size_t fbe_result = set_fields(fbe_value);
    _buffer.unshift(fbe_offset());
...
size_t FinalModel<::arena_pmr::Item2>::set_fields([[maybe_unused]] const ::arena_pmr::Item2& fbe_value) noexcept
{
    size_t fbe_current_offset = 0;
    size_t fbe_current_size = 0;
    [[maybe_unused]] size_t fbe_field_size;
...
size_t Item2FinalModel::serialize(const ::arena_pmr::Item2& value)
{
    size_t fbe_initial_size = this->buffer().size();
...
size_t Item2FinalModel::deserialize(::arena_pmr::Item2& value) const noexcept
{
    assert(((this->buffer().offset() + _model.fbe_offset()) <= this->buffer().size()) && "Model is broken!");
    if ((this->buffer().offset() + _model.fbe_offset()) > this->buffer().size())
        return 0;
...
size_t Item2FinalModel::deserialize(::arena_pmr::Item2& value, std::pmr::memory_resource* resource) const noexcept
{
    assert(((this->buffer().offset() + _model.fbe_offset()) <= this->buffer().size()) && "Model is broken!");
    if ((this->buffer().offset() + _model.fbe_offset()) > this->buffer().size())
        return 0;
