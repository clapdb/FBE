...
StructSimple::StructSimple([[maybe_unused]] allocator_type alloc)
    : id((int32_t)0ll)
    , f1(false)
    , f2(true)
    , f3((uint8_t)0u)
    ...
    , f37(FBE::uuid_t::sequential())
    , f38(FBE::uuid_t("123e4567-e89b-12d3-a456-426655440000"))
    , f39(assign_member<::proto_pmr::OrderSide>(alloc))
    , f40(assign_member<::proto_pmr::OrderType>(alloc))
    , f41(assign_member<::proto_pmr::Order>(alloc))
    , f42(assign_member<::proto_pmr::Balance>(alloc))
    , f43(assign_member<::proto_pmr::State>(alloc))
    , f44(assign_member<::proto_pmr::Account>(alloc))
{}
...
StructOptional::StructOptional([[maybe_unused]] allocator_type alloc)
    : ::test_pmr::StructSimple()
    , f100(std::nullopt)
    , f101(std::nullopt)
    , f102(std::nullopt)
...
{
    return (
        ::test_pmr::StructSimple::operator==(other)
        && (f100 == other.f100)
        && (f101 == other.f101)
        && (f102 == other.f102)
        && (f103 == other.f103)
...
bool StructOptional::operator<([[maybe_unused]] const StructOptional& other) const noexcept
{
    if (::test_pmr::StructSimple::operator<(other))
        return true;
    if (other.::test_pmr::StructSimple::operator<(*this))
        return false;
    return false;
}
...
{
    using std::swap;
    ::test_pmr::StructSimple::swap(other);
...
std::ostream& operator<<(std::ostream& stream, [[maybe_unused]] const StructOptional& value)
{
    ...
    stream << (const ::test_pmr::StructSimple&)value;
...
StructNested::StructNested([[maybe_unused]] allocator_type alloc)
    : ::test_pmr::StructOptional()
    , f1000()
    , f1001(std::nullopt)
    , f1002(EnumTyped::ENUM_VALUE_2)
...
StructNested::StructNested(const ::test_pmr::StructOptional& base, const ::test_pmr::EnumSimple& arg_f1000, const std::optional<::test_pmr::EnumSimple>& arg_f1001, const ::test_pmr::EnumTyped& arg_f1002, const std::optional<::test_pmr::EnumTyped>& arg_f1003, const ::test_pmr::FlagsSimple& arg_f1004, const std::optional<::test_pmr::FlagsSimple>& arg_f1005, const ::test_pmr::FlagsTyped& arg_f1006, const std::optional<::test_pmr::FlagsTyped>& arg_f1007, const ::test_pmr::StructSimple& arg_f1008, const std::optional<::test_pmr::StructSimple>& arg_f1009, const ::test_pmr::StructOptional& arg_f1010, const std::optional<::test_pmr::StructOptional>& arg_f1011)
    : ::test_pmr::StructOptional(base)
    , f1000(arg_f1000)
    , f1001(arg_f1001)
    , f1002(arg_f1002)
    , f1003(arg_f1003)
...
{
    return (
        ::test_pmr::StructOptional::operator==(other)
        && (f1000 == other.f1000)
        && (f1001 == other.f1001)
        && (f1002 == other.f1002)
        && (f1003 == other.f1003)
...
bool StructNested::operator<([[maybe_unused]] const StructNested& other) const noexcept
{
    if (::test_pmr::StructOptional::operator<(other))
        return true;
    if (other.::test_pmr::StructOptional::operator<(*this))
        return false;
    return false;
}
...
{
    using std::swap;
    ::test_pmr::StructOptional::swap(other);
...
{
    stream << "StructNested(";
    stream << (const ::test_pmr::StructOptional&)value;
...
StructBytes::StructBytes([[maybe_unused]] allocator_type alloc)
    : f1(alloc)
    , f2(std::nullopt)
    , f3(std::nullopt)
{}

StructBytes::StructBytes(const FBE::pmr_buffer_t& arg_f1, const std::optional<FBE::pmr_buffer_t>& arg_f2, const std::optional<FBE::pmr_buffer_t>& arg_f3)
    : f1(arg_f1)
    , f2(arg_f2)
    , f3(arg_f3)
{}
...
StructArray::StructArray([[maybe_unused]] allocator_type alloc)
    : f1()
    , f2()
    , f3()
    , f4()
...
StructVector::StructVector([[maybe_unused]] allocator_type alloc)
    : f1(alloc)
    , f2(alloc)
    , f3(alloc)
    , f4(alloc)
...
StructList::StructList([[maybe_unused]] allocator_type alloc)
    : f1(alloc)
    , f2(alloc)
    , f3(alloc)
    , f4(alloc)
...
StructSet::StructSet([[maybe_unused]] allocator_type alloc)
    : f1(alloc)
    , f2(alloc)
    , f3(alloc)
    , f4(alloc)
...
StructMap::StructMap([[maybe_unused]] allocator_type alloc)
    : f1(alloc)
    , f2(alloc)
    , f3(alloc)
    , f4(alloc)
...
StructHash::StructHash([[maybe_unused]] allocator_type alloc)
    : f1(alloc)
    , f2(alloc)
    , f3(alloc)
    , f4(alloc)
...
StructHashEx::StructHashEx([[maybe_unused]] allocator_type alloc)
    : f1(alloc)
    , f2(alloc)
{}
...
StructEmpty::StructEmpty([[maybe_unused]] allocator_type alloc)
{}
