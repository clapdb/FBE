...
public:
    ...
    void get(::osa_pmr::Extra& fbe_value, pmr::memory_resource* resource) const noexcept;
    // Get the struct fields values
    void get_fields(::osa_pmr::Extra& fbe_value, size_t fbe_struct_size, pmr::memory_resource* resource) const noexcept;
    ...
    void set(const ::osa_pmr::Extra& fbe_value, pmr::memory_resource* resource) noexcept;
    // Set the struct fields values
    void set_fields(const ::osa_pmr::Extra& fbe_value, pmr::memory_resource* resource) noexcept;
...
public:
    ...
    size_t serialize(const ::osa_pmr::Extra& value, pmr::memory_resource* resource);
    // Deserialize the struct value
    size_t deserialize(::osa_pmr::Extra& value, pmr::memory_resource* resource) const noexcept;
...
public:
    ...
    // Get the struct value
    void get(::osa_pmr::Simple& fbe_value, pmr::memory_resource* resource) const noexcept;
    // Get the struct fields values
    void get_fields(::osa_pmr::Simple& fbe_value, size_t fbe_struct_size, pmr::memory_resource* resource) const noexcept;
    ...
    // Set the struct value
    void set(const ::osa_pmr::Simple& fbe_value, pmr::memory_resource* resource) noexcept;
    // Set the struct fields values
    void set_fields(const ::osa_pmr::Simple& fbe_value, pmr::memory_resource* resource) noexcept;
...
public:
    ...
    // Serialize the struct value
    size_t serialize(const ::osa_pmr::Simple& value, pmr::memory_resource* resource);
    // Deserialize the struct value
    size_t deserialize(::osa_pmr::Simple& value, pmr::memory_resource* resource) const noexcept;
