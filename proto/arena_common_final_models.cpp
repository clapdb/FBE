...
size_t FinalModel<::arena_common::Expr>::fbe_allocation_size(const ::arena_common::Expr& fbe_value) const noexcept
{
...
size_t FinalModel<::arena_common::Expr>::verify() const noexcept
{
...
size_t FinalModel<::arena_common::Expr>::get(::arena_common::Expr& fbe_value) const noexcept
{
    size_t fbe_full_offset = _buffer.offset() + fbe_offset();
...
size_t FinalModel<::arena_common::Expr>::set(const ::arena_common::Expr& fbe_value) noexcept
{
    size_t fbe_full_offset = _buffer.offset() + fbe_offset();
    assert(((fbe_full_offset + 4) <= _buffer.size()) && "Model is broken!");
    if ((fbe_full_offset + 4) > _buffer.size())
...
FinalModel<::arena_common::Alias>::FinalModel(FBEBuffer& buffer, size_t offset) noexcept : _buffer(buffer), _offset(offset)
    , name(buffer, 0)
    , optr(buffer, 0)
    , expr(buffer, 0)
{}

size_t FinalModel<::arena_common::Alias>::fbe_allocation_size(const ::arena_common::Alias& fbe_value) const noexcept
{
    size_t fbe_result = 0
...
size_t FinalModel<::arena_common::Alias>::verify() const noexcept
{
...
size_t FinalModel<::arena_common::Alias>::verify_fields() const noexcept
{
...
size_t FinalModel<::arena_common::Alias>::get(::arena_common::Alias& fbe_value) const noexcept
{
    _buffer.shift(fbe_offset());
...
size_t FinalModel<::arena_common::Alias>::get_fields([[maybe_unused]] ::arena_common::Alias& fbe_value) const noexcept
{
    size_t fbe_current_offset = 0;
...
size_t FinalModel<::arena_common::Alias>::set(const ::arena_common::Alias& fbe_value) noexcept
{
    _buffer.shift(fbe_offset());
...
size_t FinalModel<::arena_common::Alias>::set_fields([[maybe_unused]] const ::arena_common::Alias& fbe_value) noexcept
{
    size_t fbe_current_offset = 0;
    size_t fbe_current_size = 0;
    [[maybe_unused]] size_t fbe_field_size;
...
size_t AliasFinalModel::serialize(const ::arena_common::Alias& value)
{
...
size_t AliasFinalModel::deserialize(::arena_common::Alias& value) const noexcept
{
...
FinalModel<::arena_common::Expression>::FinalModel(FBEBuffer& buffer, size_t offset) noexcept : _buffer(buffer), _offset(offset)
    , keys(buffer, 0)
    , aliases(buffer, 0)
    , alias_int(buffer, 0)
{}

size_t FinalModel<::arena_common::Expression>::fbe_allocation_size(const ::arena_common::Expression& fbe_value) const noexcept
{
    size_t fbe_result = 0
...
size_t FinalModel<::arena_common::Expression>::verify() const noexcept
{
    _buffer.shift(fbe_offset());
    size_t fbe_result = verify_fields();
    _buffer.unshift(fbe_offset());
...
size_t FinalModel<::arena_common::Expression>::verify_fields() const noexcept
{
    size_t fbe_current_offset = 0;
    [[maybe_unused]] size_t fbe_field_size;
...
size_t FinalModel<::arena_common::Expression>::get(::arena_common::Expression& fbe_value) const noexcept
{
    _buffer.shift(fbe_offset());
    size_t fbe_result = get_fields(fbe_value);
    _buffer.unshift(fbe_offset());
...
size_t FinalModel<::arena_common::Expression>::get_fields([[maybe_unused]] ::arena_common::Expression& fbe_value) const noexcept
{
    size_t fbe_current_offset = 0;
    size_t fbe_current_size = 0;
    [[maybe_unused]] size_t fbe_field_size;
...
size_t FinalModel<::arena_common::Expression>::set(const ::arena_common::Expression& fbe_value) noexcept
{
    _buffer.shift(fbe_offset());
    size_t fbe_result = set_fields(fbe_value);
    _buffer.unshift(fbe_offset());
...
size_t FinalModel<::arena_common::Expression>::set_fields([[maybe_unused]] const ::arena_common::Expression& fbe_value) noexcept
{
    size_t fbe_current_offset = 0;
    size_t fbe_current_size = 0;
    [[maybe_unused]] size_t fbe_field_size;
...
size_t ExpressionFinalModel::serialize(const ::arena_common::Expression& value)
{
    size_t fbe_initial_size = this->buffer().size();
...
size_t ExpressionFinalModel::deserialize(::arena_common::Expression& value) const noexcept
{
    assert(((this->buffer().offset() + _model.fbe_offset()) <= this->buffer().size()) && "Model is broken!");
    if ((this->buffer().offset() + _model.fbe_offset()) > this->buffer().size())
        return 0;
