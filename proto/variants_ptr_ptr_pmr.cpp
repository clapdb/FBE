...
ValueContainer::ValueContainer(std::pmr::vector<::variants_ptr_pmr::V> arg_vv, FBE::pmr::HashMap<int32_t, ::variants_ptr_pmr::V> arg_vm)
    : vv(std::move(arg_vv))
    , vm(std::move(arg_vm))
{}
...
Scalar1Container::Scalar1Container(FBE::pmr::HashMap<::variants_ptr_pmr::Scalar1, ::variants_ptr_pmr::Expr> arg_s)
    : s(std::move(arg_s))
{}
