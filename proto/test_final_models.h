...
// Fast Binary Encoding ::test::Struct128 final model
template <>
class FinalModel<::test::Struct128>
{
public:
    FinalModel(FBEBuffer& buffer, size_t offset) noexcept;

    // Get the allocation size
    size_t fbe_allocation_size(const ::test::Struct128& fbe_value) const noexcept;
    // Get the final offset
    size_t fbe_offset() const noexcept { return _offset; }
    // Set the final offset
    size_t fbe_offset(size_t offset) const noexcept { return _offset = offset; }
    ...
    // Get the struct value
    size_t get(::test::Struct128& fbe_value) const noexcept;
    // Get the struct fields values
    size_t get_fields(::test::Struct128& fbe_value) const noexcept;

    // Set the struct value
    size_t set(const ::test::Struct128& fbe_value) noexcept;
    // Set the struct fields values
    size_t set_fields(const ::test::Struct128& fbe_value) noexcept;
...
public:
    ...
    // Get the model type
    static constexpr size_t fbe_type() noexcept { return FinalModel<::test::Struct128>::fbe_type(); }
...
private:
    FinalModel<::test::Struct128> _model;
};
