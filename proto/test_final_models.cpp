...
FinalModel<::test::Struct128>::FinalModel(FBEBuffer& buffer, size_t offset) noexcept : _buffer(buffer), _offset(offset)
    , f1(buffer, 0)
    , f2(buffer, 0)
    , f3(buffer, 0)
    , f4(buffer, 0)
...
size_t FinalModel<::test::Struct128>::fbe_allocation_size(const ::test::Struct128& fbe_value) const noexcept
{
    size_t fbe_result = 0
        + f1.fbe_allocation_size(fbe_value.f1)
        + f2.fbe_allocation_size(fbe_value.f2)
...
size_t FinalModel<::test::Struct128>::verify() const noexcept
{
    _buffer.shift(fbe_offset());
    size_t fbe_result = verify_fields();
    _buffer.unshift(fbe_offset());
...
size_t FinalModel<::test::Struct128>::verify_fields() const noexcept
{
    size_t fbe_current_offset = 0;
    size_t fbe_field_size;
...
size_t FinalModel<::test::Struct128>::get(::test::Struct128& fbe_value) const noexcept
{
    _buffer.shift(fbe_offset());
    size_t fbe_result = get_fields(fbe_value);
    _buffer.unshift(fbe_offset());
...
size_t FinalModel<::test::Struct128>::get_fields([[maybe_unused]] ::test::Struct128& fbe_value) const noexcept
{
    size_t fbe_current_offset = 0;
    size_t fbe_current_size = 0;
    size_t fbe_field_size;
...
size_t FinalModel<::test::Struct128>::set(const ::test::Struct128& fbe_value) noexcept
{
    _buffer.shift(fbe_offset());
    size_t fbe_result = set_fields(fbe_value);
    _buffer.unshift(fbe_offset());
...
size_t FinalModel<::test::Struct128>::set_fields([[maybe_unused]] const ::test::Struct128& fbe_value) noexcept
{
    size_t fbe_current_offset = 0;
    size_t fbe_current_size = 0;
    size_t fbe_field_size;
...
size_t Struct128FinalModel::serialize(const ::test::Struct128& value)
{
    size_t fbe_initial_size = this->buffer().size();
...
size_t Struct128FinalModel::deserialize(::test::Struct128& value) const noexcept
{
    assert(((this->buffer().offset() + _model.fbe_offset()) <= this->buffer().size()) && "Model is broken!");
    if ((this->buffer().offset() + _model.fbe_offset()) > this->buffer().size())
        return 0;
