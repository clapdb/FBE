...
public:
    ...
    void get(::proto_pmr::Order& fbe_value, std::pmr::memory_resource* resource) const noexcept;
    // Get the struct fields values
    void get_fields(::proto_pmr::Order& fbe_value, size_t fbe_struct_size, std::pmr::memory_resource* resource) const noexcept;
    ...
    void set(const ::proto_pmr::Order& fbe_value, std::pmr::memory_resource* resource) noexcept;
    // Set the struct fields values
    void set_fields(const ::proto_pmr::Order& fbe_value, std::pmr::memory_resource* resource) noexcept;
...
public:
    ...
    size_t serialize(const ::proto_pmr::Order& value, std::pmr::memory_resource* resource);
...
public:
    ...
    // Get the struct value
    void get(::proto_pmr::Balance& fbe_value, std::pmr::memory_resource* resource) const noexcept;
    // Get the struct fields values
    void get_fields(::proto_pmr::Balance& fbe_value, size_t fbe_struct_size, std::pmr::memory_resource* resource) const noexcept;
    ...
    // Set the struct value
    void set(const ::proto_pmr::Balance& fbe_value, std::pmr::memory_resource* resource) noexcept;
    // Set the struct fields values
    void set_fields(const ::proto_pmr::Balance& fbe_value, std::pmr::memory_resource* resource) noexcept;
...
public:
    ...
    // Serialize the struct value
    size_t serialize(const ::proto_pmr::Balance& value, std::pmr::memory_resource* resource);
    // Deserialize the struct value
...
public:
    ...
    // Get the struct value
    void get(::proto_pmr::Account& fbe_value, std::pmr::memory_resource* resource) const noexcept;
    // Get the struct fields values
    void get_fields(::proto_pmr::Account& fbe_value, size_t fbe_struct_size, std::pmr::memory_resource* resource) const noexcept;
    ...
    // Set the struct value
    void set(const ::proto_pmr::Account& fbe_value, std::pmr::memory_resource* resource) noexcept;
    // Set the struct fields values
    void set_fields(const ::proto_pmr::Account& fbe_value, std::pmr::memory_resource* resource) noexcept;
...
public:
    ...
    // Serialize the struct value
    size_t serialize(const ::proto_pmr::Account& value, std::pmr::memory_resource* resource);
    // Deserialize the struct value
...
public:
    ...
    // Get the struct value
    void get(::proto_pmr::CharMap& fbe_value, std::pmr::memory_resource* resource) const noexcept;
    // Get the struct fields values
    void get_fields(::proto_pmr::CharMap& fbe_value, size_t fbe_struct_size, std::pmr::memory_resource* resource) const noexcept;
    ...
    // Set the struct value
    void set(const ::proto_pmr::CharMap& fbe_value, std::pmr::memory_resource* resource) noexcept;
    // Set the struct fields values
    void set_fields(const ::proto_pmr::CharMap& fbe_value, std::pmr::memory_resource* resource) noexcept;
...
public:
    ...
    // Serialize the struct value
    size_t serialize(const ::proto_pmr::CharMap& value, std::pmr::memory_resource* resource);
    // Deserialize the struct value
...
public:
    ...
    // Get the struct value
    void get(::proto_pmr::OrderMessage& fbe_value, std::pmr::memory_resource* resource) const noexcept;
    // Get the struct fields values
    void get_fields(::proto_pmr::OrderMessage& fbe_value, size_t fbe_struct_size, std::pmr::memory_resource* resource) const noexcept;
    ...
    // Set the struct value
    void set(const ::proto_pmr::OrderMessage& fbe_value, std::pmr::memory_resource* resource) noexcept;
    // Set the struct fields values
    void set_fields(const ::proto_pmr::OrderMessage& fbe_value, std::pmr::memory_resource* resource) noexcept;
...
public:
    ...
    // Serialize the struct value
    size_t serialize(const ::proto_pmr::OrderMessage& value, std::pmr::memory_resource* resource);
    // Deserialize the struct value
...
public:
    ...
    // Get the struct value
    void get(::proto_pmr::BalanceMessage& fbe_value, std::pmr::memory_resource* resource) const noexcept;
    // Get the struct fields values
    void get_fields(::proto_pmr::BalanceMessage& fbe_value, size_t fbe_struct_size, std::pmr::memory_resource* resource) const noexcept;
    ...
    // Set the struct value
    void set(const ::proto_pmr::BalanceMessage& fbe_value, std::pmr::memory_resource* resource) noexcept;
    // Set the struct fields values
    void set_fields(const ::proto_pmr::BalanceMessage& fbe_value, std::pmr::memory_resource* resource) noexcept;
...
public:
    ...
    // Serialize the struct value
    size_t serialize(const ::proto_pmr::BalanceMessage& value, std::pmr::memory_resource* resource);
    // Deserialize the struct value
...
public:
    ...
    // Get the struct value
    void get(::proto_pmr::AccountMessage& fbe_value, std::pmr::memory_resource* resource) const noexcept;
    // Get the struct fields values
    void get_fields(::proto_pmr::AccountMessage& fbe_value, size_t fbe_struct_size, std::pmr::memory_resource* resource) const noexcept;
    ...
    // Set the struct value
    void set(const ::proto_pmr::AccountMessage& fbe_value, std::pmr::memory_resource* resource) noexcept;
    // Set the struct fields values
    void set_fields(const ::proto_pmr::AccountMessage& fbe_value, std::pmr::memory_resource* resource) noexcept;
...
public:
    ...
    // Serialize the struct value
    size_t serialize(const ::proto_pmr::AccountMessage& value, std::pmr::memory_resource* resource);
    // Deserialize the struct value
...
public:
    ...
    // Get the struct value
    void get(::proto_pmr::PremiumAccount& fbe_value, std::pmr::memory_resource* resource) const noexcept;
    // Get the struct fields values
    void get_fields(::proto_pmr::PremiumAccount& fbe_value, size_t fbe_struct_size, std::pmr::memory_resource* resource) const noexcept;
    ...
    // Set the struct value
    void set(const ::proto_pmr::PremiumAccount& fbe_value, std::pmr::memory_resource* resource) noexcept;
    // Set the struct fields values
    void set_fields(const ::proto_pmr::PremiumAccount& fbe_value, std::pmr::memory_resource* resource) noexcept;
...
public:
    ...
    // Serialize the struct value
    size_t serialize(const ::proto_pmr::PremiumAccount& value, std::pmr::memory_resource* resource);
    // Deserialize the struct value
