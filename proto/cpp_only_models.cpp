...
void FieldModel<::cpp_only::LargeNum>::get(::cpp_only::LargeNum& fbe_value, std::pmr::memory_resource* resource) const noexcept
{
    if ((_buffer.offset() + fbe_offset() + fbe_size()) > _buffer.size())
        return;
    ...
    assert(variant_type_index <= 5 && "Model is broken!");
    ...
    switch(variant_type_index) {
        ...
        case 1: {
            FieldModel<int64_t> fbe_model(_buffer, 4);
            variant_emplace_value<::cpp_only::LargeNum, int64_t>(fbe_value, resource);
        ...
        case 2: {
            FieldModel<__int128_t> fbe_model(_buffer, 4);
            variant_emplace_value<::cpp_only::LargeNum, __int128_t>(fbe_value, resource);
        ...
        case 3: {
            FieldModel<__uint128_t> fbe_model(_buffer, 4);
            variant_emplace_value<::cpp_only::LargeNum, __uint128_t>(fbe_value, resource);
        ...
        case 4: {
            FieldModelVector<__int128_t> fbe_model(_buffer, 4);
            variant_emplace_value<::cpp_only::LargeNum, FastVec<__int128_t>>(fbe_value, resource);
        ...
        case 5: {
            FieldModelMap<__uint128_t, __int128_t> fbe_model(_buffer, 4);
            variant_emplace_value<::cpp_only::LargeNum, std::unordered_map<__uint128_t, __int128_t>>(fbe_value, resource);
...
void FieldModel<::cpp_only::LargeNum>::set(const ::cpp_only::LargeNum& fbe_value, std::pmr::memory_resource* resource) noexcept
{
    assert(((_buffer.offset() + fbe_offset() + fbe_size()) <= _buffer.size()) && "Model is broken!");
    if ((_buffer.offset() + fbe_offset() + fbe_size()) > _buffer.size())
        return;
    ...
    std::visit(
        overloaded
        {
            ...
            , [this, fbe_variant_index = fbe_value.index(), resource](__int128_t v) {
                FieldModel<__int128_t> fbe_model(_buffer, 4);
                size_t fbe_begin = set_begin(fbe_model.fbe_size(), fbe_variant_index);
                if (fbe_begin == 0)
                    return;
            ...
            , [this, fbe_variant_index = fbe_value.index(), resource](__uint128_t v) {
                FieldModel<__uint128_t> fbe_model(_buffer, 4);
                size_t fbe_begin = set_begin(fbe_model.fbe_size(), fbe_variant_index);
                if (fbe_begin == 0)
                    return;
            ...
            , [this, fbe_variant_index = fbe_value.index(), resource](const FastVec<__int128_t>& v) {
                FieldModelVector<__int128_t> fbe_model(_buffer, 4);
                size_t fbe_begin = set_begin(fbe_model.fbe_size(), fbe_variant_index);
                if (fbe_begin == 0)
                    return;
            ...
            , [this, fbe_variant_index = fbe_value.index(), resource](const std::unordered_map<__uint128_t, __int128_t>& v) {
                FieldModelMap<__uint128_t, __int128_t> fbe_model(_buffer, 4);
                size_t fbe_begin = set_begin(fbe_model.fbe_size(), fbe_variant_index);
                if (fbe_begin == 0)
                    return;
...
void FieldModel<::cpp_only::Struct128>::get(::cpp_only::Struct128& fbe_value, std::pmr::memory_resource* resource) const noexcept
{
...
void FieldModel<::cpp_only::Struct128>::get_fields([[maybe_unused]] ::cpp_only::Struct128& fbe_value, [[maybe_unused]] size_t fbe_struct_size, std::pmr::memory_resource* resource) const noexcept
{
    size_t fbe_current_size = 4 + 4;
...
void FieldModel<::cpp_only::Struct128>::set(const ::cpp_only::Struct128& fbe_value, std::pmr::memory_resource* resource) noexcept
{
...
void FieldModel<::cpp_only::Struct128>::set_fields([[maybe_unused]] const ::cpp_only::Struct128& fbe_value, std::pmr::memory_resource* resource) noexcept
{
...
size_t Struct128Model::serialize(const ::cpp_only::Struct128& value, std::pmr::memory_resource* resource)
{
...
size_t Struct128Model::deserialize(::cpp_only::Struct128& value, std::pmr::memory_resource* resource) const noexcept
{
    if ((this->buffer().offset() + model.fbe_offset() - 4) > this->buffer().size())
        return 0;
