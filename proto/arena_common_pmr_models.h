...
public:
    ...
    void get(::arena_common_pmr::Expr& fbe_value, std::pmr::memory_resource* resource) const noexcept;
    ...
    void set(const ::arena_common_pmr::Expr& fbe_value, std::pmr::memory_resource* resource) noexcept;
...
public:
    ...
    void get(::arena_common_pmr::Alias& fbe_value, std::pmr::memory_resource* resource) const noexcept;
    // Get the struct fields values
    void get_fields(::arena_common_pmr::Alias& fbe_value, size_t fbe_struct_size, std::pmr::memory_resource* resource) const noexcept;
    ...
    void set(const ::arena_common_pmr::Alias& fbe_value, std::pmr::memory_resource* resource) noexcept;
    // Set the struct fields values
    void set_fields(const ::arena_common_pmr::Alias& fbe_value, std::pmr::memory_resource* resource) noexcept;
...
public:
    ...
    size_t serialize(const ::arena_common_pmr::Alias& value, std::pmr::memory_resource* resource);
...
template<>
struct model_of<::arena_common_pmr::Alias> {
using type = arena_common_pmr::AliasModel;
};
...
public:
    ...
    // Get the struct value
    void get(::arena_common_pmr::Expression& fbe_value, std::pmr::memory_resource* resource) const noexcept;
    // Get the struct fields values
    void get_fields(::arena_common_pmr::Expression& fbe_value, size_t fbe_struct_size, std::pmr::memory_resource* resource) const noexcept;
    ...
    // Set the struct value
    void set(const ::arena_common_pmr::Expression& fbe_value, std::pmr::memory_resource* resource) noexcept;
    // Set the struct fields values
    void set_fields(const ::arena_common_pmr::Expression& fbe_value, std::pmr::memory_resource* resource) noexcept;
...
public:
    ...
    // Serialize the struct value
    size_t serialize(const ::arena_common_pmr::Expression& value, std::pmr::memory_resource* resource);
    // Deserialize the struct value
...
template<>
struct model_of<::arena_common_pmr::Expression> {
using type = arena_common_pmr::ExpressionModel;
};
