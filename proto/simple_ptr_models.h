...
public:
    ...
    void get(::simple::Simple** fbe_value, pmr::memory_resource* resource) noexcept;
    // Get the struct fields values
    void get_fields(::simple::Simple& fbe_value, size_t fbe_struct_size, pmr::memory_resource* resource) noexcept;
    ...
    void set(const ::simple::Simple* fbe_value, pmr::memory_resource* resource) noexcept;
    // Set the struct fields values
    void set_fields(const ::simple::Simple* fbe_value, pmr::memory_resource* resource) noexcept;
...
public:
    ...
    size_t serialize(const ::simple::Simple& value, pmr::memory_resource* resource);
    // Deserialize the struct value
    size_t deserialize(::simple::Simple& value, pmr::memory_resource* resource) noexcept;
