...
public:
    ...
    void get(::arena_common::Expr& fbe_value, pmr::memory_resource* resource) const noexcept;
    ...
    void set(const ::arena_common::Expr& fbe_value, pmr::memory_resource* resource) noexcept;
...
public:
    ...
    void get(::arena_common::Alias& fbe_value, pmr::memory_resource* resource) const noexcept;
    // Get the struct fields values
    void get_fields(::arena_common::Alias& fbe_value, size_t fbe_struct_size, pmr::memory_resource* resource) const noexcept;
    ...
    void set(const ::arena_common::Alias& fbe_value, pmr::memory_resource* resource) noexcept;
    // Set the struct fields values
    void set_fields(const ::arena_common::Alias& fbe_value, pmr::memory_resource* resource) noexcept;
...
public:
    ...
    size_t serialize(const ::arena_common::Alias& value, pmr::memory_resource* resource);
    // Deserialize the struct value
    size_t deserialize(::arena_common::Alias& value, pmr::memory_resource* resource) const noexcept;
...
public:
    ...
    // Get the struct value
    void get(::arena_common::Expression& fbe_value, pmr::memory_resource* resource) const noexcept;
    // Get the struct fields values
    void get_fields(::arena_common::Expression& fbe_value, size_t fbe_struct_size, pmr::memory_resource* resource) const noexcept;
    ...
    // Set the struct value
    void set(const ::arena_common::Expression& fbe_value, pmr::memory_resource* resource) noexcept;
    // Set the struct fields values
    void set_fields(const ::arena_common::Expression& fbe_value, pmr::memory_resource* resource) noexcept;
...
public:
    ...
    // Serialize the struct value
    size_t serialize(const ::arena_common::Expression& value, pmr::memory_resource* resource);
    // Deserialize the struct value
    size_t deserialize(::arena_common::Expression& value, pmr::memory_resource* resource) const noexcept;
