...
class FieldModelPMRPtr_arena_ptr_Line
{
public:
    FieldModelPMRPtr_arena_ptr_Line(FBEBuffer& buffer, size_t offset) noexcept;
    ~FieldModelPMRPtr_arena_ptr_Line();
    ...
    void get(::arena_ptr_pmr::Line** fbe_value, std::pmr::memory_resource* resource) noexcept;
    // Get the struct fields values
    void get_fields(::arena_ptr_pmr::Line& fbe_value, size_t fbe_struct_size, std::pmr::memory_resource* resource) noexcept;
    ...
    void set(const ::arena_ptr_pmr::Line* fbe_value, std::pmr::memory_resource* resource) noexcept;
    // Set the struct fields values
    void set_fields(const ::arena_ptr_pmr::Line* fbe_value, std::pmr::memory_resource* resource) noexcept;
...
class FieldModelPMRPtr_arena_ptr_Line2
{
public:
    FieldModelPMRPtr_arena_ptr_Line2(FBEBuffer& buffer, size_t offset) noexcept;
    ~FieldModelPMRPtr_arena_ptr_Line2();
    ...
    // Get the struct value
    void get(::arena_ptr_pmr::Line2** fbe_value, std::pmr::memory_resource* resource) noexcept;
    // Get the struct fields values
    void get_fields(::arena_ptr_pmr::Line2& fbe_value, size_t fbe_struct_size, std::pmr::memory_resource* resource) noexcept;
    ...
    // Set the struct value
    void set(const ::arena_ptr_pmr::Line2* fbe_value, std::pmr::memory_resource* resource) noexcept;
    // Set the struct fields values
    void set_fields(const ::arena_ptr_pmr::Line2* fbe_value, std::pmr::memory_resource* resource) noexcept;
...
class FieldModelPMR_arena_ptr_Line : public BaseFieldModel
{
public:
    FieldModelPMR_arena_ptr_Line(FBEBuffer& buffer, size_t offset) noexcept;
...
public:
    ...
    // Get the model type
    static constexpr size_t fbe_type() noexcept { return FieldModelPMR_arena_ptr_Line::fbe_type(); }
    ...
    size_t serialize(const ::arena_ptr_pmr::Line& value, std::pmr::memory_resource* resource);
    // Deserialize the struct value
    size_t deserialize(::arena_ptr_pmr::Line& value, std::pmr::memory_resource* resource) noexcept;

    // Move to the next struct value
    void next(size_t prev) noexcept { model.fbe_shift(prev); }

public:
    FieldModelPMR_arena_ptr_Line model;
};
...
{
public:
    FieldModelPMR_arena_ptr_Line2(FBEBuffer& buffer, size_t offset) noexcept;
...
public:
    ...
    size_t fbe_size() const noexcept { return model.fbe_size() + model.fbe_extra(); }
    // Get the model type
    static constexpr size_t fbe_type() noexcept { return FieldModelPMR_arena_ptr_Line2::fbe_type(); }
    ...
    // Serialize the struct value
    size_t serialize(const ::arena_ptr_pmr::Line2& value, std::pmr::memory_resource* resource);
    // Deserialize the struct value
    size_t deserialize(::arena_ptr_pmr::Line2& value, std::pmr::memory_resource* resource) noexcept;

    // Move to the next struct value
    void next(size_t prev) noexcept { model.fbe_shift(prev); }

public:
    FieldModelPMR_arena_ptr_Line2 model;
};
