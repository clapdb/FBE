...
public:
    ...
    void get(::ptrpkg::Line** fbe_value) noexcept;
    // Get the struct fields values
    void get_fields(::ptrpkg::Line& fbe_value, size_t fbe_struct_size) noexcept;
    ...
    void set(const ::ptrpkg::Line* fbe_value) noexcept;
    // Set the struct fields values
    void set_fields(const ::ptrpkg::Line* fbe_value) noexcept;
...
public:
    ...
    size_t serialize(const ::ptrpkg::Line& value);
    // Deserialize the struct value
    size_t deserialize(::ptrpkg::Line& value) noexcept;
