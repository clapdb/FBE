...
class FieldModelPtr_arena_ptr_Line
{
public:
    FieldModelPtr_arena_ptr_Line(FBEBuffer& buffer, size_t offset) noexcept;
    ~FieldModelPtr_arena_ptr_Line();
    ...
    void get(::arena_ptr::Line** fbe_value, std::pmr::memory_resource* resource) noexcept;
    // Get the struct fields values
    void get_fields(::arena_ptr::Line& fbe_value, size_t fbe_struct_size, std::pmr::memory_resource* resource) noexcept;
    ...
    void set(const ::arena_ptr::Line* fbe_value, std::pmr::memory_resource* resource) noexcept;
    // Set the struct fields values
    void set_fields(const ::arena_ptr::Line* fbe_value, std::pmr::memory_resource* resource) noexcept;
...
class FieldModelPtr_arena_ptr_Line2
{
public:
    FieldModelPtr_arena_ptr_Line2(FBEBuffer& buffer, size_t offset) noexcept;
    ~FieldModelPtr_arena_ptr_Line2();
    ...
    // Get the struct value
    void get(::arena_ptr::Line2** fbe_value, std::pmr::memory_resource* resource) noexcept;
    // Get the struct fields values
    void get_fields(::arena_ptr::Line2& fbe_value, size_t fbe_struct_size, std::pmr::memory_resource* resource) noexcept;
    ...
    // Set the struct value
    void set(const ::arena_ptr::Line2* fbe_value, std::pmr::memory_resource* resource) noexcept;
    // Set the struct fields values
    void set_fields(const ::arena_ptr::Line2* fbe_value, std::pmr::memory_resource* resource) noexcept;
...
{
public:
    FieldModel_arena_ptr_Line(FBEBuffer& buffer, size_t offset) noexcept;
...
public:
    ...
    // Get the model type
    static constexpr size_t fbe_type() noexcept { return FieldModel_arena_ptr_Line::fbe_type(); }
    ...
    size_t serialize(const ::arena_ptr::Line& value, std::pmr::memory_resource* resource);
    // Deserialize the struct value
    size_t deserialize(::arena_ptr::Line& value, std::pmr::memory_resource* resource) noexcept;
...
template<>
struct model_of<::arena_ptr::Line> {
using type = arena_ptr::LineModel;
};
...
{
public:
    FieldModel_arena_ptr_Line2(FBEBuffer& buffer, size_t offset) noexcept;
...
public:
    ...
    size_t fbe_size() const noexcept { return model.fbe_size() + model.fbe_extra(); }
    // Get the model type
    static constexpr size_t fbe_type() noexcept { return FieldModel_arena_ptr_Line2::fbe_type(); }
    ...
    // Serialize the struct value
    size_t serialize(const ::arena_ptr::Line2& value, std::pmr::memory_resource* resource);
    // Deserialize the struct value
    size_t deserialize(::arena_ptr::Line2& value, std::pmr::memory_resource* resource) noexcept;
...
template<>
struct model_of<::arena_ptr::Line2> {
using type = arena_ptr::Line2Model;
};
