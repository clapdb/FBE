...
#include "enums_final_pmr_models.h"

namespace FBE {

FinalModel<::enums_pmr::Enums>::FinalModel(FBEBuffer& buffer, size_t offset) noexcept : _buffer(buffer), _offset(offset)
    , byte0(buffer, 0)
    , byte1(buffer, 0)
    , byte2(buffer, 0)
    , byte3(buffer, 0)
...
size_t FinalModel<::enums_pmr::Enums>::fbe_allocation_size(const ::enums_pmr::Enums& fbe_value) const noexcept
{
    size_t fbe_result = 0
...
size_t FinalModel<::enums_pmr::Enums>::verify() const noexcept
{
...
size_t FinalModel<::enums_pmr::Enums>::verify_fields() const noexcept
{
...
size_t FinalModel<::enums_pmr::Enums>::get(::enums_pmr::Enums& fbe_value) const noexcept
{
    _buffer.shift(fbe_offset());
...
size_t FinalModel<::enums_pmr::Enums>::get_fields([[maybe_unused]] ::enums_pmr::Enums& fbe_value) const noexcept
{
...
size_t FinalModel<::enums_pmr::Enums>::get(::enums_pmr::Enums& fbe_value, [[maybe_unused]] std::pmr::memory_resource* resource) const noexcept
{
    _buffer.shift(fbe_offset());
...
size_t FinalModel<::enums_pmr::Enums>::get_fields([[maybe_unused]] ::enums_pmr::Enums& fbe_value, [[maybe_unused]] std::pmr::memory_resource* resource) const noexcept
{
    // All fields are fixed-size - optimized batch read (216 bytes)
    size_t fbe_base_offset = _buffer.offset();
    if ((fbe_base_offset + 216) > _buffer.size())
...
size_t FinalModel<::enums_pmr::Enums>::set(const ::enums_pmr::Enums& fbe_value) noexcept
{
    _buffer.shift(fbe_offset());
...
size_t FinalModel<::enums_pmr::Enums>::set_fields([[maybe_unused]] const ::enums_pmr::Enums& fbe_value) noexcept
{
...
size_t EnumsFinalModel::serialize(const ::enums_pmr::Enums& value)
{
...
size_t EnumsFinalModel::deserialize(::enums_pmr::Enums& value) const noexcept
{
...
size_t EnumsFinalModel::deserialize(::enums_pmr::Enums& value, std::pmr::memory_resource* resource) const noexcept
{
    assert(((this->buffer().offset() + _model.fbe_offset()) <= this->buffer().size()) && "Model is broken!");
    if ((this->buffer().offset() + _model.fbe_offset()) > this->buffer().size())
        return 0;
