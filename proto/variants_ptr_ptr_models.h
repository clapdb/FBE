...
template <>
class FieldModel<::variants_ptr::Scalar1>
{
public:
    FieldModel(FBEBuffer& buffer, size_t offset) noexcept;
    ...
    // Get the variant value
    void get(::variants_ptr::Scalar1& fbe_value) const noexcept;
    ...
    // Set the variant value
    void set(const ::variants_ptr::Scalar1& fbe_value) noexcept;
...
class FieldModelPtr_variants_ptr_ExprContainer
{
public:
    FieldModelPtr_variants_ptr_ExprContainer(FBEBuffer& buffer, size_t offset) noexcept;
    ~FieldModelPtr_variants_ptr_ExprContainer();
    ...
    // Get the struct value
    void get(::variants_ptr::ExprContainer** fbe_value) noexcept;
    // Get the struct fields values
    void get_fields(::variants_ptr::ExprContainer& fbe_value, size_t fbe_struct_size) noexcept;
    ...
    // Set the struct value
    void set(const ::variants_ptr::ExprContainer* fbe_value) noexcept;
    // Set the struct fields values
    void set_fields(const ::variants_ptr::ExprContainer* fbe_value) noexcept;
...
class FieldModelPtr_variants_ptr_Scalar1Container
{
public:
    FieldModelPtr_variants_ptr_Scalar1Container(FBEBuffer& buffer, size_t offset) noexcept;
    ~FieldModelPtr_variants_ptr_Scalar1Container();
    ...
    // Get the struct value
    void get(::variants_ptr::Scalar1Container** fbe_value) noexcept;
    // Get the struct fields values
    void get_fields(::variants_ptr::Scalar1Container& fbe_value, size_t fbe_struct_size) noexcept;
    ...
    // Set the struct value
    void set(const ::variants_ptr::Scalar1Container* fbe_value) noexcept;
    // Set the struct fields values
    void set_fields(const ::variants_ptr::Scalar1Container* fbe_value) noexcept;
...
// Fast Binary Encoding ::variants_ptr::ExprContainer field model
class FieldModel_variants_ptr_ExprContainer : public BaseFieldModel
{
public:
    FieldModel_variants_ptr_ExprContainer(FBEBuffer& buffer, size_t offset) noexcept;
...
public:
    FieldModel<::variants_ptr::Expr> e;
    FieldModel<std::optional<::variants_ptr::Expr>> eo;
    FieldModelStructOptional<FieldModel_variants_ptr_Simple, ::variants_ptr::Simple> so;
};
...
public:
    ...
    size_t fbe_size() const noexcept { return model.fbe_size() + model.fbe_extra(); }
    // Get the model type
    static constexpr size_t fbe_type() noexcept { return FieldModel_variants_ptr_ExprContainer::fbe_type(); }
    ...
    // Serialize the struct value
    size_t serialize(const ::variants_ptr::ExprContainer& value);
    // Deserialize the struct value
    size_t deserialize(::variants_ptr::ExprContainer& value) noexcept;

    // Move to the next struct value
    void next(size_t prev) noexcept { model.fbe_shift(prev); }

public:
    FieldModel_variants_ptr_ExprContainer model;
};
...
// Fast Binary Encoding ::variants_ptr::Scalar1Container field model
class FieldModel_variants_ptr_Scalar1Container : public BaseFieldModel
{
public:
    FieldModel_variants_ptr_Scalar1Container(FBEBuffer& buffer, size_t offset) noexcept;
...
public:
    FieldModelMap<::variants_ptr::Scalar1, ::variants_ptr::Expr> s;
};
...
public:
    ...
    size_t fbe_size() const noexcept { return model.fbe_size() + model.fbe_extra(); }
    // Get the model type
    static constexpr size_t fbe_type() noexcept { return FieldModel_variants_ptr_Scalar1Container::fbe_type(); }
    ...
    // Serialize the struct value
    size_t serialize(const ::variants_ptr::Scalar1Container& value);
    // Deserialize the struct value
    size_t deserialize(::variants_ptr::Scalar1Container& value) noexcept;

    // Move to the next struct value
    void next(size_t prev) noexcept { model.fbe_shift(prev); }

public:
    FieldModel_variants_ptr_Scalar1Container model;
};
