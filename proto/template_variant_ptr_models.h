...
public:
    ...
    void get(::template_variant::Line** fbe_value, std::pmr::memory_resource* resource) noexcept;
    // Get the struct fields values
    void get_fields(::template_variant::Line& fbe_value, size_t fbe_struct_size, std::pmr::memory_resource* resource) noexcept;
    ...
    void set(const ::template_variant::Line* fbe_value, std::pmr::memory_resource* resource) noexcept;
    // Set the struct fields values
    void set_fields(const ::template_variant::Line* fbe_value, std::pmr::memory_resource* resource) noexcept;
...
public:
    ...
    // Get the struct value
    void get(::template_variant::Line2** fbe_value, std::pmr::memory_resource* resource) noexcept;
    // Get the struct fields values
    void get_fields(::template_variant::Line2& fbe_value, size_t fbe_struct_size, std::pmr::memory_resource* resource) noexcept;
    ...
    // Set the struct value
    void set(const ::template_variant::Line2* fbe_value, std::pmr::memory_resource* resource) noexcept;
    // Set the struct fields values
    void set_fields(const ::template_variant::Line2* fbe_value, std::pmr::memory_resource* resource) noexcept;
...
public:
    ...
    // Get the struct value
    void get(::template_variant::Line3** fbe_value, std::pmr::memory_resource* resource) noexcept;
    // Get the struct fields values
    void get_fields(::template_variant::Line3& fbe_value, size_t fbe_struct_size, std::pmr::memory_resource* resource) noexcept;
    ...
    // Set the struct value
    void set(const ::template_variant::Line3* fbe_value, std::pmr::memory_resource* resource) noexcept;
    // Set the struct fields values
    void set_fields(const ::template_variant::Line3* fbe_value, std::pmr::memory_resource* resource) noexcept;
...
public:
    ...
    size_t serialize(const ::template_variant::Line& value, std::pmr::memory_resource* resource);
    // Deserialize the struct value
    size_t deserialize(::template_variant::Line& value, std::pmr::memory_resource* resource) noexcept;
...
public:
    ...
    // Serialize the struct value
    size_t serialize(const ::template_variant::Line2& value, std::pmr::memory_resource* resource);
    // Deserialize the struct value
    size_t deserialize(::template_variant::Line2& value, std::pmr::memory_resource* resource) noexcept;
...
public:
    ...
    // Serialize the struct value
    size_t serialize(const ::template_variant::Line3& value, std::pmr::memory_resource* resource);
    // Deserialize the struct value
    size_t deserialize(::template_variant::Line3& value, std::pmr::memory_resource* resource) noexcept;
