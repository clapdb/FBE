...
using V = std::variant<std::monostate, FBEString, int32_t, double, ::variants::Simple, FastVec<::variants::Simple>, FastVec<int32_t>, HashMap<int32_t, ::variants::Simple>, FastVec<FBE::buffer_t>, FastVec<FBEString>, HashMap<int32_t, FBE::buffer_t>, HashMap<FBEString, FBE::buffer_t>, ::variants::Expr>;
