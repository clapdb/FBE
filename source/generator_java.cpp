...
void GeneratorJava::GenerateFBEUUIDGenerator(const std::string& domain, const std::string& package)
{
    ...
    // Generate the file
    fs::path file = path / "UUIDGenerator.java";
    WriteBegin();
...
void GeneratorJava::GenerateFBEFieldModel(const std::string& domain, const std::string& package)
{
    ...
    // Generate the file
    fs::path file = path / "FieldModel.java";
    WriteBegin();
...
void GeneratorJava::GenerateFBEFieldModelDecimal(const std::string& domain, const std::string& package)
{
    ...
    // Generate the file
    fs::path file = path / "FieldModelDecimal.java";
    WriteBegin();
...
void GeneratorJava::GenerateFBEFieldModelDate(const std::string& domain, const std::string& package)
{
    ...
    // Generate the file
    fs::path file = path / "FieldModelDate.java";
    WriteBegin();
...
void GeneratorJava::GenerateFBEFieldModelTimestamp(const std::string& domain, const std::string& package)
{
    ...
    // Generate the file
    fs::path file = path / "FieldModelTimestamp.java";
    WriteBegin();
...
void GeneratorJava::GenerateFBEFieldModelBytes(const std::string& domain, const std::string& package)
{
    ...
    // Generate the file
    fs::path file = path / "FieldModelBytes.java";
    WriteBegin();
...
void GeneratorJava::GenerateFBEFieldModelString(const std::string& domain, const std::string& package)
{
    ...
    // Generate the file
    fs::path file = path / "FieldModelString.java";
    WriteBegin();
...
void GeneratorJava::GenerateFBEFinalModel(const std::string& domain, const std::string& package)
{
    ...
    // Generate the file
    fs::path file = path / "FinalModel.java";
    WriteBegin();
...
void GeneratorJava::GenerateFBEFinalModelDecimal(const std::string& domain, const std::string& package)
{
    ...
    // Generate the file
    fs::path file = path / "FinalModelDecimal.java";
    WriteBegin();
...
void GeneratorJava::GenerateFBEFinalModelDate(const std::string& domain, const std::string& package)
{
    ...
    // Generate the file
    fs::path file = path / "FinalModelDate.java";
    WriteBegin();
...
void GeneratorJava::GenerateFBEFinalModelTimestamp(const std::string& domain, const std::string& package)
{
    ...
    // Generate the file
    fs::path file = path / "FinalModelTimestamp.java";
    WriteBegin();
...
void GeneratorJava::GenerateFBEFinalModelBytes(const std::string& domain, const std::string& package)
{
    ...
    // Generate the file
    fs::path file = path / "FinalModelBytes.java";
    WriteBegin();
...
void GeneratorJava::GenerateFBEFinalModelString(const std::string& domain, const std::string& package)
{
    ...
    // Generate the file
    fs::path file = path / "FinalModelString.java";
    WriteBegin();
...
void GeneratorJava::GenerateFBEReceiver(const std::string& domain, const std::string& package)
{
    ...
    // Generate the file
    fs::path file = path / "Receiver.java";
    WriteBegin();
...
void GeneratorJava::GenerateEnum(const std::shared_ptr<Package>& p, const std::shared_ptr<EnumType>& e, const fs::path& path)
{
    std::string enum_name = *e->name + "Enum";

    // Generate the output file
    fs::path output = path / (enum_name + ".java");
    WriteBegin();
...
void GeneratorJava::GenerateEnumClass(const std::shared_ptr<Package>& p, const std::shared_ptr<EnumType>& e, const fs::path& path)
{
...
void GeneratorJava::GenerateFlags(const std::shared_ptr<Package>& p, const std::shared_ptr<FlagsType>& f, const fs::path& path)
{
    std::string flags_name = *f->name + "Enum";

    // Generate the output file
    fs::path output = path / (flags_name + ".java");
    WriteBegin();
...
void GeneratorJava::GenerateFlagsClass(const std::shared_ptr<Package>& p, const std::shared_ptr<FlagsType>& f, const fs::path& path)
{
...
void GeneratorJava::GenerateStruct(const std::shared_ptr<Package>& p, const std::shared_ptr<StructType>& s, const fs::path& path)
{
    std::string domain = (p->domain && !p->domain->empty()) ? (*p->domain + ".") : "";
    bool first;

    // Generate the output file
    fs::path output = path / (*s->name + ".java");
    WriteBegin();
