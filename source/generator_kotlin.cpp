...
void GeneratorKotlin::GenerateFBEUUIDGenerator(const std::string& domain, const std::string& package)
{
    ...
    // Generate the file
    fs::path file = path / "UUIDGenerator.kt";
    WriteBegin();
...
void GeneratorKotlin::GenerateFBEFieldModel(const std::string& domain, const std::string& package)
{
    ...
    // Generate the file
    fs::path file = path / "FieldModel.kt";
    WriteBegin();
...
void GeneratorKotlin::GenerateFBEFieldModelDecimal(const std::string& domain, const std::string& package)
{
    ...
    // Generate the file
    fs::path file = path / "FieldModelDecimal.kt";
    WriteBegin();
...
void GeneratorKotlin::GenerateFBEFieldModelDate(const std::string& domain, const std::string& package)
{
    ...
    // Generate the file
    fs::path file = path / "FieldModelDate.kt";
    WriteBegin();
...
void GeneratorKotlin::GenerateFBEFieldModelTimestamp(const std::string& domain, const std::string& package)
{
    ...
    // Generate the file
    fs::path file = path / "FieldModelTimestamp.kt";
    WriteBegin();
...
void GeneratorKotlin::GenerateFBEFieldModelBytes(const std::string& domain, const std::string& package)
{
    ...
    // Generate the file
    fs::path file = path / "FieldModelBytes.kt";
    WriteBegin();
...
void GeneratorKotlin::GenerateFBEFieldModelString(const std::string& domain, const std::string& package)
{
    ...
    // Generate the file
    fs::path file = path / "FieldModelString.kt";
    WriteBegin();
...
void GeneratorKotlin::GenerateFBEFinalModel(const std::string& domain, const std::string& package)
{
    ...
    // Generate the file
    fs::path file = path / "FinalModel.kt";
    WriteBegin();
...
void GeneratorKotlin::GenerateFBEFinalModelDecimal(const std::string& domain, const std::string& package)
{
    ...
    // Generate the file
    fs::path file = path / "FinalModelDecimal.kt";
    WriteBegin();
...
void GeneratorKotlin::GenerateFBEFinalModelDate(const std::string& domain, const std::string& package)
{
    ...
    // Generate the file
    fs::path file = path / "FinalModelDate.kt";
    WriteBegin();
...
void GeneratorKotlin::GenerateFBEFinalModelTimestamp(const std::string& domain, const std::string& package)
{
    ...
    // Generate the file
    fs::path file = path / "FinalModelTimestamp.kt";
    WriteBegin();
...
void GeneratorKotlin::GenerateFBEFinalModelBytes(const std::string& domain, const std::string& package)
{
    ...
    // Generate the file
    fs::path file = path / "FinalModelBytes.kt";
    WriteBegin();
...
void GeneratorKotlin::GenerateFBEFinalModelString(const std::string& domain, const std::string& package)
{
    ...
    // Generate the file
    fs::path file = path / "FinalModelString.kt";
    WriteBegin();
...
void GeneratorKotlin::GenerateFBESenderListener(const std::string& domain, const std::string& package)
{
    ...
    // Generate the file
    fs::path file = path / "ISenderListener.kt";
    WriteBegin();
...
void GeneratorKotlin::GenerateFBEReceiverListener(const std::string& domain, const std::string& package)
{
    ...
    // Generate the file
    fs::path file = path / "IReceiverListener.kt";
    WriteBegin();
...
void GeneratorKotlin::GenerateFBEClientListener(const std::string& domain, const std::string& package)
{
    ...
    // Generate the file
    fs::path file = path / "IClientListener.kt";
    WriteBegin();
...
void GeneratorKotlin::GenerateEnum(const std::shared_ptr<Package>& p, const std::shared_ptr<EnumType>& e, const fs::path& path)
{
    std::string enum_name = *e->name + "Enum";

    // Generate the output file
    fs::path output = path / (enum_name + ".kt");
    WriteBegin();
...
void GeneratorKotlin::GenerateEnumClass(const std::shared_ptr<Package>& p, const std::shared_ptr<EnumType>& e, const fs::path& path)
{
...
void GeneratorKotlin::GenerateFlags(const std::shared_ptr<Package>& p, const std::shared_ptr<FlagsType>& f, const fs::path& path)
{
    std::string flags_name = *f->name + "Enum";

    // Generate the output file
    fs::path output = path / (flags_name + ".kt");
    WriteBegin();
...
void GeneratorKotlin::GenerateFlagsClass(const std::shared_ptr<Package>& p, const std::shared_ptr<FlagsType>& f, const fs::path& path)
{
...
void GeneratorKotlin::GenerateStruct(const std::shared_ptr<Package>& p, const std::shared_ptr<StructType>& s, const fs::path& path)
{
    std::string domain = (p->domain && !p->domain->empty()) ? (*p->domain + ".") : "";
    bool first;

    // Generate the output file
    fs::path output = path / (*s->name + ".kt");
    WriteBegin();
