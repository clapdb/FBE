...
class SimpleFinalModel : fbe.Model
{
    ...
    fun serialize(value: osa.Simple): Long
    {
    ...
    fun deserialize(): osa.Simple { val value = osa.Simple(); deserialize(value); return value }
    @Suppress("UNUSED_VALUE")
    fun deserialize(value: osa.Simple): Long
    {
        var valueRef = value
