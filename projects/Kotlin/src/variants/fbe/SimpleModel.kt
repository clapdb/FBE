...
{
    val model: FieldModelSimple

    constructor() { model = FieldModelSimple(buffer, 4) }
    constructor(buffer: fbe.Buffer) : super(buffer) { model = FieldModelSimple(buffer, 4) }
    ...
    companion object
    {
        const val fbeTypeConst: Long = FieldModelSimple.fbeTypeConst
    }
