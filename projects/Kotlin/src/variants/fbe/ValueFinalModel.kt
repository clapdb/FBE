...
{
    private val _model: FinalModelValue

    constructor() { _model = FinalModelValue(buffer, 8) }
    constructor(buffer: fbe.Buffer) : super(buffer) { _model = FinalModelValue(buffer, 8) }
    ...
    companion object
    {
        const val fbeTypeConst: Long = FinalModelValue.fbeTypeConst
    }
