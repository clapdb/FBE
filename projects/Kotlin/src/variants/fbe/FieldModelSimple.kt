...
class FieldModelSimple(buffer: fbe.Buffer, offset: Long) : fbe.FieldModel(buffer, offset)
{
    ...
    fun get(fbeValue: variants.Simple = variants.Simple()): variants.Simple
    {
    ...
    @Suppress("UNUSED_PARAMETER")
    fun getFields(fbeValue: variants.Simple, fbeStructSize: Long)
    {
        var fbeCurrentSize = 4L + 4L
    ...
    fun set(fbeValue: variants.Simple)
    {
    ...
    @Suppress("UNUSED_PARAMETER")
    fun setFields(fbeValue: variants.Simple)
    {
