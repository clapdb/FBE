...
{
    private val _model: FinalModelSimple

    constructor() { _model = FinalModelSimple(buffer, 8) }
    constructor(buffer: fbe.Buffer) : super(buffer) { _model = FinalModelSimple(buffer, 8) }
    ...
    companion object
    {
        const val fbeTypeConst: Long = FinalModelSimple.fbeTypeConst
    }
    ...
    fun serialize(value: variants.Simple): Long
    {
    ...
    fun deserialize(): variants.Simple { val value = variants.Simple(); deserialize(value); return value }
    @Suppress("UNUSED_VALUE")
    fun deserialize(value: variants.Simple): Long
    {
        var valueRef = value
