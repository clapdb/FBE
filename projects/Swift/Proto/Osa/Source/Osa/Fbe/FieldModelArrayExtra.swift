...
class FieldModelArrayExtra: FieldModel {
    private let _model: FieldModelExtra
    ...
    required init() {
        ...
        _model = FieldModelExtra(buffer: buffer, offset: offset)
    }
    ...
    public func getItem(index: Int) -> FieldModelExtra {
    ...
    public func get() -> Array<Osa.Extra> {
        var values = Array<Osa.Extra>()
    ...
    public func get(values: inout Array<Osa.Extra>) {
        values.removeAll()
    ...
    public func set(value values: Array<Osa.Extra>) throws {
        if _buffer.offset + fbeOffset + fbeSize > _buffer.size {
