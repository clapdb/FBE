...
public class ExtraModel: Model {
    public let model: FieldModelExtra

    public override init(buffer: Buffer = Buffer()) {
        model = FieldModelExtra(buffer: buffer, offset: 4)
    ...
    static let fbeTypeConst: Int = FieldModelExtra.fbeTypeConst
