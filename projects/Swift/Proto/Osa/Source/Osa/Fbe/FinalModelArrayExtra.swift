...
class FinalModelArrayExtra: FinalModel {
    var _buffer: Buffer = Buffer()
    var _offset: Int = 0
    var _size: Int = 0

    private var _model: FinalModelExtra
    ...
    init(buffer: Buffer, offset: Int, size: Int) {
        ...
        _model = FinalModelExtra(buffer: buffer, offset: offset)
    }

    // Get the allocation size
    func fbeAllocationSize(value values: Array<Extra>) -> Int {
        var size: Int = 0
        for value in values {
    ...
    public func get(size: inout Size) -> Array<Extra> {
        var values = Array<Extra>()
    ...
    public func get(values: inout Array<Extra>) -> Int {
        values.removeAll()
    ...
    public func set(value values: Array<Extra>) throws -> Int {
        if _buffer.offset + fbeOffset > _buffer.size {
            assertionFailure("Model is broken!")
            return 0
        }
