...
public class FieldModelValue: FieldModel {
    ...
    public required init() {
        ...
        v = FieldModelV(buffer: buffer, offset: 4 + 4)
    ...
    public func get(fbeValue: inout Value) -> Value {
    ...
    public func getFields(fbeValue: inout Value, fbeStructSize: Int) {
        var fbeCurrentSize = 4 + 4
    ...
    public func set(value fbeValue: Value) throws {
    ...
    public func setFields(fbeValue: Value) throws {
        try v.set(value: fbeValue.v)
    }
}
