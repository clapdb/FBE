...
type BalanceFinalModel struct {
    // Model buffer
    buffer *fbe.Buffer

    // Final model
    model *FinalModelBalance
}

// Create a new Balance final model
func NewBalanceFinalModel(buffer *fbe.Buffer) *BalanceFinalModel {
    return &BalanceFinalModel{buffer: buffer, model: NewFinalModelBalance(buffer, 8)}
}

// Get the final model buffer
func (m *BalanceFinalModel) Buffer() *fbe.Buffer { return m.buffer }
// Get the final model
func (m *BalanceFinalModel) Model() *FinalModelBalance { return m.model }

// // Get the final model type
func (m *BalanceFinalModel) FBEType() int { return m.model.FBEType() }

// Check if the struct value is valid
func (m *BalanceFinalModel) Verify() bool {
...
func (m *BalanceFinalModel) CreateBegin() int {
    fbeBegin := m.buffer.Allocate(4 + m.model.FBESize())
    return fbeBegin
}

// Create a new final model (end phase)
func (m *BalanceFinalModel) CreateEnd(fbeBegin int) int {
...
func (m *BalanceFinalModel) Serialize(value *Balance) (int, error) {
...
func (m *BalanceFinalModel) Deserialize() (*Balance, int, error) {
    value := NewBalance()
...
func (m *BalanceFinalModel) DeserializeValue(value *Balance) (int, error) {
...
func (m *BalanceFinalModel) Next(prev int) {
