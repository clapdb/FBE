...
type FinalModelOrder struct {
    ...
    Tp *fbe.FinalModelDouble
    Sl *fbe.FinalModelDouble
}
...
func NewFinalModelOrder(buffer *fbe.Buffer, offset int) *FinalModelOrder {
    ...
    fbeResult.Tp = fbe.NewFinalModelDouble(buffer, 0)
    fbeResult.Sl = fbe.NewFinalModelDouble(buffer, 0)
    return &fbeResult
}
...
func (fm *FinalModelOrder) FBEAllocationSize(fbeValue *Order) int {
    fbeResult := 0 +
        ...
        fm.Tp.FBEAllocationSize(fbeValue.Tp) +
        fm.Sl.FBEAllocationSize(fbeValue.Sl) +
        0
    return fbeResult
}
...
func (fm *FinalModelOrder) VerifyFields() int {
    ...
    fm.Tp.SetFBEOffset(fbeCurrentOffset)
    if fbeFieldSize = fm.Tp.Verify(); fbeFieldSize == fbe.MaxInt {
        return fbe.MaxInt
    }
    fbeCurrentOffset += fbeFieldSize

    fm.Sl.SetFBEOffset(fbeCurrentOffset)
    if fbeFieldSize = fm.Sl.Verify(); fbeFieldSize == fbe.MaxInt {
        return fbe.MaxInt
    }
    fbeCurrentOffset += fbeFieldSize
...
func (fm *FinalModelOrder) GetFields(fbeValue *Order) (int, error) {
    ...
    fm.Tp.SetFBEOffset(fbeCurrentOffset)
    if fbeValue.Tp, fbeFieldSize, err = fm.Tp.Get(); err != nil {
        return fbeCurrentSize, err
    }
    fbeCurrentOffset += fbeFieldSize
    fbeCurrentSize += fbeFieldSize
    ...
    fm.Sl.SetFBEOffset(fbeCurrentOffset)
    if fbeValue.Sl, fbeFieldSize, err = fm.Sl.Get(); err != nil {
        return fbeCurrentSize, err
    }
    fbeCurrentOffset += fbeFieldSize
    fbeCurrentSize += fbeFieldSize
...
func (fm *FinalModelOrder) SetFields(fbeValue *Order) (int, error) {
    ...
    fm.Tp.SetFBEOffset(fbeCurrentOffset)
    if fbeFieldSize, err = fm.Tp.Set(fbeValue.Tp); err != nil {
        return fbeCurrentSize, err
    }
    fbeCurrentOffset += fbeFieldSize
    fbeCurrentSize += fbeFieldSize
    ...
    fm.Sl.SetFBEOffset(fbeCurrentOffset)
    if fbeFieldSize, err = fm.Sl.Set(fbeValue.Sl); err != nil {
        return fbeCurrentSize, err
    }
    fbeCurrentOffset += fbeFieldSize
    fbeCurrentSize += fbeFieldSize
