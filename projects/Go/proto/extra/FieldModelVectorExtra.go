...
// Fast Binary Encoding Extra vector field model
type FieldModelVectorExtra struct {
    // Field model buffer
    buffer *fbe.Buffer
...
// Create a new Extra vector field model
func NewFieldModelVectorExtra(buffer *fbe.Buffer, offset int) *FieldModelVectorExtra {
    fbeResult := FieldModelVectorExtra{buffer: buffer, offset: offset}
    fbeResult.model = NewFieldModelPtrExtra(buffer, offset)
    return &fbeResult
}

// Get the field size
func (fm *FieldModelVectorExtra) FBESize() int { return 4 }

// Get the field extra size
func (fm *FieldModelVectorExtra) FBEExtra() int {
...
func (fm *FieldModelVectorExtra) FBEOffset() int { return fm.offset }
// Set the field offset
func (fm *FieldModelVectorExtra) SetFBEOffset(value int) { fm.offset = value }

// Shift the current field offset
func (fm *FieldModelVectorExtra) FBEShift(size int) { fm.offset += size }
// Unshift the current field offset
func (fm *FieldModelVectorExtra) FBEUnshift(size int) { fm.offset -= size }

// Get the vector offset
func (fm *FieldModelVectorExtra) Offset() int {
    if (fm.buffer.Offset() + fm.FBEOffset() + fm.FBESize()) > fm.buffer.Size() {
        return 0
    }
...
// Get the vector size
func (fm *FieldModelVectorExtra) Size() int {
    if (fm.buffer.Offset() + fm.FBEOffset() + fm.FBESize()) > fm.buffer.Size() {
        return 0
    }
...
func (fm *FieldModelVectorExtra) GetItem(index int) (*FieldModelPtrExtra, error) {
    if (fm.buffer.Offset() + fm.FBEOffset() + fm.FBESize()) > fm.buffer.Size() {
...
func (fm *FieldModelVectorExtra) Resize(size int) (*FieldModelPtrExtra, error) {
...
func (fm *FieldModelVectorExtra) Verify() bool {
    if (fm.buffer.Offset() + fm.FBEOffset() + fm.FBESize()) > fm.buffer.Size() {
        return true
    }
...
// Get the vector
func (fm *FieldModelVectorExtra) Get() ([]*Extra, error) {
    values := make([]*Extra, 0)
...
// Set the vector
func (fm *FieldModelVectorExtra) Set(values []*Extra) error {
    if (fm.buffer.Offset() + fm.FBEOffset() + fm.FBESize()) > fm.buffer.Size() {
