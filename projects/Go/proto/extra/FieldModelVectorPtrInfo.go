...
// Fast Binary Encoding PtrInfo vector field model
type FieldModelVectorPtrInfo struct {
    // Field model buffer
    buffer *fbe.Buffer
    ...
    model *FieldModelPtrInfo
}

// Create a new PtrInfo vector field model
func NewFieldModelVectorPtrInfo(buffer *fbe.Buffer, offset int) *FieldModelVectorPtrInfo {
    fbeResult := FieldModelVectorPtrInfo{buffer: buffer, offset: offset}
    return &fbeResult
}

// Get the field size
func (fm *FieldModelVectorPtrInfo) FBESize() int { return 4 }

// Get the field extra size
func (fm *FieldModelVectorPtrInfo) FBEExtra() int {
    ...
    fbeResult := 0
    if fm.model == nil {
        fm.model = NewFieldModelPtrInfo(fm.buffer, fm.offset)
    }
...
func (fm *FieldModelVectorPtrInfo) FBEOffset() int { return fm.offset }
// Set the field offset
func (fm *FieldModelVectorPtrInfo) SetFBEOffset(value int) { fm.offset = value }

// Shift the current field offset
func (fm *FieldModelVectorPtrInfo) FBEShift(size int) { fm.offset += size }
// Unshift the current field offset
func (fm *FieldModelVectorPtrInfo) FBEUnshift(size int) { fm.offset -= size }

// Get the vector offset
func (fm *FieldModelVectorPtrInfo) Offset() int {
    if (fm.buffer.Offset() + fm.FBEOffset() + fm.FBESize()) > fm.buffer.Size() {
        return 0
    }
...
// Get the vector size
func (fm *FieldModelVectorPtrInfo) Size() int {
    if (fm.buffer.Offset() + fm.FBEOffset() + fm.FBESize()) > fm.buffer.Size() {
        return 0
    }
...
func (fm *FieldModelVectorPtrInfo) GetItem(index int) (*FieldModelPtrInfo, error) {
    if (fm.buffer.Offset() + fm.FBEOffset() + fm.FBESize()) > fm.buffer.Size() {
...
func (fm *FieldModelVectorPtrInfo) Resize(size int) (*FieldModelPtrInfo, error) {
    if fm.model == nil {
        fm.model = NewFieldModelPtrInfo(fm.buffer, fm.offset)
    }
...
func (fm *FieldModelVectorPtrInfo) Verify() bool {
    if (fm.buffer.Offset() + fm.FBEOffset() + fm.FBESize()) > fm.buffer.Size() {
        return true
    }
...
// Get the vector
func (fm *FieldModelVectorPtrInfo) Get() ([]*Info, error) {
    values := make([]*Info, 0)
...
// Set the vector
func (fm *FieldModelVectorPtrInfo) Set(values []*Info) error {
    if (fm.buffer.Offset() + fm.FBEOffset() + fm.FBESize()) > fm.buffer.Size() {
