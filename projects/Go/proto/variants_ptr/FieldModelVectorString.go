...
func (fm *FieldModelVectorString) FBEExtra() int {
    ...
    fbeResult := 0
    if fm.model == nil {
        fm.model = fbe.NewFieldModelString(fm.buffer, fm.offset)
    }
...
func (fm *FieldModelVectorString) GetItem(index int) (*fbe.FieldModelString, error) {
    if (fm.buffer.Offset() + fm.FBEOffset() + fm.FBESize()) > fm.buffer.Size() {
...
func (fm *FieldModelVectorString) Resize(size int) (*fbe.FieldModelString, error) {
    if fm.model == nil {
        fm.model = fbe.NewFieldModelString(fm.buffer, fm.offset)
    }
