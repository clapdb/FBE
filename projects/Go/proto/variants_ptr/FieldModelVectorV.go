...
// Fast Binary Encoding V vector field model
type FieldModelVectorV struct {
    // Field model buffer
    buffer *fbe.Buffer
...
// Create a new V vector field model
func NewFieldModelVectorV(buffer *fbe.Buffer, offset int) *FieldModelVectorV {
    fbeResult := FieldModelVectorV{buffer: buffer, offset: offset}
    return &fbeResult
}

// Get the field size
func (fm *FieldModelVectorV) FBESize() int { return 4 }

// Get the field extra size
func (fm *FieldModelVectorV) FBEExtra() int {
    ...
    fbeResult := 0
    if fm.model == nil {
        fm.model = NewFieldModelV(fm.buffer, fm.offset)
    }
...
func (fm *FieldModelVectorV) FBEOffset() int { return fm.offset }
// Set the field offset
func (fm *FieldModelVectorV) SetFBEOffset(value int) { fm.offset = value }

// Shift the current field offset
func (fm *FieldModelVectorV) FBEShift(size int) { fm.offset += size }
// Unshift the current field offset
func (fm *FieldModelVectorV) FBEUnshift(size int) { fm.offset -= size }

// Get the vector offset
func (fm *FieldModelVectorV) Offset() int {
    if (fm.buffer.Offset() + fm.FBEOffset() + fm.FBESize()) > fm.buffer.Size() {
        return 0
    }
...
// Get the vector size
func (fm *FieldModelVectorV) Size() int {
    if (fm.buffer.Offset() + fm.FBEOffset() + fm.FBESize()) > fm.buffer.Size() {
        return 0
    }
...
func (fm *FieldModelVectorV) GetItem(index int) (*FieldModelV, error) {
    if (fm.buffer.Offset() + fm.FBEOffset() + fm.FBESize()) > fm.buffer.Size() {
...
func (fm *FieldModelVectorV) Resize(size int) (*FieldModelV, error) {
    if fm.model == nil {
        fm.model = NewFieldModelV(fm.buffer, fm.offset)
    }
...
func (fm *FieldModelVectorV) Verify() bool {
    if (fm.buffer.Offset() + fm.FBEOffset() + fm.FBESize()) > fm.buffer.Size() {
        return true
    }
...
// Get the vector
func (fm *FieldModelVectorV) Get() ([]V, error) {
    values := make([]V, 0)
...
// Set the vector
func (fm *FieldModelVectorV) Set(values []V) error {
    if (fm.buffer.Offset() + fm.FBEOffset() + fm.FBESize()) > fm.buffer.Size() {
