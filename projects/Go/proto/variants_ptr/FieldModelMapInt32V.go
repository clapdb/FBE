...
// Fast Binary Encoding Int32->V map field model
type FieldModelMapInt32V struct {
    // Field model buffer
    buffer *fbe.Buffer
    ...
    modelValue *FieldModelV
}

// Create a new Int32->V map field model
func NewFieldModelMapInt32V(buffer *fbe.Buffer, offset int) *FieldModelMapInt32V {
    fbeResult := FieldModelMapInt32V{buffer: buffer, offset: offset}
    return &fbeResult
}

// Get the field size
func (fm *FieldModelMapInt32V) FBESize() int { return 4 }

// Get the field extra size
func (fm *FieldModelMapInt32V) FBEExtra() int {
    ...
    if fm.modelKey == nil {
        ...
        fm.modelValue = NewFieldModelV(fm.buffer, fm.offset)
    }
...
func (fm *FieldModelMapInt32V) FBEOffset() int { return fm.offset }
// Set the field offset
func (fm *FieldModelMapInt32V) SetFBEOffset(value int) { fm.offset = value }

// Shift the current field offset
func (fm *FieldModelMapInt32V) FBEShift(size int) { fm.offset += size }
// Unshift the current field offset
func (fm *FieldModelMapInt32V) FBEUnshift(size int) { fm.offset -= size }

// Get the map offset
func (fm *FieldModelMapInt32V) Offset() int {
    if (fm.buffer.Offset() + fm.FBEOffset() + fm.FBESize()) > fm.buffer.Size() {
        return 0
    }
...
// Get the map size
func (fm *FieldModelMapInt32V) Size() int {
    if (fm.buffer.Offset() + fm.FBEOffset() + fm.FBESize()) > fm.buffer.Size() {
        return 0
    }
...
// Map index operator
func (fm *FieldModelMapInt32V) GetItem(index int) (*fbe.FieldModelInt32, *FieldModelV, error) {
    if (fm.buffer.Offset() + fm.FBEOffset() + fm.FBESize()) > fm.buffer.Size() {
...
func (fm *FieldModelMapInt32V) Resize(size int) (*fbe.FieldModelInt32, *FieldModelV, error) {
    if fm.modelKey == nil {
        fm.modelKey = fbe.NewFieldModelInt32(fm.buffer, fm.offset)
        fm.modelValue = NewFieldModelV(fm.buffer, fm.offset)
    }
...
func (fm *FieldModelMapInt32V) Verify() bool {
    if (fm.buffer.Offset() + fm.FBEOffset() + fm.FBESize()) > fm.buffer.Size() {
        return true
    }
...
// Get the map
func (fm *FieldModelMapInt32V) Get() (map[int32]V, error) {
...
// Set the map
func (fm *FieldModelMapInt32V) Set(values map[int32]V) error {
    if (fm.buffer.Offset() + fm.FBEOffset() + fm.FBESize()) > fm.buffer.Size() {
