...
type FieldModelVectorByte struct {
    // Field model buffer
    buffer *fbe.Buffer
...
func NewFieldModelVectorByte(buffer *fbe.Buffer, offset int) *FieldModelVectorByte {
    fbeResult := FieldModelVectorByte{buffer: buffer, offset: offset}
    return &fbeResult
}

// Get the field size
func (fm *FieldModelVectorByte) FBESize() int { return 4 }

// Get the field extra size
func (fm *FieldModelVectorByte) FBEExtra() int {
...
func (fm *FieldModelVectorByte) FBEOffset() int { return fm.offset }
// Set the field offset
func (fm *FieldModelVectorByte) SetFBEOffset(value int) { fm.offset = value }

// Shift the current field offset
func (fm *FieldModelVectorByte) FBEShift(size int) { fm.offset += size }
// Unshift the current field offset
func (fm *FieldModelVectorByte) FBEUnshift(size int) { fm.offset -= size }

// Get the vector offset
func (fm *FieldModelVectorByte) Offset() int {
    if (fm.buffer.Offset() + fm.FBEOffset() + fm.FBESize()) > fm.buffer.Size() {
        return 0
    }
...
// Get the vector size
func (fm *FieldModelVectorByte) Size() int {
    if (fm.buffer.Offset() + fm.FBEOffset() + fm.FBESize()) > fm.buffer.Size() {
        return 0
    }
...
func (fm *FieldModelVectorByte) GetItem(index int) (*fbe.FieldModelByte, error) {
    if (fm.buffer.Offset() + fm.FBEOffset() + fm.FBESize()) > fm.buffer.Size() {
...
func (fm *FieldModelVectorByte) Resize(size int) (*fbe.FieldModelByte, error) {
    if fm.model == nil {
        fm.model = fbe.NewFieldModelByte(fm.buffer, fm.offset)
    }
...
func (fm *FieldModelVectorByte) Verify() bool {
    if (fm.buffer.Offset() + fm.FBEOffset() + fm.FBESize()) > fm.buffer.Size() {
        return true
    }
...
// Get the vector
func (fm *FieldModelVectorByte) Get() ([]byte, error) {
    values := make([]byte, 0)
...
// Set the vector
func (fm *FieldModelVectorByte) Set(values []byte) error {
    if (fm.buffer.Offset() + fm.FBEOffset() + fm.FBESize()) > fm.buffer.Size() {
