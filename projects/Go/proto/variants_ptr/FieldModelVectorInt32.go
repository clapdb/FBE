...
func (fm *FieldModelVectorInt32) FBEExtra() int {
    ...
    fbeResult := 0
    if fm.model == nil {
        fm.model = fbe.NewFieldModelInt32(fm.buffer, fm.offset)
    }
...
func (fm *FieldModelVectorInt32) GetItem(index int) (*fbe.FieldModelInt32, error) {
    if (fm.buffer.Offset() + fm.FBEOffset() + fm.FBESize()) > fm.buffer.Size() {
...
func (fm *FieldModelVectorInt32) Resize(size int) (*fbe.FieldModelInt32, error) {
    if fm.model == nil {
        fm.model = fbe.NewFieldModelInt32(fm.buffer, fm.offset)
    }
