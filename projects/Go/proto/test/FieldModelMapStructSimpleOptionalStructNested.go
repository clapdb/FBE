...
type FieldModelMapStructSimpleOptionalStructNested struct {
    // Field model buffer
    buffer *fbe.Buffer
    ...
    modelValue *FieldModelOptionalStructNested
}

// Create a new StructSimple->OptionalStructNested map field model
func NewFieldModelMapStructSimpleOptionalStructNested(buffer *fbe.Buffer, offset int) *FieldModelMapStructSimpleOptionalStructNested {
    fbeResult := FieldModelMapStructSimpleOptionalStructNested{buffer: buffer, offset: offset}
    return &fbeResult
}

// Get the field size
func (fm *FieldModelMapStructSimpleOptionalStructNested) FBESize() int { return 4 }

// Get the field extra size
func (fm *FieldModelMapStructSimpleOptionalStructNested) FBEExtra() int {
    ...
    fbeResult := 0
    if fm.modelKey == nil {
        fm.modelKey = NewFieldModelStructSimple(fm.buffer, fm.offset)
        fm.modelValue = NewFieldModelOptionalStructNested(fm.buffer, fm.offset)
    }
...
func (fm *FieldModelMapStructSimpleOptionalStructNested) FBEOffset() int { return fm.offset }
// Set the field offset
func (fm *FieldModelMapStructSimpleOptionalStructNested) SetFBEOffset(value int) { fm.offset = value }

// Shift the current field offset
func (fm *FieldModelMapStructSimpleOptionalStructNested) FBEShift(size int) { fm.offset += size }
// Unshift the current field offset
func (fm *FieldModelMapStructSimpleOptionalStructNested) FBEUnshift(size int) { fm.offset -= size }

// Get the map offset
func (fm *FieldModelMapStructSimpleOptionalStructNested) Offset() int {
    if (fm.buffer.Offset() + fm.FBEOffset() + fm.FBESize()) > fm.buffer.Size() {
        return 0
    }
...
// Get the map size
func (fm *FieldModelMapStructSimpleOptionalStructNested) Size() int {
    if (fm.buffer.Offset() + fm.FBEOffset() + fm.FBESize()) > fm.buffer.Size() {
        return 0
    }
...
// Map index operator
func (fm *FieldModelMapStructSimpleOptionalStructNested) GetItem(index int) (*FieldModelStructSimple, *FieldModelOptionalStructNested, error) {
    if (fm.buffer.Offset() + fm.FBEOffset() + fm.FBESize()) > fm.buffer.Size() {
...
func (fm *FieldModelMapStructSimpleOptionalStructNested) Resize(size int) (*FieldModelStructSimple, *FieldModelOptionalStructNested, error) {
    if fm.modelKey == nil {
        fm.modelKey = NewFieldModelStructSimple(fm.buffer, fm.offset)
        fm.modelValue = NewFieldModelOptionalStructNested(fm.buffer, fm.offset)
    }
...
func (fm *FieldModelMapStructSimpleOptionalStructNested) Verify() bool {
    if (fm.buffer.Offset() + fm.FBEOffset() + fm.FBESize()) > fm.buffer.Size() {
        return true
    }
