...
func (fm *FieldModelOptionalStructNested) Value() *FieldModelStructNested { return fm.value }

// Get the field size
func (fm *FieldModelOptionalStructNested) FBESize() int { return 1 + 4 }

// Get the field extra size
func (fm *FieldModelOptionalStructNested) FBEExtra() int {
    if !fm.HasValue() {
        return 0
    }
...
func (fm *FieldModelOptionalStructNested) FBEOffset() int { return fm.offset }
// Set the field offset
func (fm *FieldModelOptionalStructNested) SetFBEOffset(value int) { fm.offset = value }

// Shift the current field offset
func (fm *FieldModelOptionalStructNested) FBEShift(size int) { fm.offset += size }
// Unshift the current field offset
func (fm *FieldModelOptionalStructNested) FBEUnshift(size int) { fm.offset -= size }

// Check if the object contains a value
func (fm *FieldModelOptionalStructNested) HasValue() bool {
...
func (fm *FieldModelOptionalStructNested) Verify() bool {
    if (fm.buffer.Offset() + fm.FBEOffset() + fm.FBESize()) > fm.buffer.Size() {
        return true
    }
...
func (fm *FieldModelOptionalStructNested) GetBegin() (int, error) {
    if !fm.HasValue() {
        return 0, nil
    }
...
func (fm *FieldModelOptionalStructNested) GetEnd(fbeBegin int) {
...
func (fm *FieldModelOptionalStructNested) SetBegin(hasValue bool) (int, error) {
    if (fm.buffer.Offset() + fm.FBEOffset() + fm.FBESize()) > fm.buffer.Size() {
        return 0, nil
    }
...
func (fm *FieldModelOptionalStructNested) SetEnd(fbeBegin int) {
    fm.buffer.Unshift(fbeBegin)
}

// Set the optional value
func (fm *FieldModelOptionalStructNested) Set(fbeValue *StructNested) error {
