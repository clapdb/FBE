...
type FieldModelStructVector struct {
    // Field model buffer
    buffer *fbe.Buffer
...
// Create a new StructVector field model
func NewFieldModelStructVector(buffer *fbe.Buffer, offset int) *FieldModelStructVector {
    fbeResult := FieldModelStructVector{buffer: buffer, offset: offset}
...
// Get the field size
func (fm *FieldModelStructVector) FBESize() int { return 4 }

// Get the field body size
func (fm *FieldModelStructVector) FBEBody() int {
    fbeResult := 4 + 4 +
        fm.F1.FBESize() +
        fm.F2.FBESize() +
        fm.F3.FBESize() +
...
func (fm *FieldModelStructVector) FBEExtra() int {
...
// Get the field type
func (fm *FieldModelStructVector) FBEType() int { return 130 }

// Get the field offset
func (fm *FieldModelStructVector) FBEOffset() int { return fm.offset }
// Set the field offset
func (fm *FieldModelStructVector) SetFBEOffset(value int) { fm.offset = value }

// Shift the current field offset
func (fm *FieldModelStructVector) FBEShift(size int) { fm.offset += size }
// Unshift the current field offset
func (fm *FieldModelStructVector) FBEUnshift(size int) { fm.offset -= size }

// Check if the struct value is valid
func (fm *FieldModelStructVector) Verify() bool { return fm.VerifyType(true) }

// Check if the struct value and its type are valid
func (fm *FieldModelStructVector) VerifyType(fbeVerifyType bool) bool {
    if (fm.buffer.Offset() + fm.FBEOffset() + fm.FBESize()) > fm.buffer.Size() {
        return true
    }
...
func (fm *FieldModelStructVector) VerifyFields(fbeStructSize int) bool {
    fbeCurrentSize := 4 + 4
...
func (fm *FieldModelStructVector) GetBegin() (int, error) {
    if (fm.buffer.Offset() + fm.FBEOffset() + fm.FBESize()) > fm.buffer.Size() {
        return 0, nil
    }
...
func (fm *FieldModelStructVector) GetEnd(fbeBegin int) {
    fm.buffer.Unshift(fbeBegin)
}

// Get the struct value
func (fm *FieldModelStructVector) Get() (*StructVector, error) {
    fbeResult := NewStructVector()
    return fbeResult, fm.GetValue(fbeResult)
}

// Get the struct value by the given pointer
func (fm *FieldModelStructVector) GetValue(fbeValue *StructVector) error {
...
func (fm *FieldModelStructVector) GetFields(fbeValue *StructVector, fbeStructSize int) {
    fbeCurrentSize := 4 + 4
...
func (fm *FieldModelStructVector) SetBegin() (int, error) {
    if (fm.buffer.Offset() + fm.FBEOffset() + fm.FBESize()) > fm.buffer.Size() {
        return 0, errors.New("model is broken")
    }
...
func (fm *FieldModelStructVector) SetEnd(fbeBegin int) {
    fm.buffer.Unshift(fbeBegin)
}

// Set the struct value
func (fm *FieldModelStructVector) Set(fbeValue *StructVector) error {
...
func (fm *FieldModelStructVector) SetFields(fbeValue *StructVector) error {
    var err error = nil
