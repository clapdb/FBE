...
type BytesFieldNamedStringFinalModel struct {
    // Model buffer
    buffer *fbe.Buffer

    // Final model
    model *FinalModelBytesFieldNamedString
}

// Create a new BytesFieldNamedString final model
func NewBytesFieldNamedStringFinalModel(buffer *fbe.Buffer) *BytesFieldNamedStringFinalModel {
    return &BytesFieldNamedStringFinalModel{buffer: buffer, model: NewFinalModelBytesFieldNamedString(buffer, 8)}
}

// Get the final model buffer
func (m *BytesFieldNamedStringFinalModel) Buffer() *fbe.Buffer { return m.buffer }
// Get the final model
func (m *BytesFieldNamedStringFinalModel) Model() *FinalModelBytesFieldNamedString { return m.model }

// // Get the final model type
func (m *BytesFieldNamedStringFinalModel) FBEType() int { return m.model.FBEType() }

// Check if the struct value is valid
func (m *BytesFieldNamedStringFinalModel) Verify() bool {
...
func (m *BytesFieldNamedStringFinalModel) CreateBegin() int {
    fbeBegin := m.buffer.Allocate(4 + m.model.FBESize())
    return fbeBegin
}

// Create a new final model (end phase)
func (m *BytesFieldNamedStringFinalModel) CreateEnd(fbeBegin int) int {
...
func (m *BytesFieldNamedStringFinalModel) Serialize(value *BytesFieldNamedString) (int, error) {
...
func (m *BytesFieldNamedStringFinalModel) Deserialize() (*BytesFieldNamedString, int, error) {
...
func (m *BytesFieldNamedStringFinalModel) DeserializeValue(value *BytesFieldNamedString) (int, error) {
...
func (m *BytesFieldNamedStringFinalModel) Next(prev int) {
