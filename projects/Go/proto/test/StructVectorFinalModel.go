...
type StructVectorFinalModel struct {
    // Model buffer
    buffer *fbe.Buffer

    // Final model
    model *FinalModelStructVector
}

// Create a new StructVector final model
func NewStructVectorFinalModel(buffer *fbe.Buffer) *StructVectorFinalModel {
    return &StructVectorFinalModel{buffer: buffer, model: NewFinalModelStructVector(buffer, 8)}
}

// Get the final model buffer
func (m *StructVectorFinalModel) Buffer() *fbe.Buffer { return m.buffer }
// Get the final model
func (m *StructVectorFinalModel) Model() *FinalModelStructVector { return m.model }

// // Get the final model type
func (m *StructVectorFinalModel) FBEType() int { return m.model.FBEType() }

// Check if the struct value is valid
func (m *StructVectorFinalModel) Verify() bool {
...
func (m *StructVectorFinalModel) CreateBegin() int {
    fbeBegin := m.buffer.Allocate(4 + m.model.FBESize())
    return fbeBegin
}

// Create a new final model (end phase)
func (m *StructVectorFinalModel) CreateEnd(fbeBegin int) int {
...
func (m *StructVectorFinalModel) Serialize(value *StructVector) (int, error) {
...
func (m *StructVectorFinalModel) Deserialize() (*StructVector, int, error) {
...
func (m *StructVectorFinalModel) DeserializeValue(value *StructVector) (int, error) {
...
func (m *StructVectorFinalModel) Next(prev int) {
