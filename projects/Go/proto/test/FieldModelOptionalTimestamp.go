...
func (fm *FieldModelOptionalTimestamp) Value() *fbe.FieldModelTimestamp { return fm.value }

// Get the field size
func (fm *FieldModelOptionalTimestamp) FBESize() int { return 1 + 4 }

// Get the field extra size
func (fm *FieldModelOptionalTimestamp) FBEExtra() int {
    if !fm.HasValue() {
        return 0
    }
...
func (fm *FieldModelOptionalTimestamp) FBEOffset() int { return fm.offset }
// Set the field offset
func (fm *FieldModelOptionalTimestamp) SetFBEOffset(value int) { fm.offset = value }

// Shift the current field offset
func (fm *FieldModelOptionalTimestamp) FBEShift(size int) { fm.offset += size }
// Unshift the current field offset
func (fm *FieldModelOptionalTimestamp) FBEUnshift(size int) { fm.offset -= size }

// Check if the object contains a value
func (fm *FieldModelOptionalTimestamp) HasValue() bool {
...
func (fm *FieldModelOptionalTimestamp) Verify() bool {
    if (fm.buffer.Offset() + fm.FBEOffset() + fm.FBESize()) > fm.buffer.Size() {
        return true
    }
...
func (fm *FieldModelOptionalTimestamp) GetBegin() (int, error) {
    if !fm.HasValue() {
        return 0, nil
    }
...
func (fm *FieldModelOptionalTimestamp) GetEnd(fbeBegin int) {
...
func (fm *FieldModelOptionalTimestamp) SetBegin(hasValue bool) (int, error) {
    if (fm.buffer.Offset() + fm.FBEOffset() + fm.FBESize()) > fm.buffer.Size() {
        return 0, nil
    }
...
func (fm *FieldModelOptionalTimestamp) SetEnd(fbeBegin int) {
    fm.buffer.Unshift(fbeBegin)
}

// Set the optional value
func (fm *FieldModelOptionalTimestamp) Set(fbeValue *fbe.Timestamp) error {
