...
// Fast Binary Encoding String->Byte map field model
type FieldModelMapStringByte struct {
    // Field model buffer
    buffer *fbe.Buffer
    ...
    modelValue *fbe.FieldModelByte
}

// Create a new String->Byte map field model
func NewFieldModelMapStringByte(buffer *fbe.Buffer, offset int) *FieldModelMapStringByte {
    fbeResult := FieldModelMapStringByte{buffer: buffer, offset: offset}
    return &fbeResult
}

// Get the field size
func (fm *FieldModelMapStringByte) FBESize() int { return 4 }

// Get the field extra size
func (fm *FieldModelMapStringByte) FBEExtra() int {
    ...
    if fm.modelKey == nil {
        ...
        fm.modelValue = fbe.NewFieldModelByte(fm.buffer, fm.offset)
    }
...
func (fm *FieldModelMapStringByte) FBEOffset() int { return fm.offset }
// Set the field offset
func (fm *FieldModelMapStringByte) SetFBEOffset(value int) { fm.offset = value }

// Shift the current field offset
func (fm *FieldModelMapStringByte) FBEShift(size int) { fm.offset += size }
// Unshift the current field offset
func (fm *FieldModelMapStringByte) FBEUnshift(size int) { fm.offset -= size }

// Get the map offset
func (fm *FieldModelMapStringByte) Offset() int {
    if (fm.buffer.Offset() + fm.FBEOffset() + fm.FBESize()) > fm.buffer.Size() {
        return 0
    }
...
// Get the map size
func (fm *FieldModelMapStringByte) Size() int {
    if (fm.buffer.Offset() + fm.FBEOffset() + fm.FBESize()) > fm.buffer.Size() {
        return 0
    }
...
// Map index operator
func (fm *FieldModelMapStringByte) GetItem(index int) (*fbe.FieldModelString, *fbe.FieldModelByte, error) {
    if (fm.buffer.Offset() + fm.FBEOffset() + fm.FBESize()) > fm.buffer.Size() {
...
func (fm *FieldModelMapStringByte) Resize(size int) (*fbe.FieldModelString, *fbe.FieldModelByte, error) {
    if fm.modelKey == nil {
        fm.modelKey = fbe.NewFieldModelString(fm.buffer, fm.offset)
        fm.modelValue = fbe.NewFieldModelByte(fm.buffer, fm.offset)
    }
...
func (fm *FieldModelMapStringByte) Verify() bool {
    if (fm.buffer.Offset() + fm.FBEOffset() + fm.FBESize()) > fm.buffer.Size() {
        return true
    }
...
// Get the map
func (fm *FieldModelMapStringByte) Get() (map[string]byte, error) {
...
// Set the map
func (fm *FieldModelMapStringByte) Set(values map[string]byte) error {
    if (fm.buffer.Offset() + fm.FBEOffset() + fm.FBESize()) > fm.buffer.Size() {
