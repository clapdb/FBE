...
type FinalModelMapStringFlagsSimple struct {
    // Final model buffer
    buffer *fbe.Buffer
...
// Create a new String->FlagsSimple map final model
func NewFinalModelMapStringFlagsSimple(buffer *fbe.Buffer, offset int) *FinalModelMapStringFlagsSimple {
    fbeResult := FinalModelMapStringFlagsSimple{buffer: buffer, offset: offset}
...
func (fm *FinalModelMapStringFlagsSimple) FBEAllocationSize(values map[string]FlagsSimple) int {
    size := 4
...
func (fm *FinalModelMapStringFlagsSimple) FBEOffset() int { return fm.offset }
// Set the final offset
func (fm *FinalModelMapStringFlagsSimple) SetFBEOffset(value int) { fm.offset = value }

// Shift the current final offset
func (fm *FinalModelMapStringFlagsSimple) FBEShift(size int) { fm.offset += size }
// Unshift the current final offset
func (fm *FinalModelMapStringFlagsSimple) FBEUnshift(size int) { fm.offset -= size }

// Check if the map is valid
func (fm *FinalModelMapStringFlagsSimple) Verify() int {
...
// Get the map
func (fm *FinalModelMapStringFlagsSimple) Get() (map[string]FlagsSimple, int, error) {
...
// Set the map
func (fm *FinalModelMapStringFlagsSimple) Set(values map[string]FlagsSimple) (int, error) {
    if (fm.buffer.Offset() + fm.FBEOffset() + 4) > fm.buffer.Size() {
