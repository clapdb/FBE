...
type FinalModelMapStringOptionalStructSimple struct {
    // Final model buffer
    buffer *fbe.Buffer
    ...
    modelValue *FinalModelOptionalStructSimple
}

// Create a new String->OptionalStructSimple map final model
func NewFinalModelMapStringOptionalStructSimple(buffer *fbe.Buffer, offset int) *FinalModelMapStringOptionalStructSimple {
    fbeResult := FinalModelMapStringOptionalStructSimple{buffer: buffer, offset: offset}
    fbeResult.modelKey = fbe.NewFinalModelString(buffer, offset)
    fbeResult.modelValue = NewFinalModelOptionalStructSimple(buffer, offset)
    return &fbeResult
}

// Get the allocation size
func (fm *FinalModelMapStringOptionalStructSimple) FBEAllocationSize(values map[string]*StructSimple) int {
    size := 4
...
func (fm *FinalModelMapStringOptionalStructSimple) FBEOffset() int { return fm.offset }
// Set the final offset
func (fm *FinalModelMapStringOptionalStructSimple) SetFBEOffset(value int) { fm.offset = value }

// Shift the current final offset
func (fm *FinalModelMapStringOptionalStructSimple) FBEShift(size int) { fm.offset += size }
// Unshift the current final offset
func (fm *FinalModelMapStringOptionalStructSimple) FBEUnshift(size int) { fm.offset -= size }

// Check if the map is valid
func (fm *FinalModelMapStringOptionalStructSimple) Verify() int {
...
// Get the map
func (fm *FinalModelMapStringOptionalStructSimple) Get() (map[string]*StructSimple, int, error) {
...
// Set the map
func (fm *FinalModelMapStringOptionalStructSimple) Set(values map[string]*StructSimple) (int, error) {
    if (fm.buffer.Offset() + fm.FBEOffset() + 4) > fm.buffer.Size() {
