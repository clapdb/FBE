...
type FieldModelVectorEnumSimple struct {
    // Field model buffer
    buffer *fbe.Buffer
...
// Get the field size
func (fm *FieldModelVectorEnumSimple) FBESize() int { return 4 }

// Get the field extra size
func (fm *FieldModelVectorEnumSimple) FBEExtra() int {
...
func (fm *FieldModelVectorEnumSimple) FBEOffset() int { return fm.offset }
// Set the field offset
func (fm *FieldModelVectorEnumSimple) SetFBEOffset(value int) { fm.offset = value }

// Shift the current field offset
func (fm *FieldModelVectorEnumSimple) FBEShift(size int) { fm.offset += size }
// Unshift the current field offset
func (fm *FieldModelVectorEnumSimple) FBEUnshift(size int) { fm.offset -= size }

// Get the vector offset
func (fm *FieldModelVectorEnumSimple) Offset() int {
    if (fm.buffer.Offset() + fm.FBEOffset() + fm.FBESize()) > fm.buffer.Size() {
        return 0
    }
...
// Get the vector size
func (fm *FieldModelVectorEnumSimple) Size() int {
    if (fm.buffer.Offset() + fm.FBEOffset() + fm.FBESize()) > fm.buffer.Size() {
        return 0
    }
...
func (fm *FieldModelVectorEnumSimple) GetItem(index int) (*FieldModelEnumSimple, error) {
    if (fm.buffer.Offset() + fm.FBEOffset() + fm.FBESize()) > fm.buffer.Size() {
...
func (fm *FieldModelVectorEnumSimple) Verify() bool {
    if (fm.buffer.Offset() + fm.FBEOffset() + fm.FBESize()) > fm.buffer.Size() {
        return true
    }
...
// Get the vector
func (fm *FieldModelVectorEnumSimple) Get() ([]EnumSimple, error) {
...
// Set the vector
func (fm *FieldModelVectorEnumSimple) Set(values []EnumSimple) error {
    if (fm.buffer.Offset() + fm.FBEOffset() + fm.FBESize()) > fm.buffer.Size() {
