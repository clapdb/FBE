...
type FinalModelVectorFlagsSimple struct {
    // Final model buffer
    buffer *fbe.Buffer
...
// Create a new FlagsSimple vector final model
func NewFinalModelVectorFlagsSimple(buffer *fbe.Buffer, offset int) *FinalModelVectorFlagsSimple {
    fbeResult := FinalModelVectorFlagsSimple{buffer: buffer, offset: offset}
    fbeResult.model = NewFinalModelFlagsSimple(buffer, offset)
    return &fbeResult
}

// Get the allocation size
func (fm *FinalModelVectorFlagsSimple) FBEAllocationSize(values []FlagsSimple) int {
    size := 4
...
func (fm *FinalModelVectorFlagsSimple) FBEOffset() int { return fm.offset }
// Set the final offset
func (fm *FinalModelVectorFlagsSimple) SetFBEOffset(value int) { fm.offset = value }

// Shift the current final offset
func (fm *FinalModelVectorFlagsSimple) FBEShift(size int) { fm.offset += size }
// Unshift the current final offset
func (fm *FinalModelVectorFlagsSimple) FBEUnshift(size int) { fm.offset -= size }

// Check if the vector is valid
func (fm *FinalModelVectorFlagsSimple) Verify() int {
...
// Get the vector
func (fm *FinalModelVectorFlagsSimple) Get() ([]FlagsSimple, int, error) {
...
// Set the vector
func (fm *FinalModelVectorFlagsSimple) Set(values []FlagsSimple) (int, error) {
    if (fm.buffer.Offset() + fm.FBEOffset() + 4) > fm.buffer.Size() {
