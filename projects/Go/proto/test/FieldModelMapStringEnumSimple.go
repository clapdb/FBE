...
type FieldModelMapStringEnumSimple struct {
    // Field model buffer
    buffer *fbe.Buffer
...
// Create a new String->EnumSimple map field model
func NewFieldModelMapStringEnumSimple(buffer *fbe.Buffer, offset int) *FieldModelMapStringEnumSimple {
    fbeResult := FieldModelMapStringEnumSimple{buffer: buffer, offset: offset}
    return &fbeResult
}

// Get the field size
func (fm *FieldModelMapStringEnumSimple) FBESize() int { return 4 }

// Get the field extra size
func (fm *FieldModelMapStringEnumSimple) FBEExtra() int {
...
func (fm *FieldModelMapStringEnumSimple) FBEOffset() int { return fm.offset }
// Set the field offset
func (fm *FieldModelMapStringEnumSimple) SetFBEOffset(value int) { fm.offset = value }

// Shift the current field offset
func (fm *FieldModelMapStringEnumSimple) FBEShift(size int) { fm.offset += size }
// Unshift the current field offset
func (fm *FieldModelMapStringEnumSimple) FBEUnshift(size int) { fm.offset -= size }

// Get the map offset
func (fm *FieldModelMapStringEnumSimple) Offset() int {
    if (fm.buffer.Offset() + fm.FBEOffset() + fm.FBESize()) > fm.buffer.Size() {
        return 0
    }
...
// Get the map size
func (fm *FieldModelMapStringEnumSimple) Size() int {
    if (fm.buffer.Offset() + fm.FBEOffset() + fm.FBESize()) > fm.buffer.Size() {
        return 0
    }
...
// Map index operator
func (fm *FieldModelMapStringEnumSimple) GetItem(index int) (*fbe.FieldModelString, *FieldModelEnumSimple, error) {
    if (fm.buffer.Offset() + fm.FBEOffset() + fm.FBESize()) > fm.buffer.Size() {
...
func (fm *FieldModelMapStringEnumSimple) Resize(size int) (*fbe.FieldModelString, *FieldModelEnumSimple, error) {
    if fm.modelKey == nil {
        fm.modelKey = fbe.NewFieldModelString(fm.buffer, fm.offset)
        fm.modelValue = NewFieldModelEnumSimple(fm.buffer, fm.offset)
    }
...
func (fm *FieldModelMapStringEnumSimple) Verify() bool {
    if (fm.buffer.Offset() + fm.FBEOffset() + fm.FBESize()) > fm.buffer.Size() {
        return true
    }
...
// Get the map
func (fm *FieldModelMapStringEnumSimple) Get() (map[string]EnumSimple, error) {
...
// Set the map
func (fm *FieldModelMapStringEnumSimple) Set(values map[string]EnumSimple) error {
    if (fm.buffer.Offset() + fm.FBEOffset() + fm.FBESize()) > fm.buffer.Size() {
