...
type FieldModelMapInt32Byte struct {
    // Field model buffer
    buffer *fbe.Buffer
...
// Create a new Int32->Byte map field model
func NewFieldModelMapInt32Byte(buffer *fbe.Buffer, offset int) *FieldModelMapInt32Byte {
    fbeResult := FieldModelMapInt32Byte{buffer: buffer, offset: offset}
...
// Get the field size
func (fm *FieldModelMapInt32Byte) FBESize() int { return 4 }

// Get the field extra size
func (fm *FieldModelMapInt32Byte) FBEExtra() int {
...
func (fm *FieldModelMapInt32Byte) FBEOffset() int { return fm.offset }
// Set the field offset
func (fm *FieldModelMapInt32Byte) SetFBEOffset(value int) { fm.offset = value }

// Shift the current field offset
func (fm *FieldModelMapInt32Byte) FBEShift(size int) { fm.offset += size }
// Unshift the current field offset
func (fm *FieldModelMapInt32Byte) FBEUnshift(size int) { fm.offset -= size }

// Get the map offset
func (fm *FieldModelMapInt32Byte) Offset() int {
    if (fm.buffer.Offset() + fm.FBEOffset() + fm.FBESize()) > fm.buffer.Size() {
        return 0
    }
...
// Get the map size
func (fm *FieldModelMapInt32Byte) Size() int {
    if (fm.buffer.Offset() + fm.FBEOffset() + fm.FBESize()) > fm.buffer.Size() {
        return 0
    }
...
// Map index operator
func (fm *FieldModelMapInt32Byte) GetItem(index int) (*fbe.FieldModelInt32, *fbe.FieldModelByte, error) {
    if (fm.buffer.Offset() + fm.FBEOffset() + fm.FBESize()) > fm.buffer.Size() {
...
func (fm *FieldModelMapInt32Byte) Resize(size int) (*fbe.FieldModelInt32, *fbe.FieldModelByte, error) {
...
func (fm *FieldModelMapInt32Byte) Verify() bool {
    if (fm.buffer.Offset() + fm.FBEOffset() + fm.FBESize()) > fm.buffer.Size() {
        return true
    }
...
// Get the map
func (fm *FieldModelMapInt32Byte) Get() (map[int32]byte, error) {
...
// Set the map
func (fm *FieldModelMapInt32Byte) Set(values map[int32]byte) error {
    if (fm.buffer.Offset() + fm.FBEOffset() + fm.FBESize()) > fm.buffer.Size() {
