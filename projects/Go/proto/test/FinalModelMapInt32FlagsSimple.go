...
// Fast Binary Encoding Int32->FlagsSimple map final model
type FinalModelMapInt32FlagsSimple struct {
    // Final model buffer
    buffer *fbe.Buffer
    ...
    modelValue *FinalModelFlagsSimple
}

// Create a new Int32->FlagsSimple map final model
func NewFinalModelMapInt32FlagsSimple(buffer *fbe.Buffer, offset int) *FinalModelMapInt32FlagsSimple {
    fbeResult := FinalModelMapInt32FlagsSimple{buffer: buffer, offset: offset}
    fbeResult.modelKey = fbe.NewFinalModelInt32(buffer, offset)
    fbeResult.modelValue = NewFinalModelFlagsSimple(buffer, offset)
    return &fbeResult
}

// Get the allocation size
func (fm *FinalModelMapInt32FlagsSimple) FBEAllocationSize(values map[int32]FlagsSimple) int {
    size := 4
...
func (fm *FinalModelMapInt32FlagsSimple) FBEOffset() int { return fm.offset }
// Set the final offset
func (fm *FinalModelMapInt32FlagsSimple) SetFBEOffset(value int) { fm.offset = value }

// Shift the current final offset
func (fm *FinalModelMapInt32FlagsSimple) FBEShift(size int) { fm.offset += size }
// Unshift the current final offset
func (fm *FinalModelMapInt32FlagsSimple) FBEUnshift(size int) { fm.offset -= size }

// Check if the map is valid
func (fm *FinalModelMapInt32FlagsSimple) Verify() int {
...
// Get the map
func (fm *FinalModelMapInt32FlagsSimple) Get() (map[int32]FlagsSimple, int, error) {
...
// Set the map
func (fm *FinalModelMapInt32FlagsSimple) Set(values map[int32]FlagsSimple) (int, error) {
    if (fm.buffer.Offset() + fm.FBEOffset() + 4) > fm.buffer.Size() {
