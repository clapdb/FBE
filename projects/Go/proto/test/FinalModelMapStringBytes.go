...
type FinalModelMapStringBytes struct {
    // Final model buffer
    buffer *fbe.Buffer
...
// Create a new String->Bytes map final model
func NewFinalModelMapStringBytes(buffer *fbe.Buffer, offset int) *FinalModelMapStringBytes {
    fbeResult := FinalModelMapStringBytes{buffer: buffer, offset: offset}
...
func (fm *FinalModelMapStringBytes) FBEAllocationSize(values map[string][]byte) int {
    size := 4
...
func (fm *FinalModelMapStringBytes) FBEOffset() int { return fm.offset }
// Set the final offset
func (fm *FinalModelMapStringBytes) SetFBEOffset(value int) { fm.offset = value }

// Shift the current final offset
func (fm *FinalModelMapStringBytes) FBEShift(size int) { fm.offset += size }
// Unshift the current final offset
func (fm *FinalModelMapStringBytes) FBEUnshift(size int) { fm.offset -= size }

// Check if the map is valid
func (fm *FinalModelMapStringBytes) Verify() int {
...
// Get the map
func (fm *FinalModelMapStringBytes) Get() (map[string][]byte, int, error) {
...
// Set the map
func (fm *FinalModelMapStringBytes) Set(values map[string][]byte) (int, error) {
    if (fm.buffer.Offset() + fm.FBEOffset() + 4) > fm.buffer.Size() {
