...
func (fm *FinalModelOptionalStructNested) Value() *FinalModelStructNested { return fm.value }

// Get the allocation size
func (fm *FinalModelOptionalStructNested) FBEAllocationSize(fbeValue *StructNested) int {
    if fbeValue != nil {
...
func (fm *FinalModelOptionalStructNested) FBEOffset() int { return fm.offset }
// Set the final offset
func (fm *FinalModelOptionalStructNested) SetFBEOffset(value int) { fm.offset = value }

// Shift the current final offset
func (fm *FinalModelOptionalStructNested) FBEShift(size int) { fm.offset += size }
// Unshift the current final offset
func (fm *FinalModelOptionalStructNested) FBEUnshift(size int) { fm.offset -= size }

// Check if the object contains a value
func (fm *FinalModelOptionalStructNested) HasValue() bool {
...
func (fm *FinalModelOptionalStructNested) Verify() int {
    if (fm.buffer.Offset() + fm.FBEOffset() + 1) > fm.buffer.Size() {
        return fbe.MaxInt
    }
...
func (fm *FinalModelOptionalStructNested) Get() (*StructNested, int, error) {
...
func (fm *FinalModelOptionalStructNested) Set(fbeValue *StructNested) (int, error) {
    if (fm.buffer.Offset() + fm.FBEOffset() + 1) > fm.buffer.Size() {
