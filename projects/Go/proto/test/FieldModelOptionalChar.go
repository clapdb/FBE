...
type FieldModelOptionalChar struct {
    // Field model buffer
    buffer *fbe.Buffer
    ...
    value *fbe.FieldModelChar
}

// Create a new optional Char field model
func NewFieldModelOptionalChar(buffer *fbe.Buffer, offset int) *FieldModelOptionalChar {
    fbeResult := FieldModelOptionalChar{buffer: buffer, offset: offset}
    fbeResult.value = fbe.NewFieldModelChar(buffer, 0)
    return &fbeResult
}

// Get the optional field model value
func (fm *FieldModelOptionalChar) Value() *fbe.FieldModelChar { return fm.value }

// Get the field size
func (fm *FieldModelOptionalChar) FBESize() int { return 1 + 4 }

// Get the field extra size
func (fm *FieldModelOptionalChar) FBEExtra() int {
    if !fm.HasValue() {
        return 0
    }
...
func (fm *FieldModelOptionalChar) FBEOffset() int { return fm.offset }
// Set the field offset
func (fm *FieldModelOptionalChar) SetFBEOffset(value int) { fm.offset = value }

// Shift the current field offset
func (fm *FieldModelOptionalChar) FBEShift(size int) { fm.offset += size }
// Unshift the current field offset
func (fm *FieldModelOptionalChar) FBEUnshift(size int) { fm.offset -= size }

// Check if the object contains a value
func (fm *FieldModelOptionalChar) HasValue() bool {
...
func (fm *FieldModelOptionalChar) Verify() bool {
    if (fm.buffer.Offset() + fm.FBEOffset() + fm.FBESize()) > fm.buffer.Size() {
        return true
    }
...
func (fm *FieldModelOptionalChar) GetBegin() (int, error) {
    if !fm.HasValue() {
        return 0, nil
    }
...
func (fm *FieldModelOptionalChar) GetEnd(fbeBegin int) {
...
func (fm *FieldModelOptionalChar) SetBegin(hasValue bool) (int, error) {
    if (fm.buffer.Offset() + fm.FBEOffset() + fm.FBESize()) > fm.buffer.Size() {
        return 0, nil
    }
...
func (fm *FieldModelOptionalChar) SetEnd(fbeBegin int) {
    fm.buffer.Unshift(fbeBegin)
}

// Set the optional value
func (fm *FieldModelOptionalChar) Set(fbeValue *rune) error {
