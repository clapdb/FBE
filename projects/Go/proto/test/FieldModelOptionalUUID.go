...
func (fm *FieldModelOptionalUUID) Value() *fbe.FieldModelUUID { return fm.value }

// Get the field size
func (fm *FieldModelOptionalUUID) FBESize() int { return 1 + 4 }

// Get the field extra size
func (fm *FieldModelOptionalUUID) FBEExtra() int {
    if !fm.HasValue() {
        return 0
    }
...
func (fm *FieldModelOptionalUUID) FBEOffset() int { return fm.offset }
// Set the field offset
func (fm *FieldModelOptionalUUID) SetFBEOffset(value int) { fm.offset = value }

// Shift the current field offset
func (fm *FieldModelOptionalUUID) FBEShift(size int) { fm.offset += size }
// Unshift the current field offset
func (fm *FieldModelOptionalUUID) FBEUnshift(size int) { fm.offset -= size }

// Check if the object contains a value
func (fm *FieldModelOptionalUUID) HasValue() bool {
...
func (fm *FieldModelOptionalUUID) Verify() bool {
    if (fm.buffer.Offset() + fm.FBEOffset() + fm.FBESize()) > fm.buffer.Size() {
        return true
    }
...
func (fm *FieldModelOptionalUUID) GetBegin() (int, error) {
    if !fm.HasValue() {
        return 0, nil
    }
...
func (fm *FieldModelOptionalUUID) GetEnd(fbeBegin int) {
...
func (fm *FieldModelOptionalUUID) SetBegin(hasValue bool) (int, error) {
    if (fm.buffer.Offset() + fm.FBEOffset() + fm.FBESize()) > fm.buffer.Size() {
        return 0, nil
    }
...
func (fm *FieldModelOptionalUUID) SetEnd(fbeBegin int) {
    fm.buffer.Unshift(fbeBegin)
}

// Set the optional value
func (fm *FieldModelOptionalUUID) Set(fbeValue *fbe.UUID) error {
