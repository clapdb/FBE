...
type FieldModelVectorFlagsSimple struct {
    // Field model buffer
    buffer *fbe.Buffer
...
// Create a new FlagsSimple vector field model
func NewFieldModelVectorFlagsSimple(buffer *fbe.Buffer, offset int) *FieldModelVectorFlagsSimple {
    fbeResult := FieldModelVectorFlagsSimple{buffer: buffer, offset: offset}
    return &fbeResult
}

// Get the field size
func (fm *FieldModelVectorFlagsSimple) FBESize() int { return 4 }

// Get the field extra size
func (fm *FieldModelVectorFlagsSimple) FBEExtra() int {
    ...
    fbeResult := 0
    if fm.model == nil {
        fm.model = NewFieldModelFlagsSimple(fm.buffer, fm.offset)
    }
...
func (fm *FieldModelVectorFlagsSimple) FBEOffset() int { return fm.offset }
// Set the field offset
func (fm *FieldModelVectorFlagsSimple) SetFBEOffset(value int) { fm.offset = value }

// Shift the current field offset
func (fm *FieldModelVectorFlagsSimple) FBEShift(size int) { fm.offset += size }
// Unshift the current field offset
func (fm *FieldModelVectorFlagsSimple) FBEUnshift(size int) { fm.offset -= size }

// Get the vector offset
func (fm *FieldModelVectorFlagsSimple) Offset() int {
    if (fm.buffer.Offset() + fm.FBEOffset() + fm.FBESize()) > fm.buffer.Size() {
        return 0
    }
...
// Get the vector size
func (fm *FieldModelVectorFlagsSimple) Size() int {
    if (fm.buffer.Offset() + fm.FBEOffset() + fm.FBESize()) > fm.buffer.Size() {
        return 0
    }
...
func (fm *FieldModelVectorFlagsSimple) Resize(size int) (*FieldModelFlagsSimple, error) {
    if fm.model == nil {
        fm.model = NewFieldModelFlagsSimple(fm.buffer, fm.offset)
    }
...
func (fm *FieldModelVectorFlagsSimple) Verify() bool {
    if (fm.buffer.Offset() + fm.FBEOffset() + fm.FBESize()) > fm.buffer.Size() {
        return true
    }
...
// Get the vector
func (fm *FieldModelVectorFlagsSimple) Get() ([]FlagsSimple, error) {
...
// Set the vector
func (fm *FieldModelVectorFlagsSimple) Set(values []FlagsSimple) error {
    if (fm.buffer.Offset() + fm.FBEOffset() + fm.FBESize()) > fm.buffer.Size() {
