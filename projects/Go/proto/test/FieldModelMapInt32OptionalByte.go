...
// Fast Binary Encoding Int32->OptionalByte map field model
type FieldModelMapInt32OptionalByte struct {
    // Field model buffer
    buffer *fbe.Buffer
...
// Create a new Int32->OptionalByte map field model
func NewFieldModelMapInt32OptionalByte(buffer *fbe.Buffer, offset int) *FieldModelMapInt32OptionalByte {
    fbeResult := FieldModelMapInt32OptionalByte{buffer: buffer, offset: offset}
    return &fbeResult
}

// Get the field size
func (fm *FieldModelMapInt32OptionalByte) FBESize() int { return 4 }

// Get the field extra size
func (fm *FieldModelMapInt32OptionalByte) FBEExtra() int {
    ...
    if fm.modelKey == nil {
        ...
        fm.modelValue = NewFieldModelOptionalByte(fm.buffer, fm.offset)
    }
...
func (fm *FieldModelMapInt32OptionalByte) FBEOffset() int { return fm.offset }
// Set the field offset
func (fm *FieldModelMapInt32OptionalByte) SetFBEOffset(value int) { fm.offset = value }

// Shift the current field offset
func (fm *FieldModelMapInt32OptionalByte) FBEShift(size int) { fm.offset += size }
// Unshift the current field offset
func (fm *FieldModelMapInt32OptionalByte) FBEUnshift(size int) { fm.offset -= size }

// Get the map offset
func (fm *FieldModelMapInt32OptionalByte) Offset() int {
    if (fm.buffer.Offset() + fm.FBEOffset() + fm.FBESize()) > fm.buffer.Size() {
        return 0
    }
...
// Get the map size
func (fm *FieldModelMapInt32OptionalByte) Size() int {
    if (fm.buffer.Offset() + fm.FBEOffset() + fm.FBESize()) > fm.buffer.Size() {
        return 0
    }
...
// Map index operator
func (fm *FieldModelMapInt32OptionalByte) GetItem(index int) (*fbe.FieldModelInt32, *FieldModelOptionalByte, error) {
    if (fm.buffer.Offset() + fm.FBEOffset() + fm.FBESize()) > fm.buffer.Size() {
...
func (fm *FieldModelMapInt32OptionalByte) Resize(size int) (*fbe.FieldModelInt32, *FieldModelOptionalByte, error) {
    if fm.modelKey == nil {
        fm.modelKey = fbe.NewFieldModelInt32(fm.buffer, fm.offset)
        fm.modelValue = NewFieldModelOptionalByte(fm.buffer, fm.offset)
    }
...
func (fm *FieldModelMapInt32OptionalByte) Verify() bool {
    if (fm.buffer.Offset() + fm.FBEOffset() + fm.FBESize()) > fm.buffer.Size() {
        return true
    }
...
// Get the map
func (fm *FieldModelMapInt32OptionalByte) Get() (map[int32]*byte, error) {
...
// Set the map
func (fm *FieldModelMapInt32OptionalByte) Set(values map[int32]*byte) error {
    if (fm.buffer.Offset() + fm.FBEOffset() + fm.FBESize()) > fm.buffer.Size() {
