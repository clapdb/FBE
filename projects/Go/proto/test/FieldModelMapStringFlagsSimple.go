...
type FieldModelMapStringFlagsSimple struct {
    // Field model buffer
    buffer *fbe.Buffer
...
// Create a new String->FlagsSimple map field model
func NewFieldModelMapStringFlagsSimple(buffer *fbe.Buffer, offset int) *FieldModelMapStringFlagsSimple {
    fbeResult := FieldModelMapStringFlagsSimple{buffer: buffer, offset: offset}
    return &fbeResult
}

// Get the field size
func (fm *FieldModelMapStringFlagsSimple) FBESize() int { return 4 }

// Get the field extra size
func (fm *FieldModelMapStringFlagsSimple) FBEExtra() int {
    ...
    fbeResult := 0
    if fm.modelKey == nil {
        fm.modelKey = fbe.NewFieldModelString(fm.buffer, fm.offset)
...
func (fm *FieldModelMapStringFlagsSimple) FBEOffset() int { return fm.offset }
// Set the field offset
func (fm *FieldModelMapStringFlagsSimple) SetFBEOffset(value int) { fm.offset = value }

// Shift the current field offset
func (fm *FieldModelMapStringFlagsSimple) FBEShift(size int) { fm.offset += size }
// Unshift the current field offset
func (fm *FieldModelMapStringFlagsSimple) FBEUnshift(size int) { fm.offset -= size }

// Get the map offset
func (fm *FieldModelMapStringFlagsSimple) Offset() int {
    if (fm.buffer.Offset() + fm.FBEOffset() + fm.FBESize()) > fm.buffer.Size() {
        return 0
    }
...
// Get the map size
func (fm *FieldModelMapStringFlagsSimple) Size() int {
    if (fm.buffer.Offset() + fm.FBEOffset() + fm.FBESize()) > fm.buffer.Size() {
        return 0
    }
...
// Map index operator
func (fm *FieldModelMapStringFlagsSimple) GetItem(index int) (*fbe.FieldModelString, *FieldModelFlagsSimple, error) {
    if (fm.buffer.Offset() + fm.FBEOffset() + fm.FBESize()) > fm.buffer.Size() {
...
func (fm *FieldModelMapStringFlagsSimple) Resize(size int) (*fbe.FieldModelString, *FieldModelFlagsSimple, error) {
    if fm.modelKey == nil {
        fm.modelKey = fbe.NewFieldModelString(fm.buffer, fm.offset)
        fm.modelValue = NewFieldModelFlagsSimple(fm.buffer, fm.offset)
    }
...
func (fm *FieldModelMapStringFlagsSimple) Verify() bool {
    if (fm.buffer.Offset() + fm.FBEOffset() + fm.FBESize()) > fm.buffer.Size() {
        return true
    }
...
// Get the map
func (fm *FieldModelMapStringFlagsSimple) Get() (map[string]FlagsSimple, error) {
...
// Set the map
func (fm *FieldModelMapStringFlagsSimple) Set(values map[string]FlagsSimple) error {
    if (fm.buffer.Offset() + fm.FBEOffset() + fm.FBESize()) > fm.buffer.Size() {
