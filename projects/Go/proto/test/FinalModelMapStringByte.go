...
// Fast Binary Encoding String->Byte map final model
type FinalModelMapStringByte struct {
    // Final model buffer
    buffer *fbe.Buffer
...
// Create a new String->Byte map final model
func NewFinalModelMapStringByte(buffer *fbe.Buffer, offset int) *FinalModelMapStringByte {
    fbeResult := FinalModelMapStringByte{buffer: buffer, offset: offset}
...
func (fm *FinalModelMapStringByte) FBEAllocationSize(values map[string]byte) int {
    size := 4
...
func (fm *FinalModelMapStringByte) FBEOffset() int { return fm.offset }
// Set the final offset
func (fm *FinalModelMapStringByte) SetFBEOffset(value int) { fm.offset = value }

// Shift the current final offset
func (fm *FinalModelMapStringByte) FBEShift(size int) { fm.offset += size }
// Unshift the current final offset
func (fm *FinalModelMapStringByte) FBEUnshift(size int) { fm.offset -= size }

// Check if the map is valid
func (fm *FinalModelMapStringByte) Verify() int {
...
// Get the map
func (fm *FinalModelMapStringByte) Get() (map[string]byte, int, error) {
...
// Set the map
func (fm *FinalModelMapStringByte) Set(values map[string]byte) (int, error) {
    if (fm.buffer.Offset() + fm.FBEOffset() + 4) > fm.buffer.Size() {
