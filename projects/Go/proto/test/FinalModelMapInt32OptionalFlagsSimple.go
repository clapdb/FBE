...
// Fast Binary Encoding Int32->OptionalFlagsSimple map final model
type FinalModelMapInt32OptionalFlagsSimple struct {
    // Final model buffer
    buffer *fbe.Buffer
...
// Create a new Int32->OptionalFlagsSimple map final model
func NewFinalModelMapInt32OptionalFlagsSimple(buffer *fbe.Buffer, offset int) *FinalModelMapInt32OptionalFlagsSimple {
    fbeResult := FinalModelMapInt32OptionalFlagsSimple{buffer: buffer, offset: offset}
...
func (fm *FinalModelMapInt32OptionalFlagsSimple) FBEAllocationSize(values map[int32]*FlagsSimple) int {
    size := 4
...
func (fm *FinalModelMapInt32OptionalFlagsSimple) FBEOffset() int { return fm.offset }
// Set the final offset
func (fm *FinalModelMapInt32OptionalFlagsSimple) SetFBEOffset(value int) { fm.offset = value }

// Shift the current final offset
func (fm *FinalModelMapInt32OptionalFlagsSimple) FBEShift(size int) { fm.offset += size }
// Unshift the current final offset
func (fm *FinalModelMapInt32OptionalFlagsSimple) FBEUnshift(size int) { fm.offset -= size }

// Check if the map is valid
func (fm *FinalModelMapInt32OptionalFlagsSimple) Verify() int {
...
// Get the map
func (fm *FinalModelMapInt32OptionalFlagsSimple) Get() (map[int32]*FlagsSimple, int, error) {
...
// Set the map
func (fm *FinalModelMapInt32OptionalFlagsSimple) Set(values map[int32]*FlagsSimple) (int, error) {
    if (fm.buffer.Offset() + fm.FBEOffset() + 4) > fm.buffer.Size() {
