...
type FinalModelMapInt32EnumSimple struct {
    // Final model buffer
    buffer *fbe.Buffer
...
// Create a new Int32->EnumSimple map final model
func NewFinalModelMapInt32EnumSimple(buffer *fbe.Buffer, offset int) *FinalModelMapInt32EnumSimple {
    fbeResult := FinalModelMapInt32EnumSimple{buffer: buffer, offset: offset}
...
func (fm *FinalModelMapInt32EnumSimple) FBEAllocationSize(values map[int32]EnumSimple) int {
    size := 4
...
func (fm *FinalModelMapInt32EnumSimple) FBEOffset() int { return fm.offset }
// Set the final offset
func (fm *FinalModelMapInt32EnumSimple) SetFBEOffset(value int) { fm.offset = value }

// Shift the current final offset
func (fm *FinalModelMapInt32EnumSimple) FBEShift(size int) { fm.offset += size }
// Unshift the current final offset
func (fm *FinalModelMapInt32EnumSimple) FBEUnshift(size int) { fm.offset -= size }

// Check if the map is valid
func (fm *FinalModelMapInt32EnumSimple) Verify() int {
...
// Get the map
func (fm *FinalModelMapInt32EnumSimple) Get() (map[int32]EnumSimple, int, error) {
...
// Set the map
func (fm *FinalModelMapInt32EnumSimple) Set(values map[int32]EnumSimple) (int, error) {
    if (fm.buffer.Offset() + fm.FBEOffset() + 4) > fm.buffer.Size() {
