...
type StructHashExFinalModel struct {
    // Model buffer
    buffer *fbe.Buffer

    // Final model
    model *FinalModelStructHashEx
}

// Create a new StructHashEx final model
func NewStructHashExFinalModel(buffer *fbe.Buffer) *StructHashExFinalModel {
    return &StructHashExFinalModel{buffer: buffer, model: NewFinalModelStructHashEx(buffer, 8)}
}

// Get the final model buffer
func (m *StructHashExFinalModel) Buffer() *fbe.Buffer { return m.buffer }
// Get the final model
func (m *StructHashExFinalModel) Model() *FinalModelStructHashEx { return m.model }

// // Get the final model type
func (m *StructHashExFinalModel) FBEType() int { return m.model.FBEType() }

// Check if the struct value is valid
func (m *StructHashExFinalModel) Verify() bool {
...
func (m *StructHashExFinalModel) CreateBegin() int {
    fbeBegin := m.buffer.Allocate(4 + m.model.FBESize())
    return fbeBegin
}

// Create a new final model (end phase)
func (m *StructHashExFinalModel) CreateEnd(fbeBegin int) int {
...
func (m *StructHashExFinalModel) Serialize(value *StructHashEx) (int, error) {
...
func (m *StructHashExFinalModel) Deserialize() (*StructHashEx, int, error) {
...
func (m *StructHashExFinalModel) DeserializeValue(value *StructHashEx) (int, error) {
...
func (m *StructHashExFinalModel) Next(prev int) {
