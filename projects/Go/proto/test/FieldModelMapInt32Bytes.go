...
// Fast Binary Encoding Int32->Bytes map field model
type FieldModelMapInt32Bytes struct {
    // Field model buffer
    buffer *fbe.Buffer
    ...
    modelValue *fbe.FieldModelBytes
}

// Create a new Int32->Bytes map field model
func NewFieldModelMapInt32Bytes(buffer *fbe.Buffer, offset int) *FieldModelMapInt32Bytes {
    fbeResult := FieldModelMapInt32Bytes{buffer: buffer, offset: offset}
    fbeResult.modelKey = fbe.NewFieldModelInt32(buffer, offset)
    fbeResult.modelValue = fbe.NewFieldModelBytes(buffer, offset)
    return &fbeResult
}

// Get the field size
func (fm *FieldModelMapInt32Bytes) FBESize() int { return 4 }

// Get the field extra size
func (fm *FieldModelMapInt32Bytes) FBEExtra() int {
...
func (fm *FieldModelMapInt32Bytes) FBEOffset() int { return fm.offset }
// Set the field offset
func (fm *FieldModelMapInt32Bytes) SetFBEOffset(value int) { fm.offset = value }

// Shift the current field offset
func (fm *FieldModelMapInt32Bytes) FBEShift(size int) { fm.offset += size }
// Unshift the current field offset
func (fm *FieldModelMapInt32Bytes) FBEUnshift(size int) { fm.offset -= size }

// Get the map offset
func (fm *FieldModelMapInt32Bytes) Offset() int {
    if (fm.buffer.Offset() + fm.FBEOffset() + fm.FBESize()) > fm.buffer.Size() {
        return 0
    }
...
// Get the map size
func (fm *FieldModelMapInt32Bytes) Size() int {
    if (fm.buffer.Offset() + fm.FBEOffset() + fm.FBESize()) > fm.buffer.Size() {
        return 0
    }
...
// Map index operator
func (fm *FieldModelMapInt32Bytes) GetItem(index int) (*fbe.FieldModelInt32, *fbe.FieldModelBytes, error) {
    if (fm.buffer.Offset() + fm.FBEOffset() + fm.FBESize()) > fm.buffer.Size() {
...
func (fm *FieldModelMapInt32Bytes) Resize(size int) (*fbe.FieldModelInt32, *fbe.FieldModelBytes, error) {
...
func (fm *FieldModelMapInt32Bytes) Verify() bool {
    if (fm.buffer.Offset() + fm.FBEOffset() + fm.FBESize()) > fm.buffer.Size() {
        return true
    }
...
// Get the map
func (fm *FieldModelMapInt32Bytes) Get() (map[int32][]byte, error) {
...
// Set the map
func (fm *FieldModelMapInt32Bytes) Set(values map[int32][]byte) error {
    if (fm.buffer.Offset() + fm.FBEOffset() + fm.FBESize()) > fm.buffer.Size() {
