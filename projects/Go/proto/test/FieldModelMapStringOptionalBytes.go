...
type FieldModelMapStringOptionalBytes struct {
    // Field model buffer
    buffer *fbe.Buffer
...
// Create a new String->OptionalBytes map field model
func NewFieldModelMapStringOptionalBytes(buffer *fbe.Buffer, offset int) *FieldModelMapStringOptionalBytes {
    fbeResult := FieldModelMapStringOptionalBytes{buffer: buffer, offset: offset}
    return &fbeResult
}

// Get the field size
func (fm *FieldModelMapStringOptionalBytes) FBESize() int { return 4 }

// Get the field extra size
func (fm *FieldModelMapStringOptionalBytes) FBEExtra() int {
    ...
    if fm.modelKey == nil {
        ...
        fm.modelValue = NewFieldModelOptionalBytes(fm.buffer, fm.offset)
    }
...
func (fm *FieldModelMapStringOptionalBytes) FBEOffset() int { return fm.offset }
// Set the field offset
func (fm *FieldModelMapStringOptionalBytes) SetFBEOffset(value int) { fm.offset = value }

// Shift the current field offset
func (fm *FieldModelMapStringOptionalBytes) FBEShift(size int) { fm.offset += size }
// Unshift the current field offset
func (fm *FieldModelMapStringOptionalBytes) FBEUnshift(size int) { fm.offset -= size }

// Get the map offset
func (fm *FieldModelMapStringOptionalBytes) Offset() int {
    if (fm.buffer.Offset() + fm.FBEOffset() + fm.FBESize()) > fm.buffer.Size() {
        return 0
    }
...
// Get the map size
func (fm *FieldModelMapStringOptionalBytes) Size() int {
    if (fm.buffer.Offset() + fm.FBEOffset() + fm.FBESize()) > fm.buffer.Size() {
        return 0
    }
...
// Map index operator
func (fm *FieldModelMapStringOptionalBytes) GetItem(index int) (*fbe.FieldModelString, *FieldModelOptionalBytes, error) {
    if (fm.buffer.Offset() + fm.FBEOffset() + fm.FBESize()) > fm.buffer.Size() {
...
func (fm *FieldModelMapStringOptionalBytes) Resize(size int) (*fbe.FieldModelString, *FieldModelOptionalBytes, error) {
    if fm.modelKey == nil {
        fm.modelKey = fbe.NewFieldModelString(fm.buffer, fm.offset)
        fm.modelValue = NewFieldModelOptionalBytes(fm.buffer, fm.offset)
    }
...
func (fm *FieldModelMapStringOptionalBytes) Verify() bool {
    if (fm.buffer.Offset() + fm.FBEOffset() + fm.FBESize()) > fm.buffer.Size() {
        return true
    }
...
// Get the map
func (fm *FieldModelMapStringOptionalBytes) Get() (map[string]*[]byte, error) {
...
// Set the map
func (fm *FieldModelMapStringOptionalBytes) Set(values map[string]*[]byte) error {
    if (fm.buffer.Offset() + fm.FBEOffset() + fm.FBESize()) > fm.buffer.Size() {
