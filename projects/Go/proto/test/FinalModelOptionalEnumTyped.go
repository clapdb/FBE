...
func (fm *FinalModelOptionalEnumTyped) Value() *FinalModelEnumTyped { return fm.value }

// Get the allocation size
func (fm *FinalModelOptionalEnumTyped) FBEAllocationSize(fbeValue *EnumTyped) int {
    if fbeValue != nil {
...
func (fm *FinalModelOptionalEnumTyped) FBEOffset() int { return fm.offset }
// Set the final offset
func (fm *FinalModelOptionalEnumTyped) SetFBEOffset(value int) { fm.offset = value }

// Shift the current final offset
func (fm *FinalModelOptionalEnumTyped) FBEShift(size int) { fm.offset += size }
// Unshift the current final offset
func (fm *FinalModelOptionalEnumTyped) FBEUnshift(size int) { fm.offset -= size }

// Check if the object contains a value
func (fm *FinalModelOptionalEnumTyped) HasValue() bool {
...
func (fm *FinalModelOptionalEnumTyped) Verify() int {
    if (fm.buffer.Offset() + fm.FBEOffset() + 1) > fm.buffer.Size() {
        return fbe.MaxInt
    }
...
func (fm *FinalModelOptionalEnumTyped) Get() (*EnumTyped, int, error) {
...
func (fm *FinalModelOptionalEnumTyped) Set(fbeValue *EnumTyped) (int, error) {
    if (fm.buffer.Offset() + fm.FBEOffset() + 1) > fm.buffer.Size() {
