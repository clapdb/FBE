...
func (fm *FinalModelOptionalUInt16) Value() *fbe.FinalModelUInt16 { return fm.value }

// Get the allocation size
func (fm *FinalModelOptionalUInt16) FBEAllocationSize(fbeValue *uint16) int {
    if fbeValue != nil {
...
func (fm *FinalModelOptionalUInt16) FBEOffset() int { return fm.offset }
// Set the final offset
func (fm *FinalModelOptionalUInt16) SetFBEOffset(value int) { fm.offset = value }

// Shift the current final offset
func (fm *FinalModelOptionalUInt16) FBEShift(size int) { fm.offset += size }
// Unshift the current final offset
func (fm *FinalModelOptionalUInt16) FBEUnshift(size int) { fm.offset -= size }

// Check if the object contains a value
func (fm *FinalModelOptionalUInt16) HasValue() bool {
...
func (fm *FinalModelOptionalUInt16) Verify() int {
    if (fm.buffer.Offset() + fm.FBEOffset() + 1) > fm.buffer.Size() {
        return fbe.MaxInt
    }
...
func (fm *FinalModelOptionalUInt16) Get() (*uint16, int, error) {
...
func (fm *FinalModelOptionalUInt16) Set(fbeValue *uint16) (int, error) {
    if (fm.buffer.Offset() + fm.FBEOffset() + 1) > fm.buffer.Size() {
