...
func (fm *FinalModelOptionalDecimal) Value() *fbe.FinalModelDecimal { return fm.value }

// Get the allocation size
func (fm *FinalModelOptionalDecimal) FBEAllocationSize(fbeValue *fbe.Decimal) int {
    if fbeValue != nil {
...
func (fm *FinalModelOptionalDecimal) FBEOffset() int { return fm.offset }
// Set the final offset
func (fm *FinalModelOptionalDecimal) SetFBEOffset(value int) { fm.offset = value }

// Shift the current final offset
func (fm *FinalModelOptionalDecimal) FBEShift(size int) { fm.offset += size }
// Unshift the current final offset
func (fm *FinalModelOptionalDecimal) FBEUnshift(size int) { fm.offset -= size }

// Check if the object contains a value
func (fm *FinalModelOptionalDecimal) HasValue() bool {
...
func (fm *FinalModelOptionalDecimal) Verify() int {
    if (fm.buffer.Offset() + fm.FBEOffset() + 1) > fm.buffer.Size() {
        return fbe.MaxInt
    }
...
func (fm *FinalModelOptionalDecimal) Get() (*fbe.Decimal, int, error) {
...
func (fm *FinalModelOptionalDecimal) Set(fbeValue *fbe.Decimal) (int, error) {
    if (fm.buffer.Offset() + fm.FBEOffset() + 1) > fm.buffer.Size() {
