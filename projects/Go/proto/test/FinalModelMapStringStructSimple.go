...
// Fast Binary Encoding String->StructSimple map final model
type FinalModelMapStringStructSimple struct {
    // Final model buffer
    buffer *fbe.Buffer
...
// Create a new String->StructSimple map final model
func NewFinalModelMapStringStructSimple(buffer *fbe.Buffer, offset int) *FinalModelMapStringStructSimple {
    fbeResult := FinalModelMapStringStructSimple{buffer: buffer, offset: offset}
...
func (fm *FinalModelMapStringStructSimple) FBEAllocationSize(values map[string]StructSimple) int {
    size := 4
...
func (fm *FinalModelMapStringStructSimple) FBEOffset() int { return fm.offset }
// Set the final offset
func (fm *FinalModelMapStringStructSimple) SetFBEOffset(value int) { fm.offset = value }

// Shift the current final offset
func (fm *FinalModelMapStringStructSimple) FBEShift(size int) { fm.offset += size }
// Unshift the current final offset
func (fm *FinalModelMapStringStructSimple) FBEUnshift(size int) { fm.offset -= size }

// Check if the map is valid
func (fm *FinalModelMapStringStructSimple) Verify() int {
...
// Get the map
func (fm *FinalModelMapStringStructSimple) Get() (map[string]StructSimple, int, error) {
...
// Set the map
func (fm *FinalModelMapStringStructSimple) Set(values map[string]StructSimple) (int, error) {
    if (fm.buffer.Offset() + fm.FBEOffset() + 4) > fm.buffer.Size() {
