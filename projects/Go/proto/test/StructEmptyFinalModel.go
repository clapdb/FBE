...
type StructEmptyFinalModel struct {
    // Model buffer
    buffer *fbe.Buffer

    // Final model
    model *FinalModelStructEmpty
}

// Create a new StructEmpty final model
func NewStructEmptyFinalModel(buffer *fbe.Buffer) *StructEmptyFinalModel {
    return &StructEmptyFinalModel{buffer: buffer, model: NewFinalModelStructEmpty(buffer, 8)}
}

// Get the final model buffer
func (m *StructEmptyFinalModel) Buffer() *fbe.Buffer { return m.buffer }
// Get the final model
func (m *StructEmptyFinalModel) Model() *FinalModelStructEmpty { return m.model }

// // Get the final model type
func (m *StructEmptyFinalModel) FBEType() int { return m.model.FBEType() }

// Check if the struct value is valid
func (m *StructEmptyFinalModel) Verify() bool {
...
func (m *StructEmptyFinalModel) CreateBegin() int {
    fbeBegin := m.buffer.Allocate(4 + m.model.FBESize())
    return fbeBegin
}

// Create a new final model (end phase)
func (m *StructEmptyFinalModel) CreateEnd(fbeBegin int) int {
...
func (m *StructEmptyFinalModel) Serialize(value *StructEmpty) (int, error) {
...
func (m *StructEmptyFinalModel) Deserialize() (*StructEmpty, int, error) {
...
func (m *StructEmptyFinalModel) DeserializeValue(value *StructEmpty) (int, error) {
...
func (m *StructEmptyFinalModel) Next(prev int) {
