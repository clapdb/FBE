...
// Fast Binary Encoding Int32->OptionalBytes map final model
type FinalModelMapInt32OptionalBytes struct {
    // Final model buffer
    buffer *fbe.Buffer
    ...
    modelValue *FinalModelOptionalBytes
}

// Create a new Int32->OptionalBytes map final model
func NewFinalModelMapInt32OptionalBytes(buffer *fbe.Buffer, offset int) *FinalModelMapInt32OptionalBytes {
    fbeResult := FinalModelMapInt32OptionalBytes{buffer: buffer, offset: offset}
    fbeResult.modelKey = fbe.NewFinalModelInt32(buffer, offset)
    fbeResult.modelValue = NewFinalModelOptionalBytes(buffer, offset)
    return &fbeResult
}

// Get the allocation size
func (fm *FinalModelMapInt32OptionalBytes) FBEAllocationSize(values map[int32]*[]byte) int {
    size := 4
...
func (fm *FinalModelMapInt32OptionalBytes) FBEOffset() int { return fm.offset }
// Set the final offset
func (fm *FinalModelMapInt32OptionalBytes) SetFBEOffset(value int) { fm.offset = value }

// Shift the current final offset
func (fm *FinalModelMapInt32OptionalBytes) FBEShift(size int) { fm.offset += size }
// Unshift the current final offset
func (fm *FinalModelMapInt32OptionalBytes) FBEUnshift(size int) { fm.offset -= size }

// Check if the map is valid
func (fm *FinalModelMapInt32OptionalBytes) Verify() int {
...
// Get the map
func (fm *FinalModelMapInt32OptionalBytes) Get() (map[int32]*[]byte, int, error) {
...
// Set the map
func (fm *FinalModelMapInt32OptionalBytes) Set(values map[int32]*[]byte) (int, error) {
    if (fm.buffer.Offset() + fm.FBEOffset() + 4) > fm.buffer.Size() {
