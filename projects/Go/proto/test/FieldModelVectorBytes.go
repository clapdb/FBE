...
type FieldModelVectorBytes struct {
    // Field model buffer
    buffer *fbe.Buffer
...
// Create a new Bytes vector field model
func NewFieldModelVectorBytes(buffer *fbe.Buffer, offset int) *FieldModelVectorBytes {
    fbeResult := FieldModelVectorBytes{buffer: buffer, offset: offset}
    return &fbeResult
}

// Get the field size
func (fm *FieldModelVectorBytes) FBESize() int { return 4 }

// Get the field extra size
func (fm *FieldModelVectorBytes) FBEExtra() int {
    ...
    fbeResult := 0
    if fm.model == nil {
        fm.model = fbe.NewFieldModelBytes(fm.buffer, fm.offset)
    }
...
func (fm *FieldModelVectorBytes) FBEOffset() int { return fm.offset }
// Set the field offset
func (fm *FieldModelVectorBytes) SetFBEOffset(value int) { fm.offset = value }

// Shift the current field offset
func (fm *FieldModelVectorBytes) FBEShift(size int) { fm.offset += size }
// Unshift the current field offset
func (fm *FieldModelVectorBytes) FBEUnshift(size int) { fm.offset -= size }

// Get the vector offset
func (fm *FieldModelVectorBytes) Offset() int {
    if (fm.buffer.Offset() + fm.FBEOffset() + fm.FBESize()) > fm.buffer.Size() {
        return 0
    }
...
// Get the vector size
func (fm *FieldModelVectorBytes) Size() int {
    if (fm.buffer.Offset() + fm.FBEOffset() + fm.FBESize()) > fm.buffer.Size() {
        return 0
    }
...
func (fm *FieldModelVectorBytes) GetItem(index int) (*fbe.FieldModelBytes, error) {
    if (fm.buffer.Offset() + fm.FBEOffset() + fm.FBESize()) > fm.buffer.Size() {
...
func (fm *FieldModelVectorBytes) Resize(size int) (*fbe.FieldModelBytes, error) {
    if fm.model == nil {
        fm.model = fbe.NewFieldModelBytes(fm.buffer, fm.offset)
    }
...
func (fm *FieldModelVectorBytes) Verify() bool {
    if (fm.buffer.Offset() + fm.FBEOffset() + fm.FBESize()) > fm.buffer.Size() {
        return true
    }
...
// Get the vector
func (fm *FieldModelVectorBytes) Get() ([][]byte, error) {
    values := make([][]byte, 0)
...
// Set the vector
func (fm *FieldModelVectorBytes) Set(values [][]byte) error {
    if (fm.buffer.Offset() + fm.FBEOffset() + fm.FBESize()) > fm.buffer.Size() {
