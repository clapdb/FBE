...
func (fm *FinalModelOptionalTimestamp) Value() *fbe.FinalModelTimestamp { return fm.value }

// Get the allocation size
func (fm *FinalModelOptionalTimestamp) FBEAllocationSize(fbeValue *fbe.Timestamp) int {
    if fbeValue != nil {
...
func (fm *FinalModelOptionalTimestamp) HasValue() bool {
...
func (fm *FinalModelOptionalTimestamp) Verify() int {
    if (fm.buffer.Offset() + fm.FBEOffset() + 1) > fm.buffer.Size() {
        return fbe.MaxInt
    }
...
func (fm *FinalModelOptionalTimestamp) Get() (*fbe.Timestamp, int, error) {
...
func (fm *FinalModelOptionalTimestamp) Set(fbeValue *fbe.Timestamp) (int, error) {
    if (fm.buffer.Offset() + fm.FBEOffset() + 1) > fm.buffer.Size() {
