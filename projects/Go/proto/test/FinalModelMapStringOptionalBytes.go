...
type FinalModelMapStringOptionalBytes struct {
    // Final model buffer
    buffer *fbe.Buffer
...
// Create a new String->OptionalBytes map final model
func NewFinalModelMapStringOptionalBytes(buffer *fbe.Buffer, offset int) *FinalModelMapStringOptionalBytes {
    fbeResult := FinalModelMapStringOptionalBytes{buffer: buffer, offset: offset}
...
func (fm *FinalModelMapStringOptionalBytes) FBEAllocationSize(values map[string]*[]byte) int {
    size := 4
...
func (fm *FinalModelMapStringOptionalBytes) FBEOffset() int { return fm.offset }
// Set the final offset
func (fm *FinalModelMapStringOptionalBytes) SetFBEOffset(value int) { fm.offset = value }

// Shift the current final offset
func (fm *FinalModelMapStringOptionalBytes) FBEShift(size int) { fm.offset += size }
// Unshift the current final offset
func (fm *FinalModelMapStringOptionalBytes) FBEUnshift(size int) { fm.offset -= size }

// Check if the map is valid
func (fm *FinalModelMapStringOptionalBytes) Verify() int {
...
// Get the map
func (fm *FinalModelMapStringOptionalBytes) Get() (map[string]*[]byte, int, error) {
...
// Set the map
func (fm *FinalModelMapStringOptionalBytes) Set(values map[string]*[]byte) (int, error) {
    if (fm.buffer.Offset() + fm.FBEOffset() + 4) > fm.buffer.Size() {
