...
type FinalModelMapInt32OptionalStructSimple struct {
    // Final model buffer
    buffer *fbe.Buffer
...
// Create a new Int32->OptionalStructSimple map final model
func NewFinalModelMapInt32OptionalStructSimple(buffer *fbe.Buffer, offset int) *FinalModelMapInt32OptionalStructSimple {
    fbeResult := FinalModelMapInt32OptionalStructSimple{buffer: buffer, offset: offset}
...
func (fm *FinalModelMapInt32OptionalStructSimple) FBEAllocationSize(values map[int32]*StructSimple) int {
    size := 4
...
func (fm *FinalModelMapInt32OptionalStructSimple) FBEOffset() int { return fm.offset }
// Set the final offset
func (fm *FinalModelMapInt32OptionalStructSimple) SetFBEOffset(value int) { fm.offset = value }

// Shift the current final offset
func (fm *FinalModelMapInt32OptionalStructSimple) FBEShift(size int) { fm.offset += size }
// Unshift the current final offset
func (fm *FinalModelMapInt32OptionalStructSimple) FBEUnshift(size int) { fm.offset -= size }

// Check if the map is valid
func (fm *FinalModelMapInt32OptionalStructSimple) Verify() int {
...
// Get the map
func (fm *FinalModelMapInt32OptionalStructSimple) Get() (map[int32]*StructSimple, int, error) {
...
// Set the map
func (fm *FinalModelMapInt32OptionalStructSimple) Set(values map[int32]*StructSimple) (int, error) {
    if (fm.buffer.Offset() + fm.FBEOffset() + 4) > fm.buffer.Size() {
