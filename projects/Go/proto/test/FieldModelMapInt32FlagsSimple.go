...
// Fast Binary Encoding Int32->FlagsSimple map field model
type FieldModelMapInt32FlagsSimple struct {
    // Field model buffer
    buffer *fbe.Buffer
    ...
    modelValue *FieldModelFlagsSimple
}

// Create a new Int32->FlagsSimple map field model
func NewFieldModelMapInt32FlagsSimple(buffer *fbe.Buffer, offset int) *FieldModelMapInt32FlagsSimple {
    fbeResult := FieldModelMapInt32FlagsSimple{buffer: buffer, offset: offset}
    fbeResult.modelKey = fbe.NewFieldModelInt32(buffer, offset)
    fbeResult.modelValue = NewFieldModelFlagsSimple(buffer, offset)
    return &fbeResult
}

// Get the field size
func (fm *FieldModelMapInt32FlagsSimple) FBESize() int { return 4 }

// Get the field extra size
func (fm *FieldModelMapInt32FlagsSimple) FBEExtra() int {
...
func (fm *FieldModelMapInt32FlagsSimple) FBEOffset() int { return fm.offset }
// Set the field offset
func (fm *FieldModelMapInt32FlagsSimple) SetFBEOffset(value int) { fm.offset = value }

// Shift the current field offset
func (fm *FieldModelMapInt32FlagsSimple) FBEShift(size int) { fm.offset += size }
// Unshift the current field offset
func (fm *FieldModelMapInt32FlagsSimple) FBEUnshift(size int) { fm.offset -= size }

// Get the map offset
func (fm *FieldModelMapInt32FlagsSimple) Offset() int {
    if (fm.buffer.Offset() + fm.FBEOffset() + fm.FBESize()) > fm.buffer.Size() {
        return 0
    }
...
// Get the map size
func (fm *FieldModelMapInt32FlagsSimple) Size() int {
    if (fm.buffer.Offset() + fm.FBEOffset() + fm.FBESize()) > fm.buffer.Size() {
        return 0
    }
...
// Map index operator
func (fm *FieldModelMapInt32FlagsSimple) GetItem(index int) (*fbe.FieldModelInt32, *FieldModelFlagsSimple, error) {
    if (fm.buffer.Offset() + fm.FBEOffset() + fm.FBESize()) > fm.buffer.Size() {
...
func (fm *FieldModelMapInt32FlagsSimple) Resize(size int) (*fbe.FieldModelInt32, *FieldModelFlagsSimple, error) {
...
func (fm *FieldModelMapInt32FlagsSimple) Verify() bool {
    if (fm.buffer.Offset() + fm.FBEOffset() + fm.FBESize()) > fm.buffer.Size() {
        return true
    }
...
// Get the map
func (fm *FieldModelMapInt32FlagsSimple) Get() (map[int32]FlagsSimple, error) {
...
// Set the map
func (fm *FieldModelMapInt32FlagsSimple) Set(values map[int32]FlagsSimple) error {
    if (fm.buffer.Offset() + fm.FBEOffset() + fm.FBESize()) > fm.buffer.Size() {
