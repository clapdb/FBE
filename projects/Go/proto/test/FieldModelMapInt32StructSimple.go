...
// Fast Binary Encoding Int32->StructSimple map field model
type FieldModelMapInt32StructSimple struct {
    // Field model buffer
    buffer *fbe.Buffer
...
// Create a new Int32->StructSimple map field model
func NewFieldModelMapInt32StructSimple(buffer *fbe.Buffer, offset int) *FieldModelMapInt32StructSimple {
    fbeResult := FieldModelMapInt32StructSimple{buffer: buffer, offset: offset}
    return &fbeResult
}

// Get the field size
func (fm *FieldModelMapInt32StructSimple) FBESize() int { return 4 }

// Get the field extra size
func (fm *FieldModelMapInt32StructSimple) FBEExtra() int {
    ...
    if fm.modelKey == nil {
        ...
        fm.modelValue = NewFieldModelStructSimple(fm.buffer, fm.offset)
    }
...
func (fm *FieldModelMapInt32StructSimple) FBEOffset() int { return fm.offset }
// Set the field offset
func (fm *FieldModelMapInt32StructSimple) SetFBEOffset(value int) { fm.offset = value }

// Shift the current field offset
func (fm *FieldModelMapInt32StructSimple) FBEShift(size int) { fm.offset += size }
// Unshift the current field offset
func (fm *FieldModelMapInt32StructSimple) FBEUnshift(size int) { fm.offset -= size }

// Get the map offset
func (fm *FieldModelMapInt32StructSimple) Offset() int {
    if (fm.buffer.Offset() + fm.FBEOffset() + fm.FBESize()) > fm.buffer.Size() {
        return 0
    }
...
// Get the map size
func (fm *FieldModelMapInt32StructSimple) Size() int {
    if (fm.buffer.Offset() + fm.FBEOffset() + fm.FBESize()) > fm.buffer.Size() {
        return 0
    }
...
// Map index operator
func (fm *FieldModelMapInt32StructSimple) GetItem(index int) (*fbe.FieldModelInt32, *FieldModelStructSimple, error) {
    if (fm.buffer.Offset() + fm.FBEOffset() + fm.FBESize()) > fm.buffer.Size() {
...
func (fm *FieldModelMapInt32StructSimple) Resize(size int) (*fbe.FieldModelInt32, *FieldModelStructSimple, error) {
    if fm.modelKey == nil {
        fm.modelKey = fbe.NewFieldModelInt32(fm.buffer, fm.offset)
        fm.modelValue = NewFieldModelStructSimple(fm.buffer, fm.offset)
    }
...
func (fm *FieldModelMapInt32StructSimple) Verify() bool {
    if (fm.buffer.Offset() + fm.FBEOffset() + fm.FBESize()) > fm.buffer.Size() {
        return true
    }
...
// Get the map
func (fm *FieldModelMapInt32StructSimple) Get() (map[int32]StructSimple, error) {
...
// Set the map
func (fm *FieldModelMapInt32StructSimple) Set(values map[int32]StructSimple) error {
    if (fm.buffer.Offset() + fm.FBEOffset() + fm.FBESize()) > fm.buffer.Size() {
