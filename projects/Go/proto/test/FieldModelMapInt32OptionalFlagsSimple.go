...
type FieldModelMapInt32OptionalFlagsSimple struct {
    // Field model buffer
    buffer *fbe.Buffer
...
// Create a new Int32->OptionalFlagsSimple map field model
func NewFieldModelMapInt32OptionalFlagsSimple(buffer *fbe.Buffer, offset int) *FieldModelMapInt32OptionalFlagsSimple {
    fbeResult := FieldModelMapInt32OptionalFlagsSimple{buffer: buffer, offset: offset}
    return &fbeResult
}

// Get the field size
func (fm *FieldModelMapInt32OptionalFlagsSimple) FBESize() int { return 4 }

// Get the field extra size
func (fm *FieldModelMapInt32OptionalFlagsSimple) FBEExtra() int {
    ...
    if fm.modelKey == nil {
        ...
        fm.modelValue = NewFieldModelOptionalFlagsSimple(fm.buffer, fm.offset)
    }
...
func (fm *FieldModelMapInt32OptionalFlagsSimple) FBEOffset() int { return fm.offset }
// Set the field offset
func (fm *FieldModelMapInt32OptionalFlagsSimple) SetFBEOffset(value int) { fm.offset = value }

// Shift the current field offset
func (fm *FieldModelMapInt32OptionalFlagsSimple) FBEShift(size int) { fm.offset += size }
// Unshift the current field offset
func (fm *FieldModelMapInt32OptionalFlagsSimple) FBEUnshift(size int) { fm.offset -= size }

// Get the map offset
func (fm *FieldModelMapInt32OptionalFlagsSimple) Offset() int {
    if (fm.buffer.Offset() + fm.FBEOffset() + fm.FBESize()) > fm.buffer.Size() {
        return 0
    }
...
// Get the map size
func (fm *FieldModelMapInt32OptionalFlagsSimple) Size() int {
    if (fm.buffer.Offset() + fm.FBEOffset() + fm.FBESize()) > fm.buffer.Size() {
        return 0
    }
...
// Map index operator
func (fm *FieldModelMapInt32OptionalFlagsSimple) GetItem(index int) (*fbe.FieldModelInt32, *FieldModelOptionalFlagsSimple, error) {
    if (fm.buffer.Offset() + fm.FBEOffset() + fm.FBESize()) > fm.buffer.Size() {
...
func (fm *FieldModelMapInt32OptionalFlagsSimple) Resize(size int) (*fbe.FieldModelInt32, *FieldModelOptionalFlagsSimple, error) {
    if fm.modelKey == nil {
        fm.modelKey = fbe.NewFieldModelInt32(fm.buffer, fm.offset)
        fm.modelValue = NewFieldModelOptionalFlagsSimple(fm.buffer, fm.offset)
    }
...
func (fm *FieldModelMapInt32OptionalFlagsSimple) Verify() bool {
    if (fm.buffer.Offset() + fm.FBEOffset() + fm.FBESize()) > fm.buffer.Size() {
        return true
    }
...
// Get the map
func (fm *FieldModelMapInt32OptionalFlagsSimple) Get() (map[int32]*FlagsSimple, error) {
    values := make(map[int32]*FlagsSimple)
...
// Set the map
func (fm *FieldModelMapInt32OptionalFlagsSimple) Set(values map[int32]*FlagsSimple) error {
    if (fm.buffer.Offset() + fm.FBEOffset() + fm.FBESize()) > fm.buffer.Size() {
