...
type FinalModelMapStringEnumSimple struct {
    // Final model buffer
    buffer *fbe.Buffer
    ...
    modelValue *FinalModelEnumSimple
}

// Create a new String->EnumSimple map final model
func NewFinalModelMapStringEnumSimple(buffer *fbe.Buffer, offset int) *FinalModelMapStringEnumSimple {
    fbeResult := FinalModelMapStringEnumSimple{buffer: buffer, offset: offset}
    fbeResult.modelKey = fbe.NewFinalModelString(buffer, offset)
    fbeResult.modelValue = NewFinalModelEnumSimple(buffer, offset)
    return &fbeResult
}

// Get the allocation size
func (fm *FinalModelMapStringEnumSimple) FBEAllocationSize(values map[string]EnumSimple) int {
    size := 4
...
func (fm *FinalModelMapStringEnumSimple) FBEOffset() int { return fm.offset }
// Set the final offset
func (fm *FinalModelMapStringEnumSimple) SetFBEOffset(value int) { fm.offset = value }

// Shift the current final offset
func (fm *FinalModelMapStringEnumSimple) FBEShift(size int) { fm.offset += size }
// Unshift the current final offset
func (fm *FinalModelMapStringEnumSimple) FBEUnshift(size int) { fm.offset -= size }

// Check if the map is valid
func (fm *FinalModelMapStringEnumSimple) Verify() int {
...
// Get the map
func (fm *FinalModelMapStringEnumSimple) Get() (map[string]EnumSimple, int, error) {
...
// Set the map
func (fm *FinalModelMapStringEnumSimple) Set(values map[string]EnumSimple) (int, error) {
    if (fm.buffer.Offset() + fm.FBEOffset() + 4) > fm.buffer.Size() {
