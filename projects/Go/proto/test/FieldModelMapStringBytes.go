...
// Map index operator
func (fm *FieldModelMapStringBytes) GetItem(index int) (*fbe.FieldModelString, *fbe.FieldModelBytes, error) {
    if (fm.buffer.Offset() + fm.FBEOffset() + fm.FBESize()) > fm.buffer.Size() {
...
func (fm *FieldModelMapStringBytes) Resize(size int) (*fbe.FieldModelString, *fbe.FieldModelBytes, error) {
    if fm.modelKey == nil {
        fm.modelKey = fbe.NewFieldModelString(fm.buffer, fm.offset)
        fm.modelValue = fbe.NewFieldModelBytes(fm.buffer, fm.offset)
    }
