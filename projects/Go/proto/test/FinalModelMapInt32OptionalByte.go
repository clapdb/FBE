...
type FinalModelMapInt32OptionalByte struct {
    // Final model buffer
    buffer *fbe.Buffer
...
// Create a new Int32->OptionalByte map final model
func NewFinalModelMapInt32OptionalByte(buffer *fbe.Buffer, offset int) *FinalModelMapInt32OptionalByte {
    fbeResult := FinalModelMapInt32OptionalByte{buffer: buffer, offset: offset}
...
func (fm *FinalModelMapInt32OptionalByte) FBEAllocationSize(values map[int32]*byte) int {
    size := 4
...
func (fm *FinalModelMapInt32OptionalByte) FBEOffset() int { return fm.offset }
// Set the final offset
func (fm *FinalModelMapInt32OptionalByte) SetFBEOffset(value int) { fm.offset = value }

// Shift the current final offset
func (fm *FinalModelMapInt32OptionalByte) FBEShift(size int) { fm.offset += size }
// Unshift the current final offset
func (fm *FinalModelMapInt32OptionalByte) FBEUnshift(size int) { fm.offset -= size }

// Check if the map is valid
func (fm *FinalModelMapInt32OptionalByte) Verify() int {
...
// Get the map
func (fm *FinalModelMapInt32OptionalByte) Get() (map[int32]*byte, int, error) {
...
// Set the map
func (fm *FinalModelMapInt32OptionalByte) Set(values map[int32]*byte) (int, error) {
    if (fm.buffer.Offset() + fm.FBEOffset() + 4) > fm.buffer.Size() {
