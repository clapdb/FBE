...
type StringFieldNamedStringFinalModel struct {
    // Model buffer
    buffer *fbe.Buffer

    // Final model
    model *FinalModelStringFieldNamedString
}

// Create a new StringFieldNamedString final model
func NewStringFieldNamedStringFinalModel(buffer *fbe.Buffer) *StringFieldNamedStringFinalModel {
    return &StringFieldNamedStringFinalModel{buffer: buffer, model: NewFinalModelStringFieldNamedString(buffer, 8)}
}

// Get the final model buffer
func (m *StringFieldNamedStringFinalModel) Buffer() *fbe.Buffer { return m.buffer }
// Get the final model
func (m *StringFieldNamedStringFinalModel) Model() *FinalModelStringFieldNamedString { return m.model }

// // Get the final model type
func (m *StringFieldNamedStringFinalModel) FBEType() int { return m.model.FBEType() }

// Check if the struct value is valid
func (m *StringFieldNamedStringFinalModel) Verify() bool {
...
func (m *StringFieldNamedStringFinalModel) CreateBegin() int {
    fbeBegin := m.buffer.Allocate(4 + m.model.FBESize())
    return fbeBegin
}

// Create a new final model (end phase)
func (m *StringFieldNamedStringFinalModel) CreateEnd(fbeBegin int) int {
...
func (m *StringFieldNamedStringFinalModel) Serialize(value *StringFieldNamedString) (int, error) {
...
func (m *StringFieldNamedStringFinalModel) Deserialize() (*StringFieldNamedString, int, error) {
...
func (m *StringFieldNamedStringFinalModel) DeserializeValue(value *StringFieldNamedString) (int, error) {
...
func (m *StringFieldNamedStringFinalModel) Next(prev int) {
