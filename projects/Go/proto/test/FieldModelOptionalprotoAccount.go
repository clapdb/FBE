...
func (fm *FieldModelOptionalprotoAccount) Value() *proto.FieldModelAccount { return fm.value }

// Get the field size
func (fm *FieldModelOptionalprotoAccount) FBESize() int { return 1 + 4 }

// Get the field extra size
func (fm *FieldModelOptionalprotoAccount) FBEExtra() int {
    if !fm.HasValue() {
        return 0
    }
...
func (fm *FieldModelOptionalprotoAccount) FBEOffset() int { return fm.offset }
// Set the field offset
func (fm *FieldModelOptionalprotoAccount) SetFBEOffset(value int) { fm.offset = value }

// Shift the current field offset
func (fm *FieldModelOptionalprotoAccount) FBEShift(size int) { fm.offset += size }
// Unshift the current field offset
func (fm *FieldModelOptionalprotoAccount) FBEUnshift(size int) { fm.offset -= size }

// Check if the object contains a value
func (fm *FieldModelOptionalprotoAccount) HasValue() bool {
...
func (fm *FieldModelOptionalprotoAccount) Verify() bool {
    if (fm.buffer.Offset() + fm.FBEOffset() + fm.FBESize()) > fm.buffer.Size() {
        return true
    }
...
func (fm *FieldModelOptionalprotoAccount) GetBegin() (int, error) {
    if !fm.HasValue() {
        return 0, nil
    }
...
func (fm *FieldModelOptionalprotoAccount) GetEnd(fbeBegin int) {
...
func (fm *FieldModelOptionalprotoAccount) SetBegin(hasValue bool) (int, error) {
    if (fm.buffer.Offset() + fm.FBEOffset() + fm.FBESize()) > fm.buffer.Size() {
        return 0, nil
    }
...
func (fm *FieldModelOptionalprotoAccount) SetEnd(fbeBegin int) {
    fm.buffer.Unshift(fbeBegin)
}

// Set the optional value
func (fm *FieldModelOptionalprotoAccount) Set(fbeValue *proto.Account) error {
