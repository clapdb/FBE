...
func (fm *FieldModelVectorSimple) FBEExtra() int {
    ...
    fbeResult := 0
    if fm.model == nil {
        fm.model = NewFieldModelSimple(fm.buffer, fm.offset)
    }
...
func (fm *FieldModelVectorSimple) GetItem(index int) (*FieldModelSimple, error) {
    if (fm.buffer.Offset() + fm.FBEOffset() + fm.FBESize()) > fm.buffer.Size() {
...
func (fm *FieldModelVectorSimple) Resize(size int) (*FieldModelSimple, error) {
    if fm.model == nil {
        fm.model = NewFieldModelSimple(fm.buffer, fm.offset)
    }
