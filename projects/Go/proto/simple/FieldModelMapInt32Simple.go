...
func (fm *FieldModelMapInt32Simple) FBEExtra() int {
    ...
    if fm.modelKey == nil {
        ...
        fm.modelValue = NewFieldModelSimple(fm.buffer, fm.offset)
    }
...
// Map index operator
func (fm *FieldModelMapInt32Simple) GetItem(index int) (*fbe.FieldModelInt32, *FieldModelSimple, error) {
    if (fm.buffer.Offset() + fm.FBEOffset() + fm.FBESize()) > fm.buffer.Size() {
...
func (fm *FieldModelMapInt32Simple) Resize(size int) (*fbe.FieldModelInt32, *FieldModelSimple, error) {
    if fm.modelKey == nil {
        fm.modelKey = fbe.NewFieldModelInt32(fm.buffer, fm.offset)
        fm.modelValue = NewFieldModelSimple(fm.buffer, fm.offset)
    }
