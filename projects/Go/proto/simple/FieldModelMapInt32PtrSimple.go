...
// Fast Binary Encoding Int32->PtrSimple map field model
type FieldModelMapInt32PtrSimple struct {
    // Field model buffer
    buffer *fbe.Buffer
    ...
    modelValue *FieldModelPtrSimple
}

// Create a new Int32->PtrSimple map field model
func NewFieldModelMapInt32PtrSimple(buffer *fbe.Buffer, offset int) *FieldModelMapInt32PtrSimple {
    fbeResult := FieldModelMapInt32PtrSimple{buffer: buffer, offset: offset}
    return &fbeResult
}

// Get the field size
func (fm *FieldModelMapInt32PtrSimple) FBESize() int { return 4 }

// Get the field extra size
func (fm *FieldModelMapInt32PtrSimple) FBEExtra() int {
    ...
    if fm.modelKey == nil {
        ...
        fm.modelValue = NewFieldModelPtrSimple(fm.buffer, fm.offset)
    }
...
func (fm *FieldModelMapInt32PtrSimple) FBEOffset() int { return fm.offset }
// Set the field offset
func (fm *FieldModelMapInt32PtrSimple) SetFBEOffset(value int) { fm.offset = value }

// Shift the current field offset
func (fm *FieldModelMapInt32PtrSimple) FBEShift(size int) { fm.offset += size }
// Unshift the current field offset
func (fm *FieldModelMapInt32PtrSimple) FBEUnshift(size int) { fm.offset -= size }

// Get the map offset
func (fm *FieldModelMapInt32PtrSimple) Offset() int {
    if (fm.buffer.Offset() + fm.FBEOffset() + fm.FBESize()) > fm.buffer.Size() {
        return 0
    }
...
// Get the map size
func (fm *FieldModelMapInt32PtrSimple) Size() int {
    if (fm.buffer.Offset() + fm.FBEOffset() + fm.FBESize()) > fm.buffer.Size() {
        return 0
    }
...
// Map index operator
func (fm *FieldModelMapInt32PtrSimple) GetItem(index int) (*fbe.FieldModelInt32, *FieldModelPtrSimple, error) {
    if (fm.buffer.Offset() + fm.FBEOffset() + fm.FBESize()) > fm.buffer.Size() {
...
func (fm *FieldModelMapInt32PtrSimple) Resize(size int) (*fbe.FieldModelInt32, *FieldModelPtrSimple, error) {
    if fm.modelKey == nil {
        fm.modelKey = fbe.NewFieldModelInt32(fm.buffer, fm.offset)
        fm.modelValue = NewFieldModelPtrSimple(fm.buffer, fm.offset)
    }
...
func (fm *FieldModelMapInt32PtrSimple) Verify() bool {
    if (fm.buffer.Offset() + fm.FBEOffset() + fm.FBESize()) > fm.buffer.Size() {
        return true
    }
...
// Get the map
func (fm *FieldModelMapInt32PtrSimple) Get() (map[int32]*Simple, error) {
    values := make(map[int32]*Simple)
...
// Set the map
func (fm *FieldModelMapInt32PtrSimple) Set(values map[int32]*Simple) error {
    if (fm.buffer.Offset() + fm.FBEOffset() + fm.FBESize()) > fm.buffer.Size() {
