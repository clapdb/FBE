...
type DetailModel struct {
    ...
    // Field model
    model *FieldModelDetail
}

// Create a new Detail model
func NewDetailModel(buffer *fbe.Buffer) *DetailModel {
    return &DetailModel{buffer: buffer, model: NewFieldModelDetail(buffer, 4)}
}

// Get the model buffer
func (m *DetailModel) Buffer() *fbe.Buffer { return m.buffer }
// Get the field model
func (m *DetailModel) Model() *FieldModelDetail { return m.model }

// Get the model size
func (m *DetailModel) FBESize() int { return m.model.FBESize() + m.model.FBEExtra() }
// // Get the model type
func (m *DetailModel) FBEType() int { return m.model.FBEType() }

// Check if the struct value is valid
func (m *DetailModel) Verify() bool {
...
func (m *DetailModel) CreateBegin() int {
    fbeBegin := m.buffer.Allocate(4 + m.model.FBESize())
    return fbeBegin
}

// Create a new model (end phase)
func (m *DetailModel) CreateEnd(fbeBegin int) int {
...
func (m *DetailModel) Serialize(value *Detail) (int, error) {
...
func (m *DetailModel) Deserialize() (*Detail, int, error) {
    value := NewDetail()
...
func (m *DetailModel) DeserializeValue(value *Detail) (int, error) {
    if (m.buffer.Offset() + m.model.FBEOffset() - 4) > m.buffer.Size() {
        value = NewDetail()
        return 0, nil
    }
...
func (m *DetailModel) Next(prev int) {
