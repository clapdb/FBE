...
// Fast Binary Encoding Int32->osaExtra map field model
type FieldModelMapInt32osaExtra struct {
    // Field model buffer
    buffer *fbe.Buffer
    ...
    modelValue *osa.FieldModelExtra
}

// Create a new Int32->osaExtra map field model
func NewFieldModelMapInt32osaExtra(buffer *fbe.Buffer, offset int) *FieldModelMapInt32osaExtra {
    fbeResult := FieldModelMapInt32osaExtra{buffer: buffer, offset: offset}
    return &fbeResult
}

// Get the field size
func (fm *FieldModelMapInt32osaExtra) FBESize() int { return 4 }

// Get the field extra size
func (fm *FieldModelMapInt32osaExtra) FBEExtra() int {
    ...
    if fm.modelKey == nil {
        ...
        fm.modelValue = osa.NewFieldModelExtra(fm.buffer, fm.offset)
    }
...
func (fm *FieldModelMapInt32osaExtra) FBEOffset() int { return fm.offset }
// Set the field offset
func (fm *FieldModelMapInt32osaExtra) SetFBEOffset(value int) { fm.offset = value }

// Shift the current field offset
func (fm *FieldModelMapInt32osaExtra) FBEShift(size int) { fm.offset += size }
// Unshift the current field offset
func (fm *FieldModelMapInt32osaExtra) FBEUnshift(size int) { fm.offset -= size }

// Get the map offset
func (fm *FieldModelMapInt32osaExtra) Offset() int {
    if (fm.buffer.Offset() + fm.FBEOffset() + fm.FBESize()) > fm.buffer.Size() {
        return 0
    }
...
// Get the map size
func (fm *FieldModelMapInt32osaExtra) Size() int {
    if (fm.buffer.Offset() + fm.FBEOffset() + fm.FBESize()) > fm.buffer.Size() {
        return 0
    }
...
// Map index operator
func (fm *FieldModelMapInt32osaExtra) GetItem(index int) (*fbe.FieldModelInt32, *osa.FieldModelExtra, error) {
    if (fm.buffer.Offset() + fm.FBEOffset() + fm.FBESize()) > fm.buffer.Size() {
...
func (fm *FieldModelMapInt32osaExtra) Resize(size int) (*fbe.FieldModelInt32, *osa.FieldModelExtra, error) {
    if fm.modelKey == nil {
        fm.modelKey = fbe.NewFieldModelInt32(fm.buffer, fm.offset)
        fm.modelValue = osa.NewFieldModelExtra(fm.buffer, fm.offset)
    }
...
func (fm *FieldModelMapInt32osaExtra) Verify() bool {
    if (fm.buffer.Offset() + fm.FBEOffset() + fm.FBESize()) > fm.buffer.Size() {
        return true
    }
...
// Get the map
func (fm *FieldModelMapInt32osaExtra) Get() (map[int32]osa.Extra, error) {
    values := make(map[int32]osa.Extra)
...
// Set the map
func (fm *FieldModelMapInt32osaExtra) Set(values map[int32]osa.Extra) error {
    if (fm.buffer.Offset() + fm.FBEOffset() + fm.FBESize()) > fm.buffer.Size() {
