...
func NewSimpleFinalModel(buffer *fbe.Buffer) *SimpleFinalModel {
    return &SimpleFinalModel{buffer: buffer, model: NewFinalModelSimple(buffer, 8)}
}

// Get the final model buffer
func (m *SimpleFinalModel) Buffer() *fbe.Buffer { return m.buffer }
// Get the final model
func (m *SimpleFinalModel) Model() *FinalModelSimple { return m.model }

// // Get the final model type
func (m *SimpleFinalModel) FBEType() int { return m.model.FBEType() }

// Check if the struct value is valid
func (m *SimpleFinalModel) Verify() bool {
...
func (m *SimpleFinalModel) CreateBegin() int {
    fbeBegin := m.buffer.Allocate(4 + m.model.FBESize())
    return fbeBegin
}

// Create a new final model (end phase)
func (m *SimpleFinalModel) CreateEnd(fbeBegin int) int {
...
func (m *SimpleFinalModel) Serialize(value *Simple) (int, error) {
...
func (m *SimpleFinalModel) Deserialize() (*Simple, int, error) {
    value := NewSimple()
...
func (m *SimpleFinalModel) DeserializeValue(value *Simple) (int, error) {
...
func (m *SimpleFinalModel) Next(prev int) {
