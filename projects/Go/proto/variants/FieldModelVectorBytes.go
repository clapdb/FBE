...
func (fm *FieldModelVectorBytes) FBEExtra() int {
    ...
    fbeResult := 0
    if fm.model == nil {
        fm.model = fbe.NewFinalModelBytes(fm.buffer, fm.offset)
    }
...
func (fm *FieldModelVectorBytes) GetItem(index int) (*fbe.FinalModelBytes, error) {
    if (fm.buffer.Offset() + fm.FBEOffset() + fm.FBESize()) > fm.buffer.Size() {
...
func (fm *FieldModelVectorBytes) Resize(size int) (*fbe.FinalModelBytes, error) {
    if fm.model == nil {
        fm.model = fbe.NewFinalModelBytes(fm.buffer, fm.offset)
    }
