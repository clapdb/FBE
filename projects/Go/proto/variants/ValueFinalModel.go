...
func NewValueFinalModel(buffer *fbe.Buffer) *ValueFinalModel {
    return &ValueFinalModel{buffer: buffer, model: NewFinalModelValue(buffer, 8)}
}

// Get the final model buffer
func (m *ValueFinalModel) Buffer() *fbe.Buffer { return m.buffer }
// Get the final model
func (m *ValueFinalModel) Model() *FinalModelValue { return m.model }

// // Get the final model type
func (m *ValueFinalModel) FBEType() int { return m.model.FBEType() }

// Check if the struct value is valid
func (m *ValueFinalModel) Verify() bool {
...
func (m *ValueFinalModel) CreateBegin() int {
    fbeBegin := m.buffer.Allocate(4 + m.model.FBESize())
    return fbeBegin
}

// Create a new final model (end phase)
func (m *ValueFinalModel) CreateEnd(fbeBegin int) int {
...
func (m *ValueFinalModel) Serialize(value *Value) (int, error) {
...
func (m *ValueFinalModel) Deserialize() (*Value, int, error) {
    value := NewValue()
...
func (m *ValueFinalModel) DeserializeValue(value *Value) (int, error) {
...
func (m *ValueFinalModel) Next(prev int) {
