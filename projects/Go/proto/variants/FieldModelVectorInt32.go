...
// Fast Binary Encoding Int32 vector field model
type FieldModelVectorInt32 struct {
    // Field model buffer
    buffer *fbe.Buffer
    ...
    model *fbe.FinalModelInt32
}

// Create a new Int32 vector field model
func NewFieldModelVectorInt32(buffer *fbe.Buffer, offset int) *FieldModelVectorInt32 {
    fbeResult := FieldModelVectorInt32{buffer: buffer, offset: offset}
    return &fbeResult
}

// Get the field size
func (fm *FieldModelVectorInt32) FBESize() int { return 4 }

// Get the field extra size
func (fm *FieldModelVectorInt32) FBEExtra() int {
    ...
    fbeResult := 0
    if fm.model == nil {
        fm.model = fbe.NewFinalModelInt32(fm.buffer, fm.offset)
    }
...
func (fm *FieldModelVectorInt32) FBEOffset() int { return fm.offset }
// Set the field offset
func (fm *FieldModelVectorInt32) SetFBEOffset(value int) { fm.offset = value }

// Shift the current field offset
func (fm *FieldModelVectorInt32) FBEShift(size int) { fm.offset += size }
// Unshift the current field offset
func (fm *FieldModelVectorInt32) FBEUnshift(size int) { fm.offset -= size }

// Get the vector offset
func (fm *FieldModelVectorInt32) Offset() int {
    if (fm.buffer.Offset() + fm.FBEOffset() + fm.FBESize()) > fm.buffer.Size() {
        return 0
    }
...
// Get the vector size
func (fm *FieldModelVectorInt32) Size() int {
    if (fm.buffer.Offset() + fm.FBEOffset() + fm.FBESize()) > fm.buffer.Size() {
        return 0
    }
...
func (fm *FieldModelVectorInt32) GetItem(index int) (*fbe.FinalModelInt32, error) {
    if (fm.buffer.Offset() + fm.FBEOffset() + fm.FBESize()) > fm.buffer.Size() {
...
func (fm *FieldModelVectorInt32) Resize(size int) (*fbe.FinalModelInt32, error) {
    if fm.model == nil {
        fm.model = fbe.NewFinalModelInt32(fm.buffer, fm.offset)
    }
...
func (fm *FieldModelVectorInt32) Verify() bool {
    if (fm.buffer.Offset() + fm.FBEOffset() + fm.FBESize()) > fm.buffer.Size() {
        return true
    }
...
// Get the vector
func (fm *FieldModelVectorInt32) Get() ([]int32, error) {
    values := make([]int32, 0)
    ...
    values = make([]int32, 0, fbeVectorSize)
...
// Set the vector
func (fm *FieldModelVectorInt32) Set(values []int32) error {
    if (fm.buffer.Offset() + fm.FBEOffset() + fm.FBESize()) > fm.buffer.Size() {
