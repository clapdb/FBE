...
func NewSimpleModel(buffer *fbe.Buffer) *SimpleModel {
    return &SimpleModel{buffer: buffer, model: NewFieldModelSimple(buffer, 4)}
}

// Get the model buffer
func (m *SimpleModel) Buffer() *fbe.Buffer { return m.buffer }
// Get the field model
func (m *SimpleModel) Model() *FieldModelSimple { return m.model }

// Get the model size
func (m *SimpleModel) FBESize() int { return m.model.FBESize() + m.model.FBEExtra() }
// // Get the model type
func (m *SimpleModel) FBEType() int { return m.model.FBEType() }

// Check if the struct value is valid
func (m *SimpleModel) Verify() bool {
...
func (m *SimpleModel) CreateBegin() int {
    fbeBegin := m.buffer.Allocate(4 + m.model.FBESize())
    return fbeBegin
}

// Create a new model (end phase)
func (m *SimpleModel) CreateEnd(fbeBegin int) int {
...
func (m *SimpleModel) Serialize(value *Simple) (int, error) {
...
func (m *SimpleModel) Deserialize() (*Simple, int, error) {
    value := NewSimple()
...
func (m *SimpleModel) DeserializeValue(value *Simple) (int, error) {
    if (m.buffer.Offset() + m.model.FBEOffset() - 4) > m.buffer.Size() {
        value = NewSimple()
        return 0, nil
    }
...
func (m *SimpleModel) Next(prev int) {
