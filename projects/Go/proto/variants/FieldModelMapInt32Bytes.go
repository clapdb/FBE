...
// Map index operator
func (fm *FieldModelMapInt32Bytes) GetItem(index int) (*fbe.FinalModelInt32, *fbe.FinalModelBytes, error) {
    if (fm.buffer.Offset() + fm.FBEOffset() + fm.FBESize()) > fm.buffer.Size() {
...
func (fm *FieldModelMapInt32Bytes) Resize(size int) (*fbe.FinalModelInt32, *fbe.FinalModelBytes, error) {
    if fm.modelKey == nil {
        fm.modelKey = fbe.NewFinalModelInt32(fm.buffer, fm.offset)
        fm.modelValue = fbe.NewFinalModelBytes(fm.buffer, fm.offset)
    }
