...
// Fast Binary Encoding Int32->Simple map field model
type FieldModelMapInt32Simple struct {
    // Field model buffer
    buffer *fbe.Buffer
    ...
    modelValue *FinalModelSimple
}

// Create a new Int32->Simple map field model
func NewFieldModelMapInt32Simple(buffer *fbe.Buffer, offset int) *FieldModelMapInt32Simple {
    fbeResult := FieldModelMapInt32Simple{buffer: buffer, offset: offset}
    return &fbeResult
}

// Get the field size
func (fm *FieldModelMapInt32Simple) FBESize() int { return 4 }

// Get the field extra size
func (fm *FieldModelMapInt32Simple) FBEExtra() int {
    ...
    fbeResult := 0
    if fm.modelKey == nil {
        fm.modelKey = fbe.NewFinalModelInt32(fm.buffer, fm.offset)
        fm.modelValue = NewFinalModelSimple(fm.buffer, fm.offset)
    }
...
func (fm *FieldModelMapInt32Simple) FBEOffset() int { return fm.offset }
// Set the field offset
func (fm *FieldModelMapInt32Simple) SetFBEOffset(value int) { fm.offset = value }

// Shift the current field offset
func (fm *FieldModelMapInt32Simple) FBEShift(size int) { fm.offset += size }
// Unshift the current field offset
func (fm *FieldModelMapInt32Simple) FBEUnshift(size int) { fm.offset -= size }

// Get the map offset
func (fm *FieldModelMapInt32Simple) Offset() int {
    if (fm.buffer.Offset() + fm.FBEOffset() + fm.FBESize()) > fm.buffer.Size() {
        return 0
    }
...
// Get the map size
func (fm *FieldModelMapInt32Simple) Size() int {
    if (fm.buffer.Offset() + fm.FBEOffset() + fm.FBESize()) > fm.buffer.Size() {
        return 0
    }
...
// Map index operator
func (fm *FieldModelMapInt32Simple) GetItem(index int) (*fbe.FinalModelInt32, *FinalModelSimple, error) {
    if (fm.buffer.Offset() + fm.FBEOffset() + fm.FBESize()) > fm.buffer.Size() {
...
func (fm *FieldModelMapInt32Simple) Resize(size int) (*fbe.FinalModelInt32, *FinalModelSimple, error) {
    if fm.modelKey == nil {
        fm.modelKey = fbe.NewFinalModelInt32(fm.buffer, fm.offset)
        fm.modelValue = NewFinalModelSimple(fm.buffer, fm.offset)
    }
...
func (fm *FieldModelMapInt32Simple) Verify() bool {
    if (fm.buffer.Offset() + fm.FBEOffset() + fm.FBESize()) > fm.buffer.Size() {
        return true
    }
...
// Get the map
func (fm *FieldModelMapInt32Simple) Get() (map[int32]Simple, error) {
...
// Set the map
func (fm *FieldModelMapInt32Simple) Set(values map[int32]Simple) error {
    if (fm.buffer.Offset() + fm.FBEOffset() + fm.FBESize()) > fm.buffer.Size() {
