...
type ValueModel struct {
    ...
    // Field model
    model *FieldModelValue
}

// Create a new Value model
func NewValueModel(buffer *fbe.Buffer) *ValueModel {
    return &ValueModel{buffer: buffer, model: NewFieldModelValue(buffer, 4)}
}

// Get the model buffer
func (m *ValueModel) Buffer() *fbe.Buffer { return m.buffer }
// Get the field model
func (m *ValueModel) Model() *FieldModelValue { return m.model }

// Get the model size
func (m *ValueModel) FBESize() int { return m.model.FBESize() + m.model.FBEExtra() }
// // Get the model type
func (m *ValueModel) FBEType() int { return m.model.FBEType() }

// Check if the struct value is valid
func (m *ValueModel) Verify() bool {
...
func (m *ValueModel) CreateBegin() int {
    fbeBegin := m.buffer.Allocate(4 + m.model.FBESize())
    return fbeBegin
}

// Create a new model (end phase)
func (m *ValueModel) CreateEnd(fbeBegin int) int {
...
func (m *ValueModel) Serialize(value *Value) (int, error) {
...
func (m *ValueModel) Deserialize() (*Value, int, error) {
    value := NewValue()
...
func (m *ValueModel) DeserializeValue(value *Value) (int, error) {
    if (m.buffer.Offset() + m.model.FBEOffset() - 4) > m.buffer.Size() {
        value = NewValue()
        return 0, nil
    }
...
func (m *ValueModel) Next(prev int) {
