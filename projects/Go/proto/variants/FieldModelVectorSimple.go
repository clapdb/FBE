...
// Fast Binary Encoding Simple vector field model
type FieldModelVectorSimple struct {
    // Field model buffer
    buffer *fbe.Buffer
    ...
    model *FinalModelSimple
}

// Create a new Simple vector field model
func NewFieldModelVectorSimple(buffer *fbe.Buffer, offset int) *FieldModelVectorSimple {
    fbeResult := FieldModelVectorSimple{buffer: buffer, offset: offset}
    return &fbeResult
}

// Get the field size
func (fm *FieldModelVectorSimple) FBESize() int { return 4 }

// Get the field extra size
func (fm *FieldModelVectorSimple) FBEExtra() int {
    ...
    fbeResult := 0
    if fm.model == nil {
        fm.model = NewFinalModelSimple(fm.buffer, fm.offset)
    }
...
func (fm *FieldModelVectorSimple) FBEOffset() int { return fm.offset }
// Set the field offset
func (fm *FieldModelVectorSimple) SetFBEOffset(value int) { fm.offset = value }

// Shift the current field offset
func (fm *FieldModelVectorSimple) FBEShift(size int) { fm.offset += size }
// Unshift the current field offset
func (fm *FieldModelVectorSimple) FBEUnshift(size int) { fm.offset -= size }

// Get the vector offset
func (fm *FieldModelVectorSimple) Offset() int {
    if (fm.buffer.Offset() + fm.FBEOffset() + fm.FBESize()) > fm.buffer.Size() {
        return 0
    }
...
// Get the vector size
func (fm *FieldModelVectorSimple) Size() int {
    if (fm.buffer.Offset() + fm.FBEOffset() + fm.FBESize()) > fm.buffer.Size() {
        return 0
    }
...
func (fm *FieldModelVectorSimple) GetItem(index int) (*FinalModelSimple, error) {
    if (fm.buffer.Offset() + fm.FBEOffset() + fm.FBESize()) > fm.buffer.Size() {
...
func (fm *FieldModelVectorSimple) Resize(size int) (*FinalModelSimple, error) {
    if fm.model == nil {
        fm.model = NewFinalModelSimple(fm.buffer, fm.offset)
    }
...
func (fm *FieldModelVectorSimple) Verify() bool {
    if (fm.buffer.Offset() + fm.FBEOffset() + fm.FBESize()) > fm.buffer.Size() {
        return true
    }
...
// Get the vector
func (fm *FieldModelVectorSimple) Get() ([]Simple, error) {
...
// Set the vector
func (fm *FieldModelVectorSimple) Set(values []Simple) error {
    if (fm.buffer.Offset() + fm.FBEOffset() + fm.FBESize()) > fm.buffer.Size() {
