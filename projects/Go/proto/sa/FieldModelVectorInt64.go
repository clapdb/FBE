...
// Fast Binary Encoding Int64 vector field model
type FieldModelVectorInt64 struct {
    // Field model buffer
    buffer *fbe.Buffer
    ...
    model *fbe.FieldModelInt64
}

// Create a new Int64 vector field model
func NewFieldModelVectorInt64(buffer *fbe.Buffer, offset int) *FieldModelVectorInt64 {
    fbeResult := FieldModelVectorInt64{buffer: buffer, offset: offset}
    return &fbeResult
}

// Get the field size
func (fm *FieldModelVectorInt64) FBESize() int { return 4 }

// Get the field extra size
func (fm *FieldModelVectorInt64) FBEExtra() int {
    ...
    fbeResult := 0
    if fm.model == nil {
        fm.model = fbe.NewFieldModelInt64(fm.buffer, fm.offset)
    }
...
func (fm *FieldModelVectorInt64) FBEOffset() int { return fm.offset }
// Set the field offset
func (fm *FieldModelVectorInt64) SetFBEOffset(value int) { fm.offset = value }

// Shift the current field offset
func (fm *FieldModelVectorInt64) FBEShift(size int) { fm.offset += size }
// Unshift the current field offset
func (fm *FieldModelVectorInt64) FBEUnshift(size int) { fm.offset -= size }

// Get the vector offset
func (fm *FieldModelVectorInt64) Offset() int {
    if (fm.buffer.Offset() + fm.FBEOffset() + fm.FBESize()) > fm.buffer.Size() {
        return 0
    }
...
// Get the vector size
func (fm *FieldModelVectorInt64) Size() int {
    if (fm.buffer.Offset() + fm.FBEOffset() + fm.FBESize()) > fm.buffer.Size() {
        return 0
    }
...
func (fm *FieldModelVectorInt64) GetItem(index int) (*fbe.FieldModelInt64, error) {
    if (fm.buffer.Offset() + fm.FBEOffset() + fm.FBESize()) > fm.buffer.Size() {
...
func (fm *FieldModelVectorInt64) Resize(size int) (*fbe.FieldModelInt64, error) {
    if fm.model == nil {
        fm.model = fbe.NewFieldModelInt64(fm.buffer, fm.offset)
    }
...
func (fm *FieldModelVectorInt64) Verify() bool {
    if (fm.buffer.Offset() + fm.FBEOffset() + fm.FBESize()) > fm.buffer.Size() {
        return true
    }
...
// Get the vector
func (fm *FieldModelVectorInt64) Get() ([]int64, error) {
    values := make([]int64, 0)
    ...
    values = make([]int64, 0, fbeVectorSize)
...
// Set the vector
func (fm *FieldModelVectorInt64) Set(values []int64) error {
    if (fm.buffer.Offset() + fm.FBEOffset() + fm.FBESize()) > fm.buffer.Size() {
