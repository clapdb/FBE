...
type ComplexModel struct {
    ...
    // Field model
    model *FieldModelComplex
}

// Create a new Complex model
func NewComplexModel(buffer *fbe.Buffer) *ComplexModel {
    return &ComplexModel{buffer: buffer, model: NewFieldModelComplex(buffer, 4)}
}

// Get the model buffer
func (m *ComplexModel) Buffer() *fbe.Buffer { return m.buffer }
// Get the field model
func (m *ComplexModel) Model() *FieldModelComplex { return m.model }

// Get the model size
func (m *ComplexModel) FBESize() int { return m.model.FBESize() + m.model.FBEExtra() }
// // Get the model type
func (m *ComplexModel) FBEType() int { return m.model.FBEType() }

// Check if the struct value is valid
func (m *ComplexModel) Verify() bool {
...
func (m *ComplexModel) CreateBegin() int {
    fbeBegin := m.buffer.Allocate(4 + m.model.FBESize())
    return fbeBegin
}

// Create a new model (end phase)
func (m *ComplexModel) CreateEnd(fbeBegin int) int {
...
func (m *ComplexModel) Serialize(value *Complex) (int, error) {
...
func (m *ComplexModel) Deserialize() (*Complex, int, error) {
    value := NewComplex()
...
func (m *ComplexModel) DeserializeValue(value *Complex) (int, error) {
    if (m.buffer.Offset() + m.model.FBEOffset() - 4) > m.buffer.Size() {
        value = NewComplex()
        return 0, nil
    }
...
func (m *ComplexModel) Next(prev int) {
