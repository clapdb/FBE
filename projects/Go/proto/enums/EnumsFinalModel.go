...
type EnumsFinalModel struct {
    // Model buffer
    buffer *fbe.Buffer

    // Final model
    model *FinalModelEnums
}

// Create a new Enums final model
func NewEnumsFinalModel(buffer *fbe.Buffer) *EnumsFinalModel {
    return &EnumsFinalModel{buffer: buffer, model: NewFinalModelEnums(buffer, 8)}
}

// Get the final model buffer
func (m *EnumsFinalModel) Buffer() *fbe.Buffer { return m.buffer }
// Get the final model
func (m *EnumsFinalModel) Model() *FinalModelEnums { return m.model }

// // Get the final model type
func (m *EnumsFinalModel) FBEType() int { return m.model.FBEType() }

// Check if the struct value is valid
func (m *EnumsFinalModel) Verify() bool {
...
func (m *EnumsFinalModel) CreateBegin() int {
    fbeBegin := m.buffer.Allocate(4 + m.model.FBESize())
    return fbeBegin
}

// Create a new final model (end phase)
func (m *EnumsFinalModel) CreateEnd(fbeBegin int) int {
...
func (m *EnumsFinalModel) Serialize(value *Enums) (int, error) {
...
func (m *EnumsFinalModel) Deserialize() (*Enums, int, error) {
    value := NewEnums()
...
func (m *EnumsFinalModel) DeserializeValue(value *Enums) (int, error) {
...
func (m *EnumsFinalModel) Next(prev int) {
