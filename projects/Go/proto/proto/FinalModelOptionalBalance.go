...
func (fm *FinalModelOptionalBalance) Value() *FinalModelBalance { return fm.value }

// Get the allocation size
func (fm *FinalModelOptionalBalance) FBEAllocationSize(fbeValue *Balance) int {
    if fbeValue != nil {
...
func (fm *FinalModelOptionalBalance) HasValue() bool {
...
func (fm *FinalModelOptionalBalance) Verify() int {
    if (fm.buffer.Offset() + fm.FBEOffset() + 1) > fm.buffer.Size() {
        return fbe.MaxInt
    }
...
func (fm *FinalModelOptionalBalance) Get() (*Balance, int, error) {
...
func (fm *FinalModelOptionalBalance) Set(fbeValue *Balance) (int, error) {
    if (fm.buffer.Offset() + fm.FBEOffset() + 1) > fm.buffer.Size() {
