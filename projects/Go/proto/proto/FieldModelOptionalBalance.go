...
func (fm *FieldModelOptionalBalance) Value() *FieldModelBalance { return fm.value }

// Get the field size
func (fm *FieldModelOptionalBalance) FBESize() int { return 1 + 4 }

// Get the field extra size
func (fm *FieldModelOptionalBalance) FBEExtra() int {
    if !fm.HasValue() {
        return 0
    }
...
func (fm *FieldModelOptionalBalance) FBEOffset() int { return fm.offset }
// Set the field offset
func (fm *FieldModelOptionalBalance) SetFBEOffset(value int) { fm.offset = value }

// Shift the current field offset
func (fm *FieldModelOptionalBalance) FBEShift(size int) { fm.offset += size }
// Unshift the current field offset
func (fm *FieldModelOptionalBalance) FBEUnshift(size int) { fm.offset -= size }

// Check if the object contains a value
func (fm *FieldModelOptionalBalance) HasValue() bool {
...
func (fm *FieldModelOptionalBalance) Verify() bool {
    if (fm.buffer.Offset() + fm.FBEOffset() + fm.FBESize()) > fm.buffer.Size() {
        return true
    }
...
func (fm *FieldModelOptionalBalance) GetBegin() (int, error) {
    if !fm.HasValue() {
        return 0, nil
    }
...
func (fm *FieldModelOptionalBalance) GetEnd(fbeBegin int) {
...
func (fm *FieldModelOptionalBalance) SetBegin(hasValue bool) (int, error) {
    if (fm.buffer.Offset() + fm.FBEOffset() + fm.FBESize()) > fm.buffer.Size() {
        return 0, nil
    }
...
func (fm *FieldModelOptionalBalance) SetEnd(fbeBegin int) {
    fm.buffer.Unshift(fbeBegin)
}

// Set the optional value
func (fm *FieldModelOptionalBalance) Set(fbeValue *Balance) error {
