...
func NewOrderFinalModel(buffer *fbe.Buffer) *OrderFinalModel {
    return &OrderFinalModel{buffer: buffer, model: NewFinalModelOrder(buffer, 8)}
}

// Get the final model buffer
func (m *OrderFinalModel) Buffer() *fbe.Buffer { return m.buffer }
// Get the final model
func (m *OrderFinalModel) Model() *FinalModelOrder { return m.model }

// // Get the final model type
func (m *OrderFinalModel) FBEType() int { return m.model.FBEType() }

// Check if the struct value is valid
func (m *OrderFinalModel) Verify() bool {
...
func (m *OrderFinalModel) CreateBegin() int {
    fbeBegin := m.buffer.Allocate(4 + m.model.FBESize())
    return fbeBegin
}

// Create a new final model (end phase)
func (m *OrderFinalModel) CreateEnd(fbeBegin int) int {
...
func (m *OrderFinalModel) Serialize(value *Order) (int, error) {
...
func (m *OrderFinalModel) Deserialize() (*Order, int, error) {
    value := NewOrder()
...
func (m *OrderFinalModel) DeserializeValue(value *Order) (int, error) {
...
func (m *OrderFinalModel) Next(prev int) {
