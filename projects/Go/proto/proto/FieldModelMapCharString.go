...
// Fast Binary Encoding Char->String map field model
type FieldModelMapCharString struct {
    // Field model buffer
    buffer *fbe.Buffer
    ...
    // Map key field model
    modelKey *fbe.FieldModelChar
    // Map value field model
    modelValue *fbe.FieldModelString
}
...
// Get the field size
func (fm *FieldModelMapCharString) FBESize() int { return 4 }

// Get the field extra size
func (fm *FieldModelMapCharString) FBEExtra() int {
...
func (fm *FieldModelMapCharString) FBEOffset() int { return fm.offset }
// Set the field offset
func (fm *FieldModelMapCharString) SetFBEOffset(value int) { fm.offset = value }

// Shift the current field offset
func (fm *FieldModelMapCharString) FBEShift(size int) { fm.offset += size }
// Unshift the current field offset
func (fm *FieldModelMapCharString) FBEUnshift(size int) { fm.offset -= size }

// Get the map offset
func (fm *FieldModelMapCharString) Offset() int {
    if (fm.buffer.Offset() + fm.FBEOffset() + fm.FBESize()) > fm.buffer.Size() {
        return 0
    }
...
// Get the map size
func (fm *FieldModelMapCharString) Size() int {
    if (fm.buffer.Offset() + fm.FBEOffset() + fm.FBESize()) > fm.buffer.Size() {
        return 0
    }
...
// Map index operator
func (fm *FieldModelMapCharString) GetItem(index int) (*fbe.FieldModelChar, *fbe.FieldModelString, error) {
    if (fm.buffer.Offset() + fm.FBEOffset() + fm.FBESize()) > fm.buffer.Size() {
...
func (fm *FieldModelMapCharString) Verify() bool {
    if (fm.buffer.Offset() + fm.FBEOffset() + fm.FBESize()) > fm.buffer.Size() {
        return true
    }
