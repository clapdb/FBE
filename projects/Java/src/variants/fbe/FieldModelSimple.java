...
public final class FieldModelSimple extends fbe.FieldModel
{
    ...
    public variants.Simple get() { return get(new variants.Simple()); }
    public variants.Simple get(variants.Simple fbeValue)
    {
    ...
    public void getFields(variants.Simple fbeValue, long fbeStructSize)
    {
        long fbeCurrentSize = 4 + 4;
    ...
    public void set(variants.Simple fbeValue)
    {
    ...
    public void setFields(variants.Simple fbeValue)
    {
