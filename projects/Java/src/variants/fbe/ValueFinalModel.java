...
public final class ValueFinalModel extends fbe.Model
{
    private final FinalModelValue _model;

    public ValueFinalModel() { _model = new FinalModelValue(getBuffer(), 8); }
    public ValueFinalModel(fbe.Buffer buffer) { super(buffer); _model = new FinalModelValue(getBuffer(), 8); }

    // Get the model type
    public static final long fbeTypeConst = FinalModelValue.fbeTypeConst;
