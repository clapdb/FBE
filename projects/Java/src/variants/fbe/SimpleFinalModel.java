...
public final class SimpleFinalModel extends fbe.Model
{
    private final FinalModelSimple _model;

    public SimpleFinalModel() { _model = new FinalModelSimple(getBuffer(), 8); }
    public SimpleFinalModel(fbe.Buffer buffer) { super(buffer); _model = new FinalModelSimple(getBuffer(), 8); }

    // Get the model type
    public static final long fbeTypeConst = FinalModelSimple.fbeTypeConst;
