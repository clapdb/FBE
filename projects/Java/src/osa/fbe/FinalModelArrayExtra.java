...
public final class FinalModelArrayExtra extends fbe.FinalModel
{
    private final FinalModelExtra _model;
    private final long _size;

    public FinalModelArrayExtra(fbe.Buffer buffer, long offset, long size)
    {
        super(buffer, offset);
        _model = new FinalModelExtra(buffer, offset);
        _size = size;
    }

    // Get the allocation size
    public long fbeAllocationSize(osa.Extra[] values)
    {
        long size = 0;
    ...
    public long fbeAllocationSize(java.util.ArrayList<osa.Extra> values)
    {
        long size = 0;
    ...
    // Get the array
    public osa.Extra[] get(fbe.Size size)
    {
    ...
    // Get the array
    public long get(osa.Extra[] values)
    {
    ...
    public long get(java.util.ArrayList<osa.Extra> values)
    {
        assert (values != null) : "Invalid values parameter!";
        if (values == null)
            throw new IllegalArgumentException("Invalid values parameter!");
        ...
        {
            offset.value = 0;
            osa.Extra value = _model.get(offset);
            values.add(value);
            _model.fbeShift(offset.value);
            size += offset.value;
        }
    ...
    // Set the array
    public long set(osa.Extra[] values)
    {
        assert (values != null) : "Invalid values parameter!";
        if (values == null)
            throw new IllegalArgumentException("Invalid values parameter!");
    ...
    public long set(java.util.ArrayList<osa.Extra> values)
    {
        assert (values != null) : "Invalid values parameter!";
        if (values == null)
            throw new IllegalArgumentException("Invalid values parameter!");
