...
public final class SimpleFinalModel extends fbe.Model
{
    ...
    public long serialize(osa.Simple value)
    {
    ...
    public osa.Simple deserialize() { var value = new osa.Simple(); deserialize(value); return value; }
    public long deserialize(osa.Simple value)
    {
