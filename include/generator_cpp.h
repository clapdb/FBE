...
private:
    ...
    void GenerateFBE_Header(const std::filesystem::path& path);
    void GenerateFBE_Source(const std::filesystem::path& path);
    void GenerateFBEPtr_Header(const std::filesystem::path& path);
    void GenerateFBEModels_Header(const std::filesystem::path& path);
    void GenerateFBEModels_Inline(const std::filesystem::path& path);
    void GenerateFBEModels_Source(const std::filesystem::path& path);
    void GenerateFBECustomModels_Header(const std::filesystem::path& path);
    void GenerateFBECustomModels_Inline(const std::filesystem::path& path);
    void GenerateFBEFinalModels_Header(const std::filesystem::path& path);
    void GenerateFBEFinalModels_Inline(const std::filesystem::path& path);
    void GenerateFBEFinalModels_Source(const std::filesystem::path& path);
    void GenerateFBEProtocol_Header(const std::filesystem::path& path);
    void GenerateFBEProtocol_Source(const std::filesystem::path& path);
    void GenerateFBEJson_Header(const std::filesystem::path& path);
